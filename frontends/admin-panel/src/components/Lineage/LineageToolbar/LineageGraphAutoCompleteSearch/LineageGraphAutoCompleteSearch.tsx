...
// =============================================================================
import "./LineageGraphAutoCompleteSearch.css";
...
export const LineageGraphAutoCompleteSearch: React.FC = observer(() => {
  const {
    graphStore: { resetGraphToUrn },
    uiStore: {
      getLineageGraphSearchOptions,
  ...
  return (
    <AutoComplete
      options={getLineageGraphSearchOptions}
      value={searchValue}
      filterOption
      ...
      onDropdownVisibleChange={(open: boolean) => {
        if (open === false) {
          setSearchNewNodeExpanded(false);
        }
      }}
    >
      <Input

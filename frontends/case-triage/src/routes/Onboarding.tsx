...
import { OnboardingCarouselContainer } from "../components/OnboardingCarousel/OnboardingCarousel.styles";
...
const Onboarding = (props: RouteComponentProps): ReactElement => {

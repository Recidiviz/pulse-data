#!/bin/bash -e
# These functions are used in provision.sh for modifying the GitHub Runner environment variables
# https://github.com/actions/runner-images/blob/main/images/ubuntu/scripts/helpers/etc-environment.sh
################################################################################

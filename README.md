...
[![Build Status](https://travis-ci.com/Recidiviz/pulse-data.svg?token=pa7kG645RqXUvoHE2g9n&branch=master)](https://travis-ci.com/Recidiviz/pulse-data) [![Coverage Status](https://coveralls.io/repos/github/Recidiviz/pulse-data/badge.svg?branch=master)](https://coveralls.io/github/Recidiviz/pulse-data?branch=master)
...
**NOTE:** Until is microsoft/vscode-python#11995 fixed, VSCode users should explicitly set `"python.linting.pylintUseMinimalCheckers": false` to ensure the pylint settings in `pyproject.toml` are used.

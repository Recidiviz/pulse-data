...
def alter_column(table_name: str,
                 column_name: str,
                 type_: Optional[TypeEngine] = None,
                 postgresql_using: Optional[str] = None) -> None: ...
def create_check_constraint(cosntraint_name: str, table_name: str, condition: str) -> None: ...
...
def drop_constraint(constraint_name: str, table_name: str, type_: Optional[ConstraintType] = None) -> None: ...

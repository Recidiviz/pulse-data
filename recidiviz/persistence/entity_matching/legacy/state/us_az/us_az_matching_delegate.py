...
# =============================================================================
"""Contains logic for US_AZ specific entity matching overrides.
...
class UsAzMatchingDelegate(StateSpecificEntityMatchingDelegate):
    """Class that contains matching logic specific to US_AZ."""

    def __init__(self, ingest_metadata: IngestMetadata):
        super().__init__(StateCode.US_AZ.value.lower(), ingest_metadata)

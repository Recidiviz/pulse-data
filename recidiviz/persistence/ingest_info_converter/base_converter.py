...
@attr.s(frozen=True)
class IngestInfoConversionResult(Generic[entities.PersonType]):
...
class BaseConverter(Generic[entities.PersonType]):
    ...
    @abstractmethod
    def _convert_and_pop(self) -> entities.PersonType:

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "filtered_dimensions", sa.ARRAY(sa.String(length=255)), nullable=True
        ),
        sa.Column(
            "filtered_dimension_values", sa.ARRAY(sa.String(length=255)), nullable=True
        ),
        sa.Column(
            "aggregated_dimensions", sa.ARRAY(sa.String(length=255)), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "acquisition_method",
            sa.Enum(
                "SCRAPED", "UPLOADED", "MANUALLY_ENTERED", name="acquisitionmethod"
            ),
            nullable=False,
        ),

...
# Without new value
old_values = ['CONTINUANCE', 'DELAYED_ACTION', 'EXTENSION', 'REVOCATION', 'SERVICE_TERMINATION', 'SUSPENSION'] 

# With new value
new_values = ['CONTINUANCE', 'DELAYED_ACTION', 'EXTENSION', 'PRIVILEGES_REVOKED', 'REVOCATION', 'SERVICE_TERMINATION', 'SUSPENSION'] 

def upgrade():
    op.execute('ALTER TYPE state_supervision_violation_response_decision RENAME TO state_supervision_violation_response_decision_old;')
    sa.Enum(*new_values, name='state_supervision_violation_response_decision').create(bind=op.get_bind())
    ...
    op.alter_column('state_supervision_violation_response_decision_entry',
                    column_name='decision',
                    type_=sa.Enum(*new_values,
                                  name='state_supervision_violation_response_decision'),
                    postgresql_using='decision::text::state_supervision_violation_response_decision')
    op.alter_column('state_supervision_violation_response_decision_entry_history',
                    column_name='decision',
                    type_=sa.Enum(*new_values,
                                  name='state_supervision_violation_response_decision'),
                    postgresql_using='decision::text::state_supervision_violation_response_decision')
...
def downgrade():
    op.execute('ALTER TYPE state_supervision_violation_response_decision RENAME TO state_supervision_violation_response_decision_old;')
    sa.Enum(*old_values, name='state_supervision_violation_response_decision').create(bind=op.get_bind())

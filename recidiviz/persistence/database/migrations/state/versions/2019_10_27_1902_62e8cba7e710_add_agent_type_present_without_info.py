...
# Without new value
old_values = ['CORRECTIONAL_OFFICER', 'JUDGE', 'PAROLE_BOARD_MEMBER',
              'SUPERVISION_OFFICER', 'UNIT_SUPERVISOR']

# With new value
new_values = ['CORRECTIONAL_OFFICER', 'JUDGE', 'PAROLE_BOARD_MEMBER',
              'SUPERVISION_OFFICER', 'UNIT_SUPERVISOR', 'PRESENT_WITHOUT_INFO']

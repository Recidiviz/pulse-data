...
def upgrade():
    ...
    op.create_index(
        op.f("ix_state_bond_county_code"), "state_bond", ["county_code"], unique=False
    )
    op.create_index(
        op.f("ix_state_bond_external_id"), "state_bond", ["external_id"], unique=False
    )
    op.create_index(
        op.f("ix_state_bond_state_code"), "state_bond", ["state_code"], unique=False
    )
    op.create_table(
        "state_court_case",
        sa.Column("external_id", sa.String(length=255), nullable=True),
        sa.Column(
            "status",
            sa.Enum("EXTERNAL_UNKNOWN", name="state_court_case_status"),
            nullable=True,
        ),
        sa.Column("status_raw_text", sa.String(length=255), nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "supervision_level",
            sa.Enum("EXTERNAL_UNKNOWN", name="state_supervision_level"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_state_bond_history_bond_id"),
        "state_bond_history",
        ["bond_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_bond_history_county_code"),
        "state_bond_history",
        ["county_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_bond_history_external_id"),
        "state_bond_history",
        ["external_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_bond_history_state_code"),
        "state_bond_history",
        ["state_code"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_state_fine_county_code"), "state_fine", ["county_code"], unique=False
    )
    op.create_index(
        op.f("ix_state_fine_external_id"), "state_fine", ["external_id"], unique=False
    )
    op.create_index(
        op.f("ix_state_fine_state_code"), "state_fine", ["state_code"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "incarceration_type",
            sa.Enum("COUNTY_JAIL", "STATE_PRISON", name="state_incarceration_type"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_state_fine_history_county_code"),
        "state_fine_history",
        ["county_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_fine_history_external_id"),
        "state_fine_history",
        ["external_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_fine_history_fine_id"),
        "state_fine_history",
        ["fine_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_state_fine_history_state_code"),
        "state_fine_history",
        ["state_code"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "facility_security_level_raw_text", sa.String(length=255), nullable=True
        ),
        sa.Column(
            "admission_reason",
            sa.Enum(
        ...
        sa.Column(
            "projected_release_reason_raw_text", sa.String(length=255), nullable=True
        ),
        sa.Column(
            "release_reason",
            sa.Enum(
        ...
        sa.Column(
            "source_supervision_violation_response_id", sa.Integer(), nullable=True
        ),
        sa.Column("person_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["person_id"],
    ...
    op.create_table(
        ...
        sa.Column("deciding_body_type_raw_text", sa.String(length=255), nullable=True),
        sa.Column(
            "supervision_violation_response_history_id", sa.Integer(), nullable=False
        ),
        sa.Column("supervision_violation_response_id", sa.Integer(), nullable=False),
        sa.Column("supervision_violation_id", sa.Integer(), nullable=True),
        sa.Column("person_id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "assessment_type",
            sa.Enum(
                "ASI", "LSIR", "ORAS", "PSA", "SORAC", name="state_assessment_type"
            ),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column("punishment_length_days", sa.Integer(), nullable=True),
        sa.Column(
            "incarceration_incident_outcome_history_id", sa.Integer(), nullable=False
        ),
        sa.Column("incarceration_incident_outcome_id", sa.Integer(), nullable=False),
        sa.Column("incarceration_incident_id", sa.Integer(), nullable=True),
        sa.Column("person_id", sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_state_fine_history_state_code"), table_name="state_fine_history"
    )
    op.drop_index(
        op.f("ix_state_fine_history_fine_id"), table_name="state_fine_history"
    )
    op.drop_index(
        op.f("ix_state_fine_history_external_id"), table_name="state_fine_history"
    )
    op.drop_index(
        op.f("ix_state_fine_history_county_code"), table_name="state_fine_history"
    )
    ...
    op.drop_index(
        op.f("ix_state_bond_history_state_code"), table_name="state_bond_history"
    )
    op.drop_index(
        op.f("ix_state_bond_history_external_id"), table_name="state_bond_history"
    )
    op.drop_index(
        op.f("ix_state_bond_history_county_code"), table_name="state_bond_history"
    )
    op.drop_index(
        op.f("ix_state_bond_history_bond_id"), table_name="state_bond_history"
    )

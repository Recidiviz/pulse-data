...
# Without new value
old_values = ['CIVIL_COMMITMENT', 'HALFWAY_HOUSE', 'PAROLE', 'POST_CONFINEMENT', 'PRE_CONFINEMENT', 'PROBATION']

# With new value
new_values = ['CIVIL_COMMITMENT', 'EXTERNAL_UNKNOWN', 'HALFWAY_HOUSE', 'PAROLE', 'POST_CONFINEMENT', 'PRE_CONFINEMENT', 'PROBATION']

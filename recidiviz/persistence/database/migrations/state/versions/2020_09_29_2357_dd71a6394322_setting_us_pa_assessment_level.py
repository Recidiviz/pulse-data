...
UPGRADE_LOW_QUERY = "SELECT assessment_id FROM state_assessment " \
...
UPGRADE_MEDIUM_QUERY = "SELECT assessment_id FROM state_assessment " \
                       "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
...
UPGRADE_HIGH_QUERY = "SELECT assessment_id FROM state_assessment " \
                     "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
...
UPGRADE_ATTEMPTED_INCOMPLETE_QUERY = "SELECT assessment_id FROM state_assessment " \
                                     "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
                                     "AND assessment_score = 60"

UPGRADE_REFUSED_QUERY = "SELECT assessment_id FROM state_assessment " \
                        "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
                        "AND assessment_score = 70"

UPGRADE_NO_DATE_QUERY = "SELECT assessment_id FROM state_assessment " \
                        "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
...
UPGRADE_UPDATE_LEVEL_QUERY = "UPDATE state_assessment " \
...
# scores erased
DOWNGRADE_VALID_SCORES_QUERY = "SELECT assessment_id FROM state_assessment " \
                               "WHERE state_code = 'US_PA' AND assessment_type = 'LSIR' " \
                               "AND assessment_level IS NOT NULL AND assessment_score IS NOT NULL"

DOWNGRADE_UPDATE_LEVEL_VALID_SCORES_QUERY = "UPDATE state_assessment " \

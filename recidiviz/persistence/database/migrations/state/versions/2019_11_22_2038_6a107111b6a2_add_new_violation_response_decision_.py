...
# With new value
new_values = ['CONTINUANCE', 'DELAYED_ACTION', 'EXTENSION', 'REVOCATION', 'SERVICE_TERMINATION', 'SUSPENSION']
...
def upgrade():
    ...
    op.alter_column('state_supervision_violation_response_decision_type_entry',
                    column_name='decision',
                    type_=sa.Enum(*new_values,
                                  name='state_supervision_violation_response_decision'),
                    postgresql_using='decision::text::state_supervision_violation_response_decision')
    op.alter_column('state_supervision_violation_response_decision_type_entry_history',
                    column_name='decision',
                    type_=sa.Enum(*new_values,
                                  name='state_supervision_violation_response_decision'),
                    postgresql_using='decision::text::state_supervision_violation_response_decision')

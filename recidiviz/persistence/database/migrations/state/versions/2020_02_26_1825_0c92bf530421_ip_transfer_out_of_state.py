...
old_incarceration_period_admission_reason_values = [
    'ADMITTED_IN_ERROR','DUAL_REVOCATION','EXTERNAL_UNKNOWN','INTERNAL_UNKNOWN','NEW_ADMISSION','PAROLE_REVOCATION',
    'PROBATION_REVOCATION','RETURN_FROM_ERRONEOUS_RELEASE','RETURN_FROM_ESCAPE','TEMPORARY_CUSTODY','TRANSFER'
]
old_incarceration_period_release_reason_values = [
    'COMMUTED','COMPASSIONATE','CONDITIONAL_RELEASE','COURT_ORDER','DEATH','EXECUTION','ESCAPE','EXTERNAL_UNKNOWN',
    'RELEASED_FROM_TEMPORARY_CUSTODY','RELEASED_IN_ERROR','SENTENCE_SERVED','TRANSFER'
]
...
new_incarceration_period_release_reason_values =  [
    'COMMUTED','COMPASSIONATE','CONDITIONAL_RELEASE','COURT_ORDER','DEATH','EXECUTION','ESCAPE','EXTERNAL_UNKNOWN',
    'RELEASED_FROM_TEMPORARY_CUSTODY','RELEASED_IN_ERROR','SENTENCE_SERVED','TRANSFER','TRANSFERRED_OUT_OF_STATE'
]

...
# Without new value
old_values = {'EXTERNAL_UNKNOWN', 'PRESENT_WITHOUT_INFO', 'MINIMUM', 'MEDIUM', 'MAXIMUM', 'DIVERSION',
              'INTERSTATE_COMPACT'}

# With new value
new_values = {'EXTERNAL_UNKNOWN', 'INTERNAL_UNKNOWN', 'PRESENT_WITHOUT_INFO', 'MINIMUM', 'MEDIUM', 'HIGH', 'MAXIMUM',
              'INCARCERATED', 'DIVERSION', 'INTERSTATE_COMPACT'}

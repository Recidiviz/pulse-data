...
old_values = ['ASI', 'CSSM', 'HIQ', 'LSIR', 'ORAS', 'ORAS_COMMUNITY_SUPERVISION', 'ORAS_COMMUNITY_SUPERVISION_SCREENING', 'ORAS_MISDEMEANOR_ASSESSMENT', 'ORAS_MISDEMEANOR_SCREENING', 'ORAS_PRE_TRIAL', 'ORAS_PRISON_SCREENING', 'ORAS_PRISON_INTAKE', 'ORAS_REENTRY', 'ORAS_STATIC', 'ORAS_SUPPLEMENTAL_REENTRY', 'PA_RST', 'PSA', 'SORAC', 'STATIC_99', 'TCU_DRUG_SCREEN']

new_values = ['INTERNAL_UNKNOWN', 'ASI', 'CSSM', 'HIQ', 'LSIR', 'ORAS', 'ORAS_COMMUNITY_SUPERVISION', 'ORAS_COMMUNITY_SUPERVISION_SCREENING', 'ORAS_MISDEMEANOR_ASSESSMENT', 'ORAS_MISDEMEANOR_SCREENING', 'ORAS_PRE_TRIAL', 'ORAS_PRISON_SCREENING', 'ORAS_PRISON_INTAKE', 'ORAS_REENTRY', 'ORAS_STATIC', 'ORAS_SUPPLEMENTAL_REENTRY', 'PA_RST', 'PSA', 'SORAC', 'STATIC_99', 'TCU_DRUG_SCREEN']

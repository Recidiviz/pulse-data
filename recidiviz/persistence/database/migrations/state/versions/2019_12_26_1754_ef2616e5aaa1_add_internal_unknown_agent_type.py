...
# Without new value
old_values = ['CORRECTIONAL_OFFICER','JUDGE','PAROLE_BOARD_MEMBER','SUPERVISION_OFFICER','UNIT_SUPERVISOR','PRESENT_WITHOUT_INFO']

# With new value
new_values = ['CORRECTIONAL_OFFICER','JUDGE','PAROLE_BOARD_MEMBER','SUPERVISION_OFFICER','UNIT_SUPERVISOR','PRESENT_WITHOUT_INFO', 'INTERNAL_UNKNOWN']
...
def upgrade():
    ...
    op.alter_column('state_agent', column_name='agent_type',
                    type_=sa.Enum(*new_values, name='state_agent_type'),
                    postgresql_using='agent_type::text::state_agent_type')
    op.alter_column('state_agent_history', column_name='agent_type',
                    type_=sa.Enum(*new_values, name='state_agent_type'),
                    postgresql_using='agent_type::text::state_agent_type')

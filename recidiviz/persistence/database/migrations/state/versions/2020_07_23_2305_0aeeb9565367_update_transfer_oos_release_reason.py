...
RELEASE_REASON_QUERY = "SELECT incarceration_period_id FROM" \
                       " state_incarceration_period" \
                       " WHERE state_code = 'US_ND' AND release_reason_raw_text = 'TRN'"


UPDATE_QUERY = "UPDATE state_incarceration_period SET release_reason = '{new_value}'" \
...
def upgrade():
    ...
    connection.execute(UPDATE_QUERY.format(new_value=updated_release_reason,

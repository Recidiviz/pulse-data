...
# Without new value
old_values = ['COMMUTED','COMPLETED','EXTERNAL_UNKNOWN','PRESENT_WITHOUT_INFO','SERVING','SUSPENDED']

# With new value
new_values = ['COMMUTED','COMPLETED','EXTERNAL_UNKNOWN','PRESENT_WITHOUT_INFO','REVOKED','SERVING','SUSPENDED']
...
def upgrade():
    ...
    op.alter_column('state_sentence_group',
                    column_name='status',
                    type_=sa.Enum(*new_values, name='state_sentence_status'),
                    postgresql_using='status::text::state_sentence_status')
    op.alter_column('state_sentence_group_history',
                    column_name='status',
                    type_=sa.Enum(*new_values, name='state_sentence_status'),
                    postgresql_using='status::text::state_sentence_status')

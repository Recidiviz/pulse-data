...
def upgrade():
    ...
    op.drop_constraint('external_ids_unique_within_type_and_region', 'state_person_external_id', type_='unique')
    op.execute(
...
def downgrade():
    ...
    op.drop_constraint('supervision_violation_response_external_ids_unique_within_state', 'state_supervision_violation_response', type_='unique')
    op.drop_constraint('supervision_violation_external_ids_unique_within_state', 'state_supervision_violation', type_='unique')
    op.drop_constraint('supervision_contact_external_ids_unique_within_state', 'state_supervision_contact', type_='unique')
    op.drop_constraint('supervision_case_type_entry_external_ids_unique_within_state', 'state_supervision_case_type_entry', type_='unique')
    op.drop_constraint('program_assignment_external_ids_unique_within_state', 'state_program_assignment', type_='unique')
    with op.get_context().autocommit_block():
        op.execute(
    ...
    op.drop_constraint('person_external_ids_unique_within_type_and_region', 'state_person_external_id', type_='unique')
    op.drop_constraint('parole_decision_external_ids_unique_within_state', 'state_parole_decision', type_='unique')
    op.drop_constraint('incarceration_period_external_ids_unique_within_state', 'state_incarceration_period', type_='unique')
    op.drop_constraint('fine_external_ids_unique_within_state', 'state_fine', type_='unique')
    op.drop_constraint('early_discharge_external_ids_unique_within_state', 'state_early_discharge', type_='unique')
    op.drop_constraint('bond_external_ids_unique_within_state', 'state_bond', type_='unique')

# pylint: skip-file
"""fill_contacting_staff_id_fields_redo

Revision ID: a7198e4860ae
Revises: f311098d4624
Create Date: 2023-07-27 15:22:34.399966
...
revision = "a7198e4860ae"
down_revision = "f311098d4624"
branch_labels = None
depends_on = None
...
COPY_QUERY_TEMPLATE = """
    WITH joined AS (
        ...
        LEFT JOIN
            state_agent
        ON state_supervision_contact.supervision_contact_id = state_agent.agent_id
        WHERE

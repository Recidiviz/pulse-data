...
def downgrade():
    ...
    op.drop_index(op.f('ix_state_supervision_violation_response_decision_type_entry_history_state_code'), table_name='state_supervision_violation_response_decision_type_entry_history')
    op.drop_index(op.f('ix_state_supervision_violation_response_decision_type_entry_history_supervision_violation_response_decision_type_entry_id'), table_name='state_supervision_violation_response_decision_type_entry_history')
    op.drop_table('state_supervision_violation_response_decision_type_entry_history')
    op.drop_index(op.f('ix_state_supervision_violation_type_entry_history_supervision_violation_type_entry_id'), table_name='state_supervision_violation_type_entry_history')
    op.drop_index(op.f('ix_state_supervision_violation_type_entry_history_state_code'), table_name='state_supervision_violation_type_entry_history')
    op.drop_table('state_supervision_violation_type_entry_history')
    op.drop_index(op.f('ix_state_supervision_violation_response_decision_type_entry_state_code'), table_name='state_supervision_violation_response_decision_type_entry')
    op.drop_table('state_supervision_violation_response_decision_type_entry')
    op.drop_index(op.f('ix_state_supervision_violated_condition_entry_history_state_code'), table_name='state_supervision_violated_condition_entry_history')
    op.drop_index(op.f('ix_state_supervision_violated_condition_entry_history_supervision_violated_condition_entry_id'), table_name='state_supervision_violated_condition_entry_history')
    op.drop_table('state_supervision_violated_condition_entry_history')
    op.drop_index(op.f('ix_state_supervision_violation_type_entry_state_code'), table_name='state_supervision_violation_type_entry')
    op.drop_table('state_supervision_violation_type_entry')
    op.drop_index(op.f('ix_state_supervision_violated_condition_entry_state_code'), table_name='state_supervision_violated_condition_entry')

...
# Without new value
old_values = ['ADMITTED_IN_ERROR', 'EXTERNAL_UNKNOWN', 'NEW_ADMISSION', 'PAROLE_REVOCATION', 'PROBATION_REVOCATION', 'RETURN_FROM_ERRONEOUS_RELEASE', 'RETURN_FROM_ESCAPE', 'TEMPORARY_CUSTODY', 'TRANSFER']

# With new value
new_values = ['ADMITTED_IN_ERROR', 'DUAL_REVOCATION', 'EXTERNAL_UNKNOWN', 'NEW_ADMISSION', 'PAROLE_REVOCATION', 'PROBATION_REVOCATION', 'RETURN_FROM_ERRONEOUS_RELEASE', 'RETURN_FROM_ESCAPE', 'TEMPORARY_CUSTODY', 'TRANSFER']

...
def upgrade():
    op.add_column('state_charge', sa.Column('ncic_code', sa.String(length=255), nullable=True))
    op.add_column('state_charge_history', sa.Column('ncic_code', sa.String(length=255), nullable=True))

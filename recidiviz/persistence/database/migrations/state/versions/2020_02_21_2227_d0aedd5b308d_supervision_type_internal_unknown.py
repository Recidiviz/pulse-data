...
# Without new value
old_values = ['CIVIL_COMMITMENT', 'EXTERNAL_UNKNOWN', 'HALFWAY_HOUSE', 'PAROLE', 'POST_CONFINEMENT', 'PRE_CONFINEMENT', 'PROBATION']

# With new value
new_values = ['CIVIL_COMMITMENT', 'EXTERNAL_UNKNOWN', 'INTERNAL_UNKNOWN', 'HALFWAY_HOUSE', 'PAROLE', 'POST_CONFINEMENT', 'PRE_CONFINEMENT', 'PROBATION']

def upgrade():
    op.execute('ALTER TYPE state_supervision_type RENAME TO state_supervision_type_old;')
    sa.Enum(*new_values, name='state_supervision_type').create(bind=op.get_bind())

    op.alter_column('state_supervision_sentence',
    ...
    op.alter_column('state_supervision_sentence_history',
                    column_name='supervision_type',
                    type_=sa.Enum(*new_values, name='state_supervision_type'),
                    postgresql_using='supervision_type::text::state_supervision_type')

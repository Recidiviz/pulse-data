...
old_level_values = ['LOW', 'LOW_MEDIUM', 'MEDIUM', 'MEDIUM_HIGH', 'MODERATE',
                    'HIGH', 'NOT_APPLICABLE', 'UNDETERMINED']

# With new values
new_type_values = ['ASI', 'LSIR', 'ORAS',
                   ...
                   'PSA', 'SORAC']
new_level_values = ['LOW', 'LOW_MEDIUM', 'MEDIUM', 'MEDIUM_HIGH', 'MODERATE',
                    'HIGH', 'VERY_HIGH', 'NOT_APPLICABLE', 'UNDETERMINED']

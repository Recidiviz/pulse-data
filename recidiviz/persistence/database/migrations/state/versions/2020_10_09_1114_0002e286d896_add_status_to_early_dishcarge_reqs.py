...
def upgrade():
    ...
    sa.Enum(*early_discharge_decision_status_values, name='state_early_discharge_decision_status').create(bind=op.get_bind())

    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('state_early_discharge', sa.Column('decision_status', sa.Enum(*early_discharge_decision_status_values, name='state_early_discharge_decision_status'), nullable=True))
    op.add_column('state_early_discharge', sa.Column('decision_status_raw_text', sa.String(length=255), nullable=True))
    op.add_column('state_early_discharge_history', sa.Column('decision_status', sa.Enum(*early_discharge_decision_status_values, name='state_early_discharge_decision_status'), nullable=True))
    op.add_column('state_early_discharge_history', sa.Column('decision_status_raw_text', sa.String(length=255), nullable=True))

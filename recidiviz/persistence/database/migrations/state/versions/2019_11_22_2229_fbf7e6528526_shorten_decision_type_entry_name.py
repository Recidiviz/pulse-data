...
def upgrade():
    ...
    op.drop_index(
        ...
        table_name="state_supervision_violation_response_decision_type_entry_histor",
    )
    op.drop_index(
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["person_id"],
            ["state_person.person_id"],
            name="state_supervision_violation_response_decision_ty_person_id_fkey",
            initially="DEFERRED",
            deferrable=True,
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.PrimaryKeyConstraint(
            "supervision_violation_response_decision_type_entry_id",
            name="state_supervision_violation_response_decision_type_entry_pkey",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["person_id"],
            ["state_person.person_id"],
            name="state_supervision_violation_response_decision_t_person_id_fkey1",
            initially="DEFERRED",
            deferrable=True,
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.PrimaryKeyConstraint(
            "supervision_violation_response_decision_type_entry_history_id",
            name="state_supervision_violation_response_decision_type_entry_h_pkey",
        ),
    )
    op.create_index(
        "ix_state_supervision_violation_response_decision_type_e_ba56",

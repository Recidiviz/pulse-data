...
WARRANT_QUERY = "SELECT supervision_violation_response_decision_entry_id FROM" \
...
UPDATE_TO_NEW_VALUE_QUERY = "UPDATE state_supervision_violation_response_decision_entry" \
...
SET_TO_NULL_QUERY = "UPDATE state_supervision_violation_response_decision_entry SET revocation_type = NULL," \
...
def upgrade():
    ...
    connection.execute(UPDATE_TO_NEW_VALUE_QUERY.format(new_value=updated_revocation_type_shock,
...
def downgrade():
    ...
    # decisions
    connection.execute(UPDATE_TO_NEW_VALUE_QUERY.format(new_value=reincarceration_value,
    ...
    # (SHOCK_INCARCERATION) decisions
    connection.execute(UPDATE_TO_NEW_VALUE_QUERY.format(new_value=treatment_in_prison_value,

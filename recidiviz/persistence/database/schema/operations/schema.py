...
class DirectIngestDataflowRawTableUpperBounds(OperationsBase):
    ...
    ingest_run_id = Column(Integer, primary_key=True)
    ...
    # When ingest in Dataflow Airflow DAG discovered this watermark
    discovery_time = Column(DateTime, nullable=False)

    # When ingest in Dataflow Airflow DAG finished work on this watermark

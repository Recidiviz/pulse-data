...
state_assessment_type = Enum(
    ...
    state_enum_strings.state_assessment_type_rcaf,
    state_enum_strings.state_assessment_type_dcaf,
    ...
    state_enum_strings.state_assessment_type_tn_stg,
    state_enum_strings.state_assessment_type_vrag,
    state_enum_strings.internal_unknown,
    state_enum_strings.external_unknown,

...
class SendGridClientWrapper:
    ...
    def _create_text_attachment(self, file_content: str) -> mail_helpers.Attachment:
        ...
        return mail_helpers.Attachment(
            ...
            file_name=mail_helpers.FileName('Recidiviz Monthly Report - Client Details.txt'),
    ...
    def _create_message(self,
                        ...
                        text_attachment_content: Optional[str] = None) -> mail_helpers.Mail:
        ...
        """
        message = mail_helpers.Mail(to_emails=to_email,
                       from_email=self._create_email_address(from_email, from_email_name),
                       subject=subject,
                       html_content=html_content)
        if cc_addresses:
            message.cc = [mail_helpers.Cc(email=cc_email_address) for cc_email_address in cc_addresses]
    ...
    @staticmethod
    def _create_email_address(from_email_address: str, from_email_name: str) -> mail_helpers.Email:
    ...
    def send_message(self,
                     ...
                     cc_addresses: Optional[List[str]] = None,
                     text_attachment_content: Optional[str] = None) -> bool:

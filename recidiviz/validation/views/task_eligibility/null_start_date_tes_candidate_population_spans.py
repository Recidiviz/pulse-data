...
NULL_START_DATE_TES_CANDIDATE_POPULATION_SPANS_VIEW_NAME = (
    "null_start_date_tes_candidate_population_spans"
)

NULL_START_DATE_TES_CANDIDATE_POPULATION_SPANS_DESCRIPTION = """
Identifies candidate population spans with a null start date. These spans will not be
collapsed into eligibility spans properly.
"""
...
NULL_START_DATE_TES_CANDIDATE_POPULATION_SPANS_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=NULL_START_DATE_TES_CANDIDATE_POPULATION_SPANS_VIEW_NAME,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        NULL_START_DATE_TES_CANDIDATE_POPULATION_SPANS_VIEW_BUILDER.build_and_print()

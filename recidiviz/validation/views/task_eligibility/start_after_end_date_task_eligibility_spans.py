...
# =============================================================================
"""A view revealing when task eligibility spans have a start date that comes after
the end date.
...
START_AFTER_END_DATE_TASK_ELIGIBILITY_SPANS_VIEW_NAME = (
    "start_after_end_date_task_eligibility_spans"
)

START_AFTER_END_DATE_TASK_ELIGIBILITY_SPANS_DESCRIPTION = """
Identifies task eligibility spans with a start date that comes after the end date.
"""
...
START_AFTER_END_DATE_TASK_ELIGIBILITY_SPANS_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=START_AFTER_END_DATE_TASK_ELIGIBILITY_SPANS_VIEW_NAME,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        START_AFTER_END_DATE_TASK_ELIGIBILITY_SPANS_VIEW_BUILDER.build_and_print()

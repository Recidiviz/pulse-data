...
# =============================================================================
"""A view containing external data for aggregate incarceration facility populations to validate against."""
...
INCARCERATION_POPULATION_BY_FACILITY_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    ...
    description="Contains external data for aggregate incarceration facility "
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        INCARCERATION_POPULATION_BY_FACILITY_VIEW_BUILDER.build_and_print()

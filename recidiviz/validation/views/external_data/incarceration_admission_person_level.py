...
UNION ALL 
SELECT 'US_PA' as region_code, control_number as person_external_id, PARSE_DATE('%m/%d/%Y', mov_date_std) as admission_date
FROM (
...
INCARCERATION_ADMISSION_PERSON_LEVEL_VIEW_BUILDER = SimpleBigQueryViewBuilder(
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        INCARCERATION_ADMISSION_PERSON_LEVEL_VIEW_BUILDER.build_and_print()

...
def get_incarceration_release_person_level_view_builder() -> UnionAllBigQueryViewBuilder:
    ...
    return UnionAllBigQueryViewBuilder(
        ...
        builder_to_select_statement=lambda _: "SELECT region_code, person_external_id, external_id_type, release_date",
    )

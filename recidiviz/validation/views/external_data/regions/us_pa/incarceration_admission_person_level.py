...
# =============================================================================
"""A view detailing incarceration admissions at the person level for Pennsylvania."""
...
FROM `{{project_id}}.{{us_pa_validation_oneoff_dataset}}.{month.strftime('%Y_%m')}_incarceration_admissions`
"""
...
SELECT 
    ...
    'US_PA_CONT' as external_id_type, 
    admission_date
FROM `{project_id}.{us_pa_validation_oneoff_dataset}.incarceration_admission_person_level_raw`
"""

VIEW_QUERY_TEMPLATE = "UNION ALL\n".join([SUPPLEMENTAL_DATA, *TIMESERIES_DATA])


US_PA_INCARCERATION_ADMISSION_PERSON_LEVEL_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.validation_dataset_for_state(StateCode.US_PA),
    view_id="incarceration_admission_person_level",
    description="A view detailing incarceration admissions at the person level for Pennsylvania",
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        US_PA_INCARCERATION_ADMISSION_PERSON_LEVEL_VIEW_BUILDER.build_and_print()

...
# =============================================================================
"""A view detailing the incarceration population at the person level for Tennessee."""
...
US_TN_INCARCERATION_POPULATION_PERSON_LEVEL_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.validation_dataset_for_state(StateCode.US_TN),
    view_id="incarceration_population_person_level",
    description="A view detailing the incarceration population at the person level for Tennessee",
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        US_TN_INCARCERATION_POPULATION_PERSON_LEVEL_VIEW_BUILDER.build_and_print()

...
US_IX_COUNTY_JAIL_INCARCERATION_POPULATION_PERSON_LEVEL_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.validation_dataset_for_state(StateCode.US_IX),
    view_id="county_jail_incarceration_population_person_level",
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        US_IX_COUNTY_JAIL_INCARCERATION_POPULATION_PERSON_LEVEL_VIEW_BUILDER.build_and_print()

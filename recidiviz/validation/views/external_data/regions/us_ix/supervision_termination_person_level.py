...
# =============================================================================
"""A view containing supervision terminations at the person level for Idaho."""
...
US_IX_SUPERVISION_TERMINATION_PERSON_LEVEL_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.validation_dataset_for_state(StateCode.US_IX),
    view_id="supervision_termination_person_level",
    description="A view detailing supervision terminations at the person level for Idaho",
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        US_IX_SUPERVISION_TERMINATION_PERSON_LEVEL_VIEW_BUILDER.build_and_print()

...
INCARCERATION_RELEASE_REASON_NO_RELEASE_DATE_VIEW_NAME = 'incarceration_release_reason_no_release_date'

INCARCERATION_RELEASE_REASON_NO_RELEASE_DATE_DESCRIPTION = """ Incarceration release reasons with no release date """

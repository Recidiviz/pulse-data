...
class StaleCriticalRawDataQueryBuilder:
    ...
    def _get_critical_file_configs(self) -> List[DirectIngestRawFileConfig]:
        ...
        file_tags_with_ingest_view_references = {
        ...
        return [
            ...
            if file_config.file_tag in file_tags_with_ingest_view_references
        ]
...
ALL_STALE_CRITICAL_RAW_DATA_VIEW_BUILDERS = get_stale_critical_raw_data_builders()

...
LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY = (
    "liberty_to_prison_population_snapshot_by_dimension_internal_consistency"
)

LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY_DESCRIPTION = (
...
LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY,
    view_query_template=LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY_QUERY,
    description=LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY_DESCRIPTION,
    dashboard_dataset=DASHBOARD_VIEWS_DATASET,
)

if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        LIBERTY_TO_PRISON_POPULATION_SNAPSHOT_BY_DIMENSION_INTERNAL_CONSISTENCY_VIEW_BUILDER.build_and_print()

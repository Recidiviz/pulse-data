...
from recidiviz.calculator.query.state.views.public_dashboard.incarceration.\
    incarceration_lengths_by_demographics import \
...
INCARCERATION_LENGTHS_BY_DEMOGRAPHICS_INTERNAL_CONSISTENCY_DESCRIPTION = \
...
CALCULATED_COLUMNS_TO_VALIDATE = ['years_0_1', 'years_1_2', 'years_2_3', 'years_3_5', 'years_5_10',
                                  'years_10_20', 'years_20_plus', 'total_release_count']

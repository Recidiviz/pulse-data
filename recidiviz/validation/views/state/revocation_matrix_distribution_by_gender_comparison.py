...
from recidiviz.calculator.query.state.views.dashboard.revocation_analysis.\
    revocations_matrix_distribution_by_gender import \
...
REVOCATION_MATRIX_DISTRIBUTION_BY_GENDER_COMPARISON_VIEW_NAME = 'revocation_matrix_distribution_by_gender_comparison'

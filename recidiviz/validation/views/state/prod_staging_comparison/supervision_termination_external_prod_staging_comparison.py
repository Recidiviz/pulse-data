...
/*{description}*/
      ...
      FROM `{prod_project_id}.{validation_views_dataset}.supervision_termination_person_level_external_comparison_materialized` prod
      FULL JOIN `{staging_project_id}.{validation_views_dataset}.supervision_termination_person_level_external_comparison_materialized` staging

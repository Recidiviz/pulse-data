...
/*{description}*/
      ...
      FROM `{prod_project_id}.{validation_views_dataset}.incarceration_admission_person_level_external_comparison` prod
      FULL JOIN `{staging_project_id}.{validation_views_dataset}.incarceration_admission_person_level_external_comparison` staging

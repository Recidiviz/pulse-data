...
REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_VIEW_NAME = (
    "reincarcerations_from_dataflow_to_dataflow"
)
...
REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_QUERY_TEMPLATE = """
    ...
    FROM `{project_id}.{validation_views_dataset}.reincarcerations_from_dataflow_to_dataflow_disaggregated`
    GROUP BY 1,2
    ORDER BY 1,2
    """

REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_VIEW_NAME,
    view_query_template=REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_QUERY_TEMPLATE,
    description=REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_DESCRIPTION,
    validation_views_dataset=dataset_config.VIEWS_DATASET,
)

if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        REINCARCERATIONS_FROM_DATAFLOW_TO_DATAFLOW_VIEW_BUILDER.build_and_print()

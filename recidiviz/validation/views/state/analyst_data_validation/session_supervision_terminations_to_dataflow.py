...
SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_VIEW_NAME = (
    "session_supervision_terminations_to_dataflow"
)
...
SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_QUERY_TEMPLATE = """
    ...
    FROM `{project_id}.{validation_views_dataset}.session_supervision_terminations_to_dataflow_disaggregated`
    GROUP BY 1,2
    ORDER BY 1,2
    """

SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_VIEW_NAME,
    view_query_template=SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_QUERY_TEMPLATE,
    description=SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_DESCRIPTION,
    validation_views_dataset=dataset_config.VIEWS_DATASET,
)

if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        SESSION_SUPERVISION_TERMINATIONS_TO_DATAFLOW_VIEW_BUILDER.build_and_print()

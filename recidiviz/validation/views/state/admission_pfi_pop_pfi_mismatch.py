...
LEFT JOIN
    (SELECT state_code, person_id, date_of_stay as metric_date, included_in_state_population, specialized_purpose_for_incarceration as 
    population_pfi
    FROM `{project_id}.{materialized_metrics_dataset}.most_recent_incarceration_population_metrics_not_included_in_state_population_materialized`)
USING (state_code, person_id, metric_date, included_in_state_population)

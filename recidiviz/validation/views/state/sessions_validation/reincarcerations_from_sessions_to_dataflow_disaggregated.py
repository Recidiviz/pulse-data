...
REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_VIEW_NAME = (
    "reincarcerations_from_sessions_to_dataflow_disaggregated"
)

REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_DESCRIPTION = """
...
REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_QUERY_TEMPLATE = """
    /*{description}*/
    SELECT
        person_id,
        state_code,
    ...
    FROM
      (
      SELECT *
      FROM `{project_id}.{sessions_dataset}.reincarceration_sessions_from_sessions_materialized` 
...
REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_VIEW_BUILDER = SimpleBigQueryViewBuilder(
    dataset_id=dataset_config.VIEWS_DATASET,
    view_id=REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_VIEW_NAME,
    view_query_template=REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_QUERY_TEMPLATE,
    description=REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_DESCRIPTION,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        REINCARCERATIONS_FROM_SESSIONS_TO_DATAFLOW_DISAGGREGATED_VIEW_BUILDER.build_and_print()

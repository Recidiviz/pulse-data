...
from recidiviz.calculator.query.state.views.public_dashboard.sentencing.\
    sentence_type_by_district_by_demographics import \
...
SENTENCE_TYPE_BY_DISTRICT_BY_DEMOGRAPHICS_INTERNAL_CONSISTENCY_DESCRIPTION = \

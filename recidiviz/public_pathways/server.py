...
# (the Bearer token in the Auth header), which protects against CSRF.
# https://security.stackexchange.com/questions/170388/do-i-need-csrf-token-if-im-using-bearer-jwt
csrf.exempt(public_pathways_api_blueprint)

app.register_blueprint(public_pathways_api_blueprint, url_prefix="/public_pathways")

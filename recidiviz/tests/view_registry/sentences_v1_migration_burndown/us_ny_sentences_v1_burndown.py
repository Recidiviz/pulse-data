...
# =============================================================================
"""US_NY exemptions for deprecated sentence v1 view references in product views."""
...
# For each US_NY metric export, for each product view in that export, a mapping of
...
US_NY_SENTENCE_V1_PRODUCT_USAGE_EXEMPTIONS: dict[

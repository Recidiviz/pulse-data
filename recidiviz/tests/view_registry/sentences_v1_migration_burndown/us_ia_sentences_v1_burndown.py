...
# =============================================================================
"""US_IA exemptions for deprecated sentence v1 view references in product views."""
...
# For each US_IA metric export, for each product view in that export, a mapping of
...
US_IA_SENTENCE_V1_PRODUCT_USAGE_EXEMPTIONS: dict[

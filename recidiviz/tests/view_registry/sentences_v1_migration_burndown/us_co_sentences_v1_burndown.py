...
# =============================================================================
"""US_CO exemptions for deprecated sentence v1 view references in product views."""
...
# For each US_CO metric export, for each product view in that export, a mapping of
...
US_CO_SENTENCE_V1_PRODUCT_USAGE_EXEMPTIONS: dict[

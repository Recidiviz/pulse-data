...
# =============================================================================
"""Tests for state_person_database_invariant_validators.py."""
...
@pytest.mark.uses_db
class TestStatePersonDatabaseInvariantValidators(unittest.TestCase):
    """Tests for state_person_database_invariant_validators.py."""
    ...
    def test_clean_session(self) -> None:
        with SessionFactory.using_database(
            ...
            errors = validate_invariants(
                session, self.state_code, schema.StatePerson, []
            )

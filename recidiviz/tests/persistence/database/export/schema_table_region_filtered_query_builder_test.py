...
class SchemaTableRegionFilteredQueryBuilderTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_columns_to_include = ['column1', 'column2']
        ...
        self.get_foreign_key_constraints_patcher = mock.patch(
            'recidiviz.persistence.database.export.schema_table_region_filtered_query_builder'
            '.get_foreign_key_constraints'
        )
        self.get_table_class_by_name_patcher = mock.patch(
            'recidiviz.persistence.database.export.schema_table_region_filtered_query_builder.get_table_class_by_name')
        self.get_region_code_col_patcher = mock.patch(
            'recidiviz.persistence.database.export.schema_table_region_filtered_query_builder.get_region_code_col')
    ...
    def test___init__(self) -> None:
        ...
        with self.assertRaises(ValueError):
            SchemaTableRegionFilteredQueryBuilder(StateBase, self.fake_jails_table, self.mock_columns_to_include,
    ...
    def test_select_clause_jails_schema(self) -> None:
        ...
        query_builder = SchemaTableRegionFilteredQueryBuilder(JailsBase, self.fake_jails_table,
                                                              self.mock_columns_to_include)
        expected_select = f'SELECT {self.fake_jails_table.name}.column1,{self.fake_jails_table.name}.column2 ' \
    ...
    def test_select_clause_state_schema(self) -> None:
        ...
        query_builder = SchemaTableRegionFilteredQueryBuilder(StateBase, self.fake_state_table,
                                                              self.mock_columns_to_include)
        expected_select = f'SELECT {self.fake_state_table.name}.column1,{self.fake_state_table.name}.column2 ' \
    ...
    def test_select_clause_state_association_table(self) -> None:
        ...
        query_builder = SchemaTableRegionFilteredQueryBuilder(StateBase, self.fake_association_table,
                                                              self.mock_columns_to_include)
    ...
    def test_join_clause_not_association_table(self) -> None:
        ...
        query_builder = SchemaTableRegionFilteredQueryBuilder(StateBase, self.fake_jails_table,
                                                              self.mock_columns_to_include)
    ...
    def test_full_query(self) -> None:
        ...
        query_builder = SchemaTableRegionFilteredQueryBuilder(JailsBase, self.fake_jails_table,
                                                              self.mock_columns_to_include)
        expected_query = f"SELECT {self.fake_jails_table.name}.column1,{self.fake_jails_table.name}.column2 " \
                         f"FROM {self.fake_jails_table.name}"
    ...
    def test_full_query_region_codes_to_exclude(self) -> None:
        ...
        expected_query = f"SELECT {self.fake_state_table.name}.column1,{self.fake_state_table.name}.column2 " \
                         f"FROM {self.fake_state_table.name} " \

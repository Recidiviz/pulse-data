...
class TestPathwaysMigrations(MigrationsTestBase):
    ...
    def expected_missing_indices(self) -> Set[str]:
        ...
        return {
            ...
            "prison_population_by_dimension_religion",
            "prison_population_by_dimension_marital_status",
            "prison_population_by_dimension_months_at_facility",
            "prison_population_by_dimension_offense_type",
            "prison_population_by_dimension_charge_description",

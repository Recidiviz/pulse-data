...
class TestStateSchemaEnums(TestSchemaEnums):
    ...
    def testPersistenceAndSchemaEnumsMatch(self) -> None:
        ...
        state_enums_mapping = {
            ...
            "state_scheduled_supervision_contact_location": state_scheduled_supervision_contact.StateScheduledSupervisionContactLocation,
            "state_scheduled_supervision_contact_reason": state_scheduled_supervision_contact.StateScheduledSupervisionContactReason,
            "state_scheduled_supervision_contact_status": state_scheduled_supervision_contact.StateScheduledSupervisionContactStatus,
            "state_scheduled_supervision_contact_type": state_scheduled_supervision_contact.StateScheduledSupervisionContactType,
            "state_scheduled_supervision_contact_method": state_scheduled_supervision_contact.StateScheduledSupervisionContactMethod,

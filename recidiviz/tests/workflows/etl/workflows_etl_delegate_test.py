...
from recidiviz.workflows.etl.workflows_etl_delegate import (
    WorkflowsETLDelegate,
    WorkflowsSingleStateETLDelegate,
)


class TestOpportunityDelegate(WorkflowsETLDelegate):
    EXPORT_BY_STATE = {"US_XX": ["export_filename.json"]}
    COLLECTION_BY_FILENAME = {"export_filename.json": "testOpportunity"}

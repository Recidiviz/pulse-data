...
from recidiviz.workflows.etl.workflows_demo_etl_delegate import (
    WorkflowsFirestoreDemoETLDelegate,
)
...
class TestETLDelegate(WorkflowsFirestoreDemoETLDelegate):
...
@patch(
    "recidiviz.workflows.etl.workflows_demo_etl_delegate.WorkflowsFirestoreDemoETLDelegate.get_file_stream"
)
class WorkflowsFirestoreDemoEtlDelegateTest(TestCase):
    """Tests for the Firestore Demo ETL Delegate."""

...
def make_add_config_arguments(
    ...
    return {
        ...
        "snooze_review_status_message": "Under Review",
        "grant_review_status_message": "Under Review",
        "grant_review_dropdown_label": "Submit for Supervisor Approval",
        "reviewer_feature_variant": "feature_variant",
        "subcategory_headings": [
        ...
        "mark_submitted_on_form_download": False,
    }

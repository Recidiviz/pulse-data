...
class ViewCollectionExportManagerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.view_export_config_patcher = mock.patch(
            'recidiviz.metrics.export.view_export_manager.view_config',
            **view_config_values)
    ...
    def test_export_dashboard_data_to_cloud_storage(self, mock_view_exporter, mock_view_update_manager):
        ...
        view_export_manager.export_view_data_to_cloud_storage(mock_state_code, mock_view_exporter)
    ...
    @mock.patch('recidiviz.metrics.export.view_export_manager.view_config')
    @mock.patch('recidiviz.big_query.view_update_manager.create_dataset_and_update_views_for_view_builders')
    @mock.patch('recidiviz.big_query.export.big_query_view_exporter.BigQueryViewExporter')
    def test_export_dashboard_data_to_cloud_storage_state_agnostic(self,
        ...
        mock_view_config.VIEW_BUILDERS_FOR_VIEWS_TO_UPDATE = self.view_buidlers_for_dataset
        mock_view_config.VIEW_COLLECTION_EXPORT_CONFIGS = state_agnostic_dataset_export_configs

        view_export_manager.export_view_data_to_cloud_storage(export_job_filter=None,

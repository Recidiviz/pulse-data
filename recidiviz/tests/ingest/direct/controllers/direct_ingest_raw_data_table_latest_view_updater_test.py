...
class DirectIngestRawDataUpdateControllerTest(unittest.TestCase):
    ...
    @patch(
        "recidiviz.ingest.direct.controllers.direct_ingest_raw_data_table_latest_view_updater"
        ".DirectIngestRegionRawFileConfig"
    )
    def test_update_tables_for_state(
        self, mock_region_config_fn: mock.MagicMock
    ) -> None:
        mock_region_config = FakeDirectIngestRegionRawFileConfig(

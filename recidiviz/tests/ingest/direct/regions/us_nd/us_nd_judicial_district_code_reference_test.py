...
class TestUsNdJudicialDistrictCodeReferenceTable(unittest.TestCase):
    ...
    def test_normalized_judicial_district_code(self) -> None:
        self.assertEqual(normalized_judicial_district_code("FD"), "FEDERAL")
        self.assertEqual(normalized_judicial_district_code("NC"), "NORTH_CENTRAL")
        self.assertEqual(normalized_judicial_district_code("OS"), "OUT_OF_STATE")
        self.assertEqual(normalized_judicial_district_code("OOS"), "OUT_OF_STATE")

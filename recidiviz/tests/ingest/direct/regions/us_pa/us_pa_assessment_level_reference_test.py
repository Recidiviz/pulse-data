...
class TestSetDateSpecificAssessmentLevel(unittest.TestCase):
    ...
    def test_set_date_specific_lsir_fields(self) -> None:
        assessment = StateAssessment(assessment_score="33", assessment_date="03012018")

        updated_assessment = (
            us_pa_assessment_level_reference.set_date_specific_lsir_fields(assessment)
        )

        self.assertEqual(
            StateAssessmentLevel.HIGH.value, updated_assessment.assessment_level
        )
    ...
    def test_set_date_specific_lsir_fields_pre_2009(self) -> None:
        ...
        self.assertEqual(
            StateAssessmentLevel.LOW.value, updated_assessment.assessment_level
        )
    ...
    def test_set_date_specific_lsir_fields_pre_2014_12_3(self) -> None:
        ...
        self.assertEqual(
            StateAssessmentLevel.MEDIUM.value, updated_assessment.assessment_level
        )
    ...
    def test_set_date_specific_lsir_fields_no_score(self) -> None:
        assessment = StateAssessment(assessment_score=None, assessment_date="12042014")
    ...
    def test_set_date_specific_lsir_fields_undetermined_60(self) -> None:
        ...
        self.assertEqual(
            "UNKNOWN (60-ATTEMPTED_INCOMPLETE)", updated_assessment.assessment_level
        )
        self.assertIsNone(updated_assessment.assessment_score)
    ...
    def test_set_date_specific_lsir_fields_undetermined_general(self) -> None:
        ...
        self.assertEqual(
            "UNKNOWN (351-SCORE_OUT_OF_RANGE)", updated_assessment.assessment_level
        )
        self.assertIsNone(updated_assessment.assessment_score)
    ...
    def test_set_date_specific_lsir_fields_date_in_future(self) -> None:
        ...
        assessment_today = StateAssessment(
            assessment_score="33", assessment_date=date.strftime(date.today(), "%m%d%Y")
        )
    ...
    def test_set_date_specific_lsir_fields_no_date(self) -> None:
        assessment = StateAssessment(assessment_score="31", assessment_date=None)
    ...
    def test_set_date_specific_lsir_fields_timestamp(self) -> None:
        assessment = StateAssessment(
            assessment_score="33", assessment_date="12/19/2016 15:21:56"
        )

...
#  =============================================================================
"""Tests the TN `SupervisionContacts` view logic."""
...
class SupervisionContactsTest(BaseViewTest):
    ...
    def test_supervision_contacts_simple(self) -> None:
        self.run_ingest_view_test(fixtures_files_name="supervision_contacts_simple.csv")

...
# TODO(#11424): Delete these tests once BQ materialization is shipped to all states.
class TestIngestViewMaterializationArgsGeneratorWithLegacyDelegate(unittest.TestCase):
    """Tests for IngestViewMaterializationArgsGenerator."""

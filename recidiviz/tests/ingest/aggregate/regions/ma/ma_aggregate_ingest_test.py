        ...
        expected_head = pd.DataFrame(
            {
                ...
                "facility_total_female": [29.0, 0.0],
                "hoc_total_female": [12.0, 0.0],
                "jail_total_female": [17.0, 0.0],
                ...
                "facility_total_male": [288.0, 184.0],
                "hoc_total_male": [157.0, 98.0],
                "jail_total_male": [131.0, 86.0],
                ...
                "facility_total_total": [317.0, 184.0],
                "hoc_total_total": [169.0, 98.0],
                "jail_total_total": [148.0, 86.0],
        ...
        expected_tail = pd.DataFrame(
            {
                ...
                "facility_total_female": [113.0, 0.0],
                "hoc_total_female": [113.0, 0.0],
                ...
                "facility_total_male": [890.0, 913.0],
                "hoc_total_male": [890.0, 416.0],
                "jail_total_male": [np.nan, 497.0],
                ...
                "facility_total_total": [1003.0, 913.0],
                "hoc_total_total": [1003.0, 416.0],
                "jail_total_total": [np.nan, 497.0],

...
class TestHiAggregateIngest(TestCase):
    ...
    def testParseNewTableOrder_ParsesHeadAndTail(self):
        ...
        expected_head = pd.DataFrame({
            ...
            'sentenced_pretrial_felony_male_population': [107, 0],
            'sentenced_pretrial_felony_female_population': [16, 0],
            'sentenced_pretrial_misdemeanor_male_population': [30, 0],
            'sentenced_pretrial_misdemeanor_female_population': [11, 0],
        ...
        expected_tail = pd.DataFrame({
            ...
            'sentenced_pretrial_felony_male_population': [0, 5],
            'sentenced_pretrial_felony_female_population': [0, 2],
            'sentenced_pretrial_misdemeanor_male_population': [0, 3],
            'sentenced_pretrial_misdemeanor_female_population': [0, 0],
            'held_for_other_jurisdiction_male_population': [0, 1],
            'held_for_other_jurisdiction_female_population': [0, 0],

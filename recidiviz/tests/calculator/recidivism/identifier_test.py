...
class TestValidateSortAndCollapseIncarcerationPeriods(unittest.TestCase):
    ...
    def test_validate_incarceration_periods_temporary_custody(self):
        ...
        incarceration_periods = [temporary_custody]
    ...
    def test_validate_incarceration_periods_temporary_and_valid(self):
        temporary_custody = StateIncarcerationPeriod.new_with_defaults(
            incarceration_period_id=111,
            status=StateIncarcerationPeriodStatus.NOT_IN_CUSTODY,
            state_code='TX',
    ...
    def test_validate_incarceration_periods_multiple_temporary_and_transfer(self):
        ...
        assert validated_incarceration_periods == [collapsed_incarceration_period]
    ...
    def test_validate_incarceration_periods_temporary_between_valid(self):
        ...
        assert validated_incarceration_periods == [valid_incarceration_period_1,
                                                   valid_incarceration_period_2]

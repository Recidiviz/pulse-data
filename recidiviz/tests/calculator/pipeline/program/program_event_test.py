...
class TestProgramEvent(unittest.TestCase):
    ...
    def test_program_referral_event(self):
        ...
        assert program_event.supervising_officer_external_id == supervising_officer_external_id
        assert program_event.supervising_district_external_id == supervising_district_external_id

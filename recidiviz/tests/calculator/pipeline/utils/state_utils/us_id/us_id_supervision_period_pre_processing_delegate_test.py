...
# =============================================================================
"""Tests for the us_id_supervision_period_pre_processing_delegate.py file"""
import unittest
...
class TestUsIdSupervisionPeriodPreProcessingDelegate(unittest.TestCase):
    """Unit tests for UsIdSupervisionPreProcdessingDelegate"""

    def setUp(self) -> None:
        self.upper_bound_date = date(2018, 10, 10)
        self.delegate = UsIdSupervisionPreProcessingDelegate()

...
# =============================================================================
"""Tests us_ix_program_assignments_normalization_delegate.py."""
import unittest
...
class TestUsIxProgramAssignmentNormalizationDelegate(unittest.TestCase):
    """Tests functions in UsIxProgramAssignmentNormalizationDelegate."""

...
#  =============================================================================
"""Tests us_xx_violation_response_normalization_delegate.py."""
import unittest
...
class TestUsXxViolationResponseNormalizationDelegate(unittest.TestCase):
    """Tests functions in UsXxViolationResponseNormalizationDelegate."""

...
#  =============================================================================
"""Tests us_xx_violation_response_pre_processing_delegate.py."""
import unittest
...
class TestUsXxViolationResponsePreprocessingDelegate(unittest.TestCase):
    """Tests functions in UsXxViolationResponsePreprocessingDelegate."""

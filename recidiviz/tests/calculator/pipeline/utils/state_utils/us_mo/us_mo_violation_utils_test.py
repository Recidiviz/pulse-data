...
from recidiviz.calculator.pipeline.utils.state_utils.us_mo.us_mo_violation_utils import \
    ...
    us_mo_filter_violation_responses, _normalize_violations_on_responses, _UNSUPPORTED_VIOLATION_SUBTYPE_VALUES, \
...
class TestUsMoGetViolationTypeSubstringsForViolation(unittest.TestCase):
    ...
    def test_us_mo_get_violation_type_subtype_strings_for_violation_substance(self) -> None:
        # Arrange
        violation = StateSupervisionViolation.new_with_defaults(
            state_code=_STATE_CODE,
            supervision_violation_types=[
    ...
    def test_us_mo_get_violation_type_subtype_strings_for_violation_law_citation(self) -> None:
        # Arrange
        violation = StateSupervisionViolation.new_with_defaults(
            state_code=_STATE_CODE,
            supervision_violation_types=[
    ...
    def test_us_mo_get_violation_type_subtype_strings_for_violation_technical(self) -> None:
        # Arrange
        violation = StateSupervisionViolation.new_with_defaults(
            state_code=_STATE_CODE,
            supervision_violation_types=[

...
from recidiviz.calculator.pipeline.utils.state_utils.us_pa.us_pa_revocation_utils import PURPOSE_FOR_INCARCERATION_PVC
...
class TestGetRevocationDetails(unittest.TestCase):
    ...
    @staticmethod
    def _test_get_revocation_details(incarceration_period: StateIncarcerationPeriod,
                                     ...
                                     Optional[Dict[int, Dict[Any, Any]]] = None):

        violation_responses = violation_responses or []
        supervision_period_to_agent_associations = \
            supervision_period_to_agent_associations or DEFAULT_SUPERVISION_PERIOD_AGENT_ASSOCIATIONS
    ...
    def test_get_revocation_details(self):
        ...
        self.assertEqual(RevocationDetails(

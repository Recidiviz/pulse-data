...
class TestCollapseIncarcerationPeriods(unittest.TestCase):
    ...
    def test_collapse_incarceration_periods(self):
        ...
        collapsed_incarceration_periods = utils.collapse_incarceration_period_transfers(
            incarceration_periods
        )
    ...
    def test_collapse_incarceration_periods_transfer_different_pfi_do_not_collapse(
        self,
    ):
        ...
        collapsed_incarceration_periods = utils.collapse_incarceration_period_transfers(
            incarceration_periods, collapse_transfers_with_different_pfi=False
        )
    ...
    def test_collapse_incarceration_periods_transfer_different_pfi_collapse(self):
        ...
        collapsed_incarceration_periods = utils.collapse_incarceration_period_transfers(
            incarceration_periods, collapse_transfers_with_different_pfi=True
        )
...
class TestCollapseTemporaryCustodyAndRevocationPeriods(unittest.TestCase):
    ...
    def test_collapseTemporaryCustodyAndRevocationPeriods_noTempCustodyPreceedingRevocation(
        self,
    ):
        # Arrange
        state_code = "US_XX"
...
class TestPrepareIncarcerationPeriodsForCalculations(unittest.TestCase):
    ...
    def test_prepare_incarceration_periods_for_calculations_temporary_between_valid(
        self,
    ):
        state_code = "US_ND"
    ...
    def test_prepare_incarceration_periods_for_calculations_drop_invalid_zero_day_after_transfer(
        self,
    ):
        state_code = "US_XX"
        valid_incarceration_period_1 = StateIncarcerationPeriod.new_with_defaults(
    ...
    def test_prepare_incarceration_periods_for_calculations_multiple_jail_and_transfer(
        self,
    ):
        state_code = "US_XX"
        jail_period_1 = StateIncarcerationPeriod.new_with_defaults(
...
class TestUsNdPrepareIncarcerationPeriodsForCalculations(unittest.TestCase):
    ...
    def test_prepare_incarceration_periods_for_calculations_multiple_temporary_and_valid(
        self,
    ):
        state_code = "US_ND"
    ...
    def test_prepare_incarceration_periods_for_calculations_multiple_temporary_and_transfer(
        self,
    ):
        state_code = "US_ND"
        temporary_custody_1 = StateIncarcerationPeriod.new_with_defaults(
...
class TestInferMissingDatesAndStatuses(unittest.TestCase):
    ...
    def test_infer_missing_dates_and_statuses_multiple_open_periods(self):
        ...
        for ip_order_combo in permutations(incarceration_periods.copy()):
            ...
            num_open_periods = len(
                [
                    ip
                    for ip in updated_incarceration_periods
    ...
    def test_infer_missing_dates_and_statuses_set_missing_admission_data_after_transfer(
        self,
    ):
        first_incarceration_period = StateIncarcerationPeriod.new_with_defaults(
            external_id="1",
    ...
    def test_infer_missing_dates_and_statuses_same_dates_sort_by_transfer_start(self):
        incarceration_period = StateIncarcerationPeriod.new_with_defaults(
            external_id="1",
            incarceration_period_id=1111,
            status=StateIncarcerationPeriodStatus.NOT_IN_CUSTODY,
    ...
    def test_infer_missing_dates_and_statuses_same_admission_dates_sort_by_statuses(
        self,
    ):
        first_incarceration_period = StateIncarcerationPeriod.new_with_defaults(
            external_id="1",

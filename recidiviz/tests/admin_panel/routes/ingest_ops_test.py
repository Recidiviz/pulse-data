    ...
    def test_get_latest_raw_data_import_runs(
        ...
        import_manager_mock().get_n_most_recent_imports_for_file_tag.return_value = [
            DirectIngestRawFileImportSummary(
                ...
                file_id=1,
                dag_run_id="run1",
                import_status="FAILED_DAG_LEVEL",
            ...
            [
                {
                    ...
                    "importRunStart": "2022-08-29T00:00:00+00:00",
                    "importStatus": "FAILED_DAG_LEVEL",
                    "importStatusDescription": "The FAILED_DAG_LEVEL status indicates that a DAG-level failure occurred (e.g. an upstream task crashed without writing results to xcom), preventing the import of this file. The root cause is not file-specific.",
                    "isInvalidated": False,
                    "rawRowCount": 0,

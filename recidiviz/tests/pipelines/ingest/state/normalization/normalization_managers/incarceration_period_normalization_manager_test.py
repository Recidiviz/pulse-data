...
class TestNormalizedIncarcerationPeriodsForCalculations(unittest.TestCase):
    ...
    @mock.patch(
        "recidiviz.pipelines.utils.state_utils.templates.us_xx.us_xx_incarceration_period_normalization_delegate.UsXxIncarcerationNormalizationDelegate.get_pfi_info_for_period_if_commitment_from_supervision"
    )
    @mock.patch(
        "recidiviz.pipelines.utils.state_utils.templates.us_xx.us_xx_incarceration_period_normalization_delegate.UsXxIncarcerationNormalizationDelegate.normalize_period_if_commitment_from_supervision"
    )

...
class TestNormalizedPersonExternalIdChecks(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.allowed_multiple_ids_patcher = patch(
            "recidiviz.pipelines.ingest.activity.state.validator.person_external_id_types_with_allowed_multiples_per_person"
        )
...
class TestNormalizedStaffExternalIdChecks(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.allowed_multiple_ids_patcher = patch(
            "recidiviz.pipelines.ingest.activity.state.validator.staff_external_id_types_with_allowed_multiples_per_person"
        )
        self.allowed_multiple_ids_patcher.start().return_value = [
            "US_XX_ID_TYPE",
            "US_XX_ID_TYPE_2",

...
#  =============================================================================
"""Tests us_tx_incarceration_period_normalization_delegate.py."""
import unittest
...
class TestUsTxIncarcerationNormalizationDelegate(unittest.TestCase):
    """Tests functions in TestUsTxIncarcerationNormalizationDelegate."""

    def setUp(self) -> None:
        self.delegate = UsTxIncarcerationNormalizationDelegate()

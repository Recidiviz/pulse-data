...
#  =============================================================================
"""Tests us_tx_violation_response_normalization_delegate.py."""
import unittest
...
class TestUsTxViolationResponseNormalizationDelegate(unittest.TestCase):
    """Tests functions in UsTxViolationResponseNormalizationDelegate."""

    def setUp(self) -> None:
        self.delegate = UsTxViolationResponseNormalizationDelegate()

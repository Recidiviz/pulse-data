...
# =============================================================================
"""Tests the us_id_assessment_normalization_delegate.py"""
import datetime
import unittest
...
class TestNormalizedAssessmentPeriodsForCalculations(unittest.TestCase):
    """Tests the US_ID-specific aspects of the normalized_assessments_and_additional_attributes
    ...
    def _normalized_assessments_for_calculations(
        ...
        assessments_normalization_manager = AssessmentNormalizationManager(
            ...
            delegate=UsIdAssessmentNormalizationDelegate(persons=persons),

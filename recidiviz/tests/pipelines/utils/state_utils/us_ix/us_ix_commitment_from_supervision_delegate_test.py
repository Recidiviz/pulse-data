...
# =============================================================================
"""Tests the functions in us_ix_commitment_from_supervision_delegate.py"""
import unittest
...
class TestPreCommitmentSupervisionPeriod(unittest.TestCase):
    ...
    @staticmethod
    def _test_us_ix_pre_commitment_supervision_period(
        admission_date: date,
    ...
    def test_us_ix_pre_commitment_supervision_period(self) -> None:
        ...
        self.assertEqual(
            ...
            self._test_us_ix_pre_commitment_supervision_period(

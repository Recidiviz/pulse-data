...
# =============================================================================
"""Tests for the us_ix_supervision_period_normalization_delegate.py file"""
import unittest
...
class TestUsIxSupervisionPeriodNormalizationDelegate(unittest.TestCase):
    """Unit tests for UsIxSupervisionPreProcdessingDelegate"""

    def setUp(self) -> None:
        self.upper_bound_date = date(2018, 10, 10)
        self.delegate = UsIxSupervisionNormalizationDelegate()

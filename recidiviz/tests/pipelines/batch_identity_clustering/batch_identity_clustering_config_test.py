...
# =============================================================================
"""Tests for BatchIdentityClusteringConfig."""
import os
import tempfile
import unittest

from recidiviz.common.constants.identity import PersonType
from recidiviz.pipelines.batch_identity_clustering.batch_identity_clustering_config import (
...
class BatchIdentityClusteringTenantConfigTest(unittest.TestCase):
    """Tests for BatchIdentityClusteringTenantConfig."""

    def test_get_max_ids_for_type_uses_override(self) -> None:
        config = BatchIdentityClusteringTenantConfig(
...
class BatchIdentityClusteringConfigTest(unittest.TestCase):
    """Tests for BatchIdentityClusteringConfig."""

    def setUp(self) -> None:
        self.config = BatchIdentityClusteringConfig.load_clustering_config()
    ...
    def test_load_clustering_config_loads_overrides_from_state_config(self) -> None:
        with tempfile.TemporaryDirectory() as regions_dir:
            ...
            config = BatchIdentityClusteringConfig.load_clustering_config(

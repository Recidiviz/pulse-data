...
# =============================================================================
"""Unit tests for BatchIdentityClusteringPipelineParameters"""
import json
import unittest
...
class TestBatchIdentityClusteringPipelineParameters(unittest.TestCase):
    """Unit tests for BatchIdentityClusteringPipelineParameters"""

    def test_creation_all_fields(self) -> None:
        pipeline_parameters = BatchIdentityClusteringPipelineParameters(
        ...
        self.assertEqual(
            pipeline_parameters.job_name, "us-oz-batch-identity-clustering"
        )
        self.assertEqual(
    ...
    def test_creation_with_sandbox_prefix(self) -> None:
        ...
        self.assertEqual(
            ...
            "my-prefix-us-oz-batch-identity-clustering-test",
        )

        self.assertEqual("us_oz_raw_data", pipeline_parameters.raw_data_input_dataset)
        self.assertEqual(
            "my_prefix_batch_identity_clustering",
            pipeline_parameters.clustering_output_dataset,
        )
        self.assertTrue(pipeline_parameters.is_sandbox_pipeline)
    ...
    def test_secondary_instance_no_prefix_set(self) -> None:
        with self.assertRaisesRegex(
            ...
            _ = BatchIdentityClusteringPipelineParameters(
                project="recidiviz-456",
                tenant="US_OZ",
                pipeline="test_pipeline_name",
                region="us-east1",
    ...
    def test_non_state_tenant_raw_data_raises(self) -> None:
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"No support for batch clustering pipeline with non-state tenants.",
        ):
    ...
    def test_pipeline_entry_point_parses(self) -> None:
        ...
        args, _ = BatchIdentityClusteringPipelineParameters.parse_args(

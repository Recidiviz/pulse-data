...
view: tagBasicData {
  ...
  sql_table_name: {% if view_type._parameter_value == 'raw_data' %} us_xx_raw_data.tagBasicData
    {% elsif view_type._parameter_value == 'raw_data_up_to_date_views' %} us_xx_raw_data_up_to_date_views.tagBasicData_latest
    {% endif %} ;;

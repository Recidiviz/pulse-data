...
class CopyBQViewsTest(unittest.TestCase):
    ...
    def table_exists_side_effect(self, dataset_ref: bigquery.DatasetReference, table_id: str) -> bool:
    ...
    def test_copy_bq_views(self, mock_table_exists: mock.MagicMock, mock_copy_view: mock.MagicMock) -> None:
        ...
        self.assertEqual(self.mock_destination_project_id,
                         mock_copy_view.call_args_list[0][1].get('destination_client').project_id)
        self.assertEqual(expected_destination_dataset_ref,

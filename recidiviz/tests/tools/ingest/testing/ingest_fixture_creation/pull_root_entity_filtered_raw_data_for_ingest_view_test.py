...
def test_get_raw_data_dependency_subsets() -> None:
    ...
    assert queries == {
        "AZ_DOC_DRUG_TRAN_PRG_ELIG": (
            ...
            'JOIN project.dataset.DOC_EPISODE ON AZ_DOC_DRUG_TRAN_PRG_ELIG.DOC_ID = DOC_EPISODE.DOC_ID WHERE DOC_EPISODE.PERSON_ID IN ("12345")'
        ),
        "AZ_DOC_SC_ARS_CODE": (
        ...
        "AZ_DOC_SC_COMMITMENT": (
            ...
            'JOIN project.dataset.DOC_EPISODE ON AZ_DOC_SC_EPISODE.DOC_ID = DOC_EPISODE.DOC_ID WHERE DOC_EPISODE.PERSON_ID IN ("12345")'
        ),
        "AZ_DOC_SC_EPISODE": (
        ...
        "AZ_DOC_TRANSITION_PRG_ELIG": (
            ...
            'JOIN project.dataset.DOC_EPISODE ON AZ_DOC_TRANSITION_PRG_ELIG.DOC_ID = DOC_EPISODE.DOC_ID WHERE DOC_EPISODE.PERSON_ID IN ("12345")'
        ),
        "DOC_EPISODE": (

...
def view_builder() -> List[FakeBigQueryViewBuilder]:
    return [FakeBigQueryViewBuilder(GOOD_VIEW_5)]


def helloooooooooooooooooooo_view_builder() -> List[FakeBigQueryViewBuilder]:
    return [FakeBigQueryViewBuilder(GOOD_VIEW_5)]

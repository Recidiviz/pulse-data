...
class AttrValidatorsTest(unittest.TestCase):
    ...
    def test_is_float_between_zero_and_one_validator(self) -> None:
        @attr.s
        class _TestClass:
            my_float: float = attr.ib(
                validator=attr_validators.is_float_between_zero_and_one
            )
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"Field \[my_float\] on \[_TestClass\] must be between 0 and 1, "
            r"inclusive. Found value \[-0.5\]",
        ):
            _ = _TestClass(my_float=-0.5)
        ...
        # Both bounds are inclusive, and ints are allowed.
        _ = _TestClass(my_float=0.0)
        _ = _TestClass(my_float=0.85)
        _ = _TestClass(my_float=1.0)
        _ = _TestClass(my_float=1)

    ...
    def test_import_gcs_csv_to_cloud_sql_with_region_code(self) -> None:
        ...
        def _mock_side_effect(**_kwargs: Any) -> str:
            return self._mock_load_data_from_csv(
                values=[
                    "('US_MO', 'user-2@test.gov', '{2}', 'level_1_supervision_location', 'level_1_access_role', true, false, 'null')",
                    "('US_MO', 'user-3@test.gov', '{3}', 'level_1_supervision_location', 'level_1_access_role', true, false, 'null')",
                ]
            )

...
COMMON_VESTIGES = [
    ...
    "jii_backend_production_segment_metrics.identifies",
    "jii_backend_production_segment_metrics.tracks",
    "jii_backend_production_segment_metrics.users",
    ...
    # Newly-registered meetings postgres export tables for states not yet referenced
    # by the cross-state union view (added in a stacked PR); not vestigial once that
    # view merges.
    "meetings_dashboards_db_us_az.Client",
    "meetings_dashboards_db_us_az.Meeting",
    "meetings_dashboards_db_us_az.NotetakingAgentExecution",
    "meetings_dashboards_db_us_az.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_az.NotetakingPipelineRun",
    "meetings_dashboards_db_us_az.OutputVote",
    "meetings_dashboards_db_us_az.Resident",
    "meetings_dashboards_db_us_az.Staff",
    "meetings_dashboards_db_us_az.Transcription",
    "meetings_dashboards_db_us_az.Utterance",
    "meetings_dashboards_db_us_co.Client",
    "meetings_dashboards_db_us_co.Meeting",
    "meetings_dashboards_db_us_co.NotetakingAgentExecution",
    "meetings_dashboards_db_us_co.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_co.NotetakingPipelineRun",
    "meetings_dashboards_db_us_co.OutputVote",
    "meetings_dashboards_db_us_co.Resident",
    "meetings_dashboards_db_us_co.Staff",
    "meetings_dashboards_db_us_co.Transcription",
    "meetings_dashboards_db_us_co.Utterance",
    "meetings_dashboards_db_us_ix.Client",
    "meetings_dashboards_db_us_ix.Meeting",
    "meetings_dashboards_db_us_ix.NotetakingAgentExecution",
    "meetings_dashboards_db_us_ix.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_ix.NotetakingPipelineRun",
    "meetings_dashboards_db_us_ix.OutputVote",
    "meetings_dashboards_db_us_ix.Resident",
    "meetings_dashboards_db_us_ix.Staff",
    "meetings_dashboards_db_us_ix.Transcription",
    "meetings_dashboards_db_us_ix.Utterance",
    "meetings_dashboards_db_us_nc.Client",
    "meetings_dashboards_db_us_nc.Meeting",
    "meetings_dashboards_db_us_nc.NotetakingAgentExecution",
    "meetings_dashboards_db_us_nc.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_nc.NotetakingPipelineRun",
    "meetings_dashboards_db_us_nc.OutputVote",
    "meetings_dashboards_db_us_nc.Resident",
    "meetings_dashboards_db_us_nc.Staff",
    "meetings_dashboards_db_us_nc.Transcription",
    "meetings_dashboards_db_us_nc.Utterance",
    "meetings_dashboards_db_us_nd.Client",
    "meetings_dashboards_db_us_nd.Meeting",
    "meetings_dashboards_db_us_nd.NotetakingAgentExecution",
    "meetings_dashboards_db_us_nd.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_nd.NotetakingPipelineRun",
    "meetings_dashboards_db_us_nd.OutputVote",
    "meetings_dashboards_db_us_nd.Resident",
    "meetings_dashboards_db_us_nd.Staff",
    "meetings_dashboards_db_us_nd.Transcription",
    "meetings_dashboards_db_us_nd.Utterance",
    "meetings_dashboards_db_us_tn.Client",
    "meetings_dashboards_db_us_tn.Meeting",
    "meetings_dashboards_db_us_tn.NotetakingAgentExecution",
    "meetings_dashboards_db_us_tn.NotetakingEvaluationRun",
    "meetings_dashboards_db_us_tn.NotetakingPipelineRun",
    "meetings_dashboards_db_us_tn.OutputVote",
    "meetings_dashboards_db_us_tn.Resident",
    "meetings_dashboards_db_us_tn.Staff",
    "meetings_dashboards_db_us_tn.Transcription",
    "meetings_dashboards_db_us_tn.Utterance",

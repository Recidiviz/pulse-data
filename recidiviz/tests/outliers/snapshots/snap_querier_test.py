...
snapshots[
    ...
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='3', middle_names='', name_suffix=''), external_id='03', pseudonymized_id='officerhash3', supervisor_external_id='102', district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'absconsions_bench_warrants', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-04-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-03-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-02-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-01-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2022-12-01', 'metric_rate': 0.8}]}], top_x_pct_metrics=[{'metric_id': 'incarceration_starts_and_inferred', 'top_x_pct': 10}])"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='4', middle_names='', name_suffix=''), external_id='04', pseudonymized_id='officerhash4', supervisor_external_id='102', district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'task_completions_transfer_to_limited_supervision', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0}, {'status': 'FAR', 'end_date': '2023-04-01', 'metric_rate': 0}]}], top_x_pct_metrics=[])"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='6', middle_names='', name_suffix=''), external_id='06', pseudonymized_id='officerhash6', supervisor_external_id='102', district='2', caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[])"
    ),
]
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='3', middle_names='', name_suffix=''), external_id='03', pseudonymized_id='officerhash3', supervisor_external_id='102', district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'absconsions_bench_warrants', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0.8}]}], top_x_pct_metrics=[{'metric_id': 'incarceration_starts_and_inferred', 'top_x_pct': 10}])"
)

snapshots[
    "TestOutliersQuerier.TestOutliersQuerier test_get_supervision_officer_entity_found_match_not_top_x_pct"
] = GenericRepr(
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='9', middle_names='', name_suffix=''), external_id='09', pseudonymized_id='officerhash9', supervisor_external_id='103', district=None, caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[])"
)
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='7', middle_names='', name_suffix=''), external_id='07', pseudonymized_id='officerhash7', supervisor_external_id='101', district='1', caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[])"
)

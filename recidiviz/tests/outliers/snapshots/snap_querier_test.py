...
snapshots[
    ...
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='3', middle_names='', name_suffix=''), external_id='OFFICER3', pseudonymized_id='officerhash3', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=54.321, earliest_person_assignment_date=None, zero_grant_opportunities=['usPaAdminSupervision', 'usPaSpecialCircumstancesSupervision'], latest_login_date=datetime.date(2024, 12, 13), has_consistent_login_activity=True)"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='4', middle_names='', name_suffix=''), external_id='OFFICER4', pseudonymized_id='officerhash4', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=3.45, earliest_person_assignment_date=datetime.date(2020, 6, 15), zero_grant_opportunities=['usPaAdminSupervision'], latest_login_date=datetime.date(2024, 12, 12), has_consistent_login_activity=True)"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='6', middle_names='', name_suffix=''), external_id='OFFICER6', pseudonymized_id='officerhash6', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=90.09, earliest_person_assignment_date=datetime.date(2022, 4, 15), zero_grant_opportunities=['usPaSpecialCircumstancesSupervision'], latest_login_date=datetime.date(2024, 12, 10), has_consistent_login_activity=True)"
    ),
]
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='1', middle_names='', name_suffix=''), external_id='OFFICER1', pseudonymized_id='officerhash1', supervisor_external_id='101', supervisor_external_ids=['101', '104'], district='1', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=59.95, earliest_person_assignment_date=datetime.date(2024, 4, 15), zero_grant_opportunities=['usPaSpecialCircumstancesSupervision'], latest_login_date=datetime.date(2024, 12, 15), has_consistent_login_activity=True)"
)
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='9', middle_names='', name_suffix=''), external_id='OFFICER9', pseudonymized_id='officerhash9', supervisor_external_id='103', supervisor_external_ids=['103'], district='2', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=99.9, earliest_person_assignment_date=datetime.date(2020, 6, 15), zero_grant_opportunities=[], latest_login_date=datetime.date(2024, 12, 7), has_consistent_login_activity=True)"
)
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='7', middle_names='', name_suffix=''), external_id='OFFICER7', pseudonymized_id='officerhash7', supervisor_external_id='101', supervisor_external_ids=['101'], district='1', email='officer1@recidiviz.org', include_in_outcomes=True, avg_daily_population=23.456, earliest_person_assignment_date=datetime.date(2018, 4, 15), zero_grant_opportunities=['usPaAdminSupervision'], latest_login_date=datetime.date(2024, 12, 9), has_consistent_login_activity=True)"
)

...
snapshots[
    ...
    GenericRepr(
        "SupervisionOfficerOutcomes(external_id='04', pseudonymized_id='officerhash4', outlier_metrics=[], top_x_pct_metrics=[], caseload_category='ALL')"
    ),
    GenericRepr(
...
snapshots[
    ...
    GenericRepr(
        "SupervisionOfficerOutcomes(external_id='04', pseudonymized_id='officerhash4', outlier_metrics=[], top_x_pct_metrics=[], caseload_category='NOT_SEX_OFFENSE')"
    ),
    GenericRepr(

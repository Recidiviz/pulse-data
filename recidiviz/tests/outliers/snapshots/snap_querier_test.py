...
snapshots[
    ...
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='3', middle_names='', name_suffix=''), external_id='03', pseudonymized_id='officerhash3', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'absconsions_bench_warrants', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-04-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-03-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-02-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2023-01-01', 'metric_rate': 0.8}, {'status': 'FAR', 'end_date': '2022-12-01', 'metric_rate': 0.8}]}], top_x_pct_metrics=[{'metric_id': 'incarceration_starts_and_inferred', 'top_x_pct': 10}], avg_daily_population=54.321)"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='4', middle_names='', name_suffix=''), external_id='04', pseudonymized_id='officerhash4', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'task_completions_transfer_to_limited_supervision', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0}, {'status': 'FAR', 'end_date': '2023-04-01', 'metric_rate': 0}]}], top_x_pct_metrics=[], avg_daily_population=3.45)"
    ),
    GenericRepr(
        "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='6', middle_names='', name_suffix=''), external_id='06', pseudonymized_id='officerhash6', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[], avg_daily_population=90.09)"
    ),
]
...
snapshots[
    ...
    "OutliersProductConfiguration(updated_by='alexa@recidiviz.org', updated_at=datetime.datetime(2024, 1, 26, 13, 30), feature_variant=None, metrics=[OutliersMetricConfig(name='incarceration_starts_and_inferred', outcome_type=<MetricOutcome.ADVERSE: 'ADVERSE'>, title_display_name='Incarceration Rate (CPVs & TPVs)', body_display_name='incarceration rate', event_name='incarcerations', event_name_singular='incarceration', event_name_past_tense='were incarcerated', description_markdown='', metric_event_conditions_string=None, top_x_pct=None), OutliersMetricConfig(name='incarceration_starts_and_inferred_technical_violation', outcome_type=<MetricOutcome.ADVERSE: 'ADVERSE'>, title_display_name='Technical Incarceration Rate (TPVs)', body_display_name='technical incarceration rate', event_name='technical incarcerations', event_name_singular='technical incarceration', event_name_past_tense='had a technical incarceration', description_markdown='', metric_event_conditions_string=None, top_x_pct=None), OutliersMetricConfig(name='absconsions_bench_warrants', outcome_type=<MetricOutcome.ADVERSE: 'ADVERSE'>, title_display_name='Absconsion Rate', body_display_name='absconsion rate', event_name='absconsions', event_name_singular='absconsion', event_name_past_tense='absconded', description_markdown='', metric_event_conditions_string=None, top_x_pct=None)], learn_more_url='fake.com', supervision_officer_label='agent', supervision_district_label='district', supervision_unit_label='unit', supervision_supervisor_label='supervisor', supervision_district_manager_label='district manager', supervision_jii_label='client', none_are_outliers_label='are outliers', worse_than_rate_label='Far worse than statewide rate', exclusion_reason_description='excluded because x', slightly_worse_than_rate_label='slightly worse than statewide rate', at_or_below_rate_label='At or below statewide rate', at_or_above_rate_label='At or above statewide rate', client_events=[], outliers_hover='Has a rate on any metric significantly higher than peers - over 1 Interquartile Range above the statewide rate.', doc_label='DOC', absconder_label='absconder')"
)

snapshots[
    "TestOutliersQuerier.TestOutliersQuerier test_get_supervision_officer_entity_found_match"
] = GenericRepr(
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='3', middle_names='', name_suffix=''), external_id='03', pseudonymized_id='officerhash3', supervisor_external_id='102', supervisor_external_ids=['102'], district='2', caseload_type=None, outlier_metrics=[{'metric_id': 'absconsions_bench_warrants', 'statuses_over_time': [{'status': 'FAR', 'end_date': '2023-05-01', 'metric_rate': 0.8}]}], top_x_pct_metrics=[{'metric_id': 'incarceration_starts_and_inferred', 'top_x_pct': 10}], avg_daily_population=54.321)"
)

snapshots[
    "TestOutliersQuerier.TestOutliersQuerier test_get_supervision_officer_entity_found_match_not_top_x_pct"
] = GenericRepr(
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='9', middle_names='', name_suffix=''), external_id='09', pseudonymized_id='officerhash9', supervisor_external_id='103', supervisor_external_ids=['103'], district=None, caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[], avg_daily_population=99.9)"
)
...
snapshots[
    ...
    "SupervisionOfficerEntity(full_name=PersonName(given_names='Officer', surname='7', middle_names='', name_suffix=''), external_id='07', pseudonymized_id='officerhash7', supervisor_external_id='101', supervisor_external_ids=['101'], district='1', caseload_type=None, outlier_metrics=[], top_x_pct_metrics=[], avg_daily_population=23.456)"
)

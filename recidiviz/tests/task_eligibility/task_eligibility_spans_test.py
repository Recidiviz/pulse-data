...
class TestGetUnionedViewBuilders(unittest.TestCase):
    ...
    def test_get_unioned_view_builders(self) -> None:
        ...
        expected_all_tasks_view_addresses = [
            ...
            BigQueryAddress(
                dataset_id="task_eligibility_candidates_us_mi",
                table_id="all_state_specific_candidate_populations",
            ),
            BigQueryAddress(
                dataset_id="task_eligibility_candidates_us_ar",
                table_id="all_state_specific_candidate_populations",
            ),
            BigQueryAddress(
                dataset_id="task_eligibility_candidates_us_ne",
                table_id="all_state_specific_candidate_populations",
            ),
            BigQueryAddress(
            ...
            BigQueryAddress(
                dataset_id="task_eligibility_criteria_us_co",
                table_id="all_state_specific_criteria",
            ),
            BigQueryAddress(

...
class WorkflowsQuerier:
    ...
    def add_config(
        ...
        *,
        ...
        strictly_ineligible_criteria_copy: list[dict[str, str]],
        ...
        supports_supervisor_review_on_grants: bool,
        supports_supervisor_review_on_snooze: bool,
        reasons_requiring_approval: list[str],
        supervisor_review_tab_title: str | None,
        grant_approved_tab_title: str | None,
        grant_approved_status_message: str | None,
        snooze_review_status_message: str | None,
        grant_review_status_message: str | None,
        grant_review_dropdown_label: str | None,
        reviewer_feature_variant: str | None,
        ...
        enabled_columns: list[dict[str, str | None]],
        ...
        with self.database_session() as session:
            ...
            insert_statement = (
                ...
                .values(
                    ...
                    strictly_ineligible_criteria_copy=strictly_ineligible_criteria_copy,
                    ...
                    supports_supervisor_review_on_grants=supports_supervisor_review_on_grants,
                    supports_supervisor_review_on_snooze=supports_supervisor_review_on_snooze,
                    reasons_requiring_approval=reasons_requiring_approval,
                    supervisor_review_tab_title=supervisor_review_tab_title,
                    grant_approved_tab_title=grant_approved_tab_title,
                    grant_approved_status_message=grant_approved_status_message,
                    snooze_review_status_message=snooze_review_status_message,
                    grant_review_status_message=grant_review_status_message,
                    grant_review_dropdown_label=grant_review_dropdown_label,
                    reviewer_feature_variant=reviewer_feature_variant,

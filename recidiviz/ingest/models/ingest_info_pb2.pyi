...
class StateAlias(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"alias_type",b"full_name",b"given_names",b"middle_names",b"name_suffix",b"state_alias_id",b"state_code",b"surname"]) -> None: ...
...
class StateCharge(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"attempted",b"charge_notes",b"charging_entity",b"classification_subtype",b"classification_type",b"counts",b"county_code",b"date_charged",b"description",b"is_controlling",b"ncic_code",b"offense_date",b"state_bond_id",b"state_charge_id",b"state_code",b"state_court_case_id",b"status",b"statute"]) -> None: ...

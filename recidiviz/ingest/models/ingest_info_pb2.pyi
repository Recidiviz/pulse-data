...
class IngestInfo(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"arrests",u"bonds",u"bookings",u"charges",u"holds",u"people",u"sentence_relationships",u"sentences"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"arrests",b"bonds",b"bookings",b"charges",b"holds",b"people",b"sentence_relationships",b"sentences"]) -> None: ...
...
class Person(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"age",u"birthdate",u"ethnicity",u"full_name",u"gender",u"given_names",u"middle_names",u"name_suffix",u"person_id",u"place_of_residence",u"race",u"surname"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"age",u"birthdate",u"booking_ids",u"ethnicity",u"full_name",u"gender",u"given_names",u"middle_names",u"name_suffix",u"person_id",u"place_of_residence",u"race",u"surname"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"age",b"birthdate",b"booking_ids",b"ethnicity",b"full_name",b"gender",b"given_names",b"middle_names",b"name_suffix",b"person_id",b"place_of_residence",b"race",b"surname"]) -> None: ...

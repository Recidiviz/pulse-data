...
class StateAlias(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"alias_id",u"full_name",u"given_names",u"middle_names",u"name_suffix",u"state_code",u"surname"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"alias_id",u"full_name",u"given_names",u"middle_names",u"name_suffix",u"state_code",u"surname"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"alias_id",b"alias_id",u"full_name",b"full_name",u"given_names",b"given_names",u"middle_names",b"middle_names",u"name_suffix",b"name_suffix",u"state_code",b"state_code",u"surname",b"surname"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"alias_id",b"full_name",b"given_names",b"middle_names",b"name_suffix",b"state_code",b"surname"]) -> None: ...
...
class StatePersonExternalId(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"external_id",u"id_type",u"state_code",u"state_person_external_id_id"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"external_id",u"id_type",u"state_code",u"state_person_external_id_id"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"external_id",b"external_id",u"id_type",b"id_type",u"state_code",b"state_code",u"state_person_external_id_id",b"state_person_external_id_id"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"external_id",b"id_type",b"state_code",b"state_person_external_id_id"]) -> None: ...
...
class StateIncarcerationIncident(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"county_code",u"incident_date",u"location_within_facility",u"offense",u"outcome",u"responding_officer_id",u"state_code",u"state_incarceration_incident_id"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"county_code",u"incident_date",u"location_within_facility",u"offense",u"outcome",u"responding_officer_id",u"state_code",u"state_incarceration_incident_id"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"county_code",b"county_code",u"incident_date",b"incident_date",u"location_within_facility",b"location_within_facility",u"offense",b"offense",u"outcome",b"outcome",u"responding_officer_id",b"responding_officer_id",u"state_code",b"state_code",u"state_incarceration_incident_id",b"state_incarceration_incident_id"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"county_code",b"incident_date",b"location_within_facility",b"offense",b"outcome",b"responding_officer_id",b"state_code",b"state_incarceration_incident_id"]) -> None: ...
...
class StateParoleDecision(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"corrective_action",b"corrective_action_deadline",b"county_code",b"decision_agent_ids",b"decision_date",b"decision_outcome",b"decision_reasoning",b"received_parole",b"state_code",b"state_parole_decision_id"]) -> None: ...
...
class StateSupervisionViolationResponse(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"deciding_body_type",b"decision",b"response_date",b"response_type",b"revocation_type",b"state_code",b"state_supervision_violation_response_id"]) -> None: ...
...
class StateAgent(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"agent_type",b"full_name",b"state_agent_id",b"state_code"]) -> None: ...

...
_INGESTINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state_supervision_violation_responses', full_name='recidiviz.ingest.models.IngestInfo.state_supervision_violation_responses', index=26,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state_agents', full_name='recidiviz.ingest.models.IngestInfo.state_agents', index=27,

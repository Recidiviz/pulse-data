...
# =============================================================================
"""Raw data import download delegate for US_MA"""
...
class UsMaRawDataImportDelegate(BaseRawDataImportDelegate):
    def coalesce_chunked_files(
        ...
        """As of 3/6/2025, there are no chunked files in US_MA"""

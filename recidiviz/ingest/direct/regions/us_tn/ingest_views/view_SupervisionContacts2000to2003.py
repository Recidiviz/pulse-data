...
WHERE CAST(ContactNoteDateTime AS DATETIME) >= CAST('2000-01-01' AS DATETIME)
AND CAST(ContactNoteDateTime AS DATETIME) < CAST('2003-01-01' AS DATETIME)
"""
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    region="us_tn",
    ingest_view_name="SupervisionContacts2000to2003",

...
WHERE CAST(ContactNoteDateTime AS DATETIME) >= CAST('2017-01-01' AS DATETIME)
AND CAST(ContactNoteDateTime AS DATETIME) < CAST('2020-01-01' AS DATETIME)
"""
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    region="us_tn",
    ingest_view_name="SupervisionContacts2017to2020",

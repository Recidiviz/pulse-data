...
WHERE CAST(ContactNoteDateTime AS DATETIME) >= CAST('1990-01-01' AS DATETIME)
AND CAST(ContactNoteDateTime AS DATETIME) < CAST('1995-01-01' AS DATETIME)
"""
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    region="us_tn",
    ingest_view_name="SupervisionContacts1990to1995",

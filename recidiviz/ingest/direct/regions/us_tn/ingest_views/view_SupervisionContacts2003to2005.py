...
WHERE CAST(ContactNoteDateTime AS DATETIME) >= CAST('2003-01-01' AS DATETIME)
AND CAST(ContactNoteDateTime AS DATETIME) < CAST('2005-01-01' AS DATETIME)
"""
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    region="us_tn",
    ingest_view_name="SupervisionContacts2003to2005",

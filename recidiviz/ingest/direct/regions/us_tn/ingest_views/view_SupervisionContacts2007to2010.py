...
WHERE CAST(ContactNoteDateTime AS DATETIME) >= CAST('2007-01-01' AS DATETIME)
AND CAST(ContactNoteDateTime AS DATETIME) < CAST('2010-01-01' AS DATETIME)
"""
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    region="us_tn",
    ingest_view_name="SupervisionContacts2007to2010",

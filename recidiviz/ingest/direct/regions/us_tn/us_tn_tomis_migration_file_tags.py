...
MICASE_FILE_TAGS: frozenset[str] = frozenset(
    {
        ...
        "CM_IGP_GOAL",
        "CM_IGP_OBJECTIVES",
        "CM_INMATE_ASSIGNMENT",
        "CS_CASE_AGENT",
        "CS_CHRONO_NOTES",
        "CS_INTAKE_ASSIGNMENT",
        "CS_OMS_CASE_PLAN",
        "CS_OMS_CN_CONTACT",
        "CS_OMS_CONDITION",
        "CS_OMS_OFF_ADDRESS",
        "CS_OMS_SENTENCE_INFO",
        "CS_OMS_SUP_CL",
        "CS_OMS_SUP_FEE",
        "CS_OMS_SUP_FEE_HIST",
        "CS_OMS_SUP_LEVEL_HIST",
        ...
        "IN_PREA_AGGRESSOR_MONITORING_REVIEW",
        "IN_PREA_END_MONITORING_REQUEST_REVIEW",
        "IN_PREA_REVIEW",
        "IN_PREA_VICTIM_MONITORING_REVIEW",
        "IN_RELATIONSHIP",
        "INT_HEALTH_ASSESSMENT",
        ...
        "MEA_USERS",
        "PB_BOARD_MEMBER",
        "PB_FINAL_HEARING_BOARD_VOTE",
        "PB_HEARING_BOARD_VOTE",
        "PB_HEARING_RESULT",
        "PB_NOTIF_ADD_INFO",
        "PB_PAROLE_HEARING",
        "PB_VOTE_SUMMARY",
        ...
        "PR_PROGRAM",
        "PR_PROGRAM_DETAIL",
        "PR_PROGRAM_DETAIL_WAITLIST",
        "PR_SESSION_PARTICIPATION",
        "PREA_INVESTIGATIVE_OUTCOME",
        "PREA_INVESTIGATIVE_OUTCOME_HIST",
        ...
        "RMS_HOME_PLAN",
        "RMS_HOME_PLAN_APPROVAL",
        "RMS_HOME_PLAN_DETAIL",
        "RMS_ISC",
        "RMS_PLACEMENT",
        "RMS_RELEASEINFO",
        "RMS_VLTN_INFO",

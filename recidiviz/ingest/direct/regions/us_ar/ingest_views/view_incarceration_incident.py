...
unpivoted_violation_codes AS (
  ...
  FROM (
    SELECT
      OFFENDERID,VIOLATIONDATETIME,DISCVIOLFAC,DISCSTATUSCODE,DISCVIOLSTATUSDT,HRGDATETIME,RPTDATETIME,TYPEOFDISCCODE,REPRIMANDFLAG,ISOLATIONDAYSTOSERVE,EXTRADUTYHOURSASSIGNED,RESTRICTDAYSMAX,TIMEFORFEITINDAYS,RESTITUTIONTOBEPAID,
...
unpivoted_violation_outcomes AS (
  ...
  FROM (
    SELECT 
      OFFENDERID,VIOLATIONDATETIME,DISCVIOLFAC,DISCSTATUSCODE,DISCVIOLSTATUSDT,HRGDATETIME,RPTDATETIME,TYPEOFDISCCODE,violation_seq,DISCCODEVIOL,
    ...
    FROM unpivoted_violation_codes
    UNION ALL 
      SELECT OFFENDERID,VIOLATIONDATETIME,DISCVIOLFAC,DISCSTATUSCODE,DISCVIOLSTATUSDT,HRGDATETIME,RPTDATETIME,TYPEOFDISCCODE,violation_seq,DISCCODEVIOL,

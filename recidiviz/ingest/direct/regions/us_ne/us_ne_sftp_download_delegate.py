...
# =============================================================================
"""Class containing logic for how US_NE SFTP downloads are handled."""
...
class UsNeSftpDownloadDelegate(BaseSftpDownloadDelegate):
    """Class containing logic for how US_NE SFTP downloads are handled."""
    ...
    def _matches(self, path: str) -> bool:
        """Directory names must match TheData_YYYY_MM_DD"""
    ...
    def filter_paths(self, candidate_paths: List[str]) -> List[str]:
        """For US_NE, find all file uploads that match TheData_YYYY_MM_DD format."""
        return [
            candidate_path
    ...
    def post_process_downloads(
        ...
        """For US_NE, the downloaded path is the same that will be streamed directly to GCS."""

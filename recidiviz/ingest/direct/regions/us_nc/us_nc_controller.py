...
# =============================================================================
"""Direct ingest controller implementation for US_NC."""
...
class UsNcController(BaseDirectIngestController):
    """Direct ingest controller implementation for US_NC."""

    @classmethod
    def region_code(cls) -> str:
        return StateCode.US_NC.value.lower()
    ...
    def _get_ingest_view_rank_list(
        ...
        return ["incarceration_state_person", "incarceration_periods"]

...
-- exclude when prev and current dates are null
WHERE NOT(PREV_EARLY_TERMINATION_DATE IS NULL AND EARLY_TERMINATION_DATE IS NULL) 
-- include first entry
AND PREV_EARLY_TERMINATION_DATE IS NULL
-- include every change to early termination date
OR PREV_EARLY_TERMINATION_DATE != EARLY_TERMINATION_DATE
"""

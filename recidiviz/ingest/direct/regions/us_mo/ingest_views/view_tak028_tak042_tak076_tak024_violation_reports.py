...
VIEW_QUERY_TEMPLATE = f"""
    ...
    SELECT
        ...
        BY_VIL,
        CASE WHEN BY_VOR IN ("CO","RN","NOREC") THEN BY_VOR ELSE ARRAY_TO_STRING(SPLIT(BY_VOR,""),",") END as BY_VOR,
        BY_PIN,BY_PLN,BY_PON,BY_RCA,
        ARRAY_TO_STRING(SPLIT(BY_VTY,""),",") as BY_VTY,
        BY_DV,BY_UID,BY_UIU,VIOLATED_CONDITIONS,CZ_DOC,CZ_CYC,CZ_SEO,

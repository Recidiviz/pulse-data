...
-- opportunities.
and upper(l.DESCRIPTION) not in ("NO CHARGES FILED", "PENDING CHARGES", "DISCIPLINE VIOLATION", "NOT PROCESSED", "SET ASIDE", "VACATE", "EXPUNGED", "COMMUTED", "PARDON", "DISMISSED", "UNKNOWN", "NOT GUILTY", "DRUG COURT", "PENDING CHARGES")

...
SELECT
    ...
    CASE
        ...
        ELSE TO_JSON_STRING(ARRAY_AGG(STRUCT<RESPONSE_DATE DATE, HEARING_PERIOD_ID STRING, VIOLATION_RESULT STRING>(RESPONSE_DATE, HEARING_PERIOD_ID, VIOLATION_RESULT) ORDER BY HEARING_PERIOD_ID))

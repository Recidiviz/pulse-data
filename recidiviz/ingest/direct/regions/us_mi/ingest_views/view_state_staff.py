...
-- Nulling out and cleaning invalid emails.
SELECT 
  employee_ids_omni,
  employee_ids_compas,
  first_name,
  ...
  last_name, 
  CASE 
    WHEN email_address LIKE  '%zz_locked%' THEN ''
    WHEN email_address LIKE '%>%' THEN  REPLACE(email_address, '>', '')
    ELSE email_address
  END AS email_address
FROM merging_staff_info
"""

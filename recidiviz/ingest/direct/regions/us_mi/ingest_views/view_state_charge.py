...
from {ADH_OFFENDER_CHARGE} charge
    ...
    left join {ADH_OFFENDER_BOOKING} book on charge.offender_booking_id = book.offender_booking_id
    -- inner join because offender_number is a required external_id for the state_person object
    inner join {ADH_OFFENDER} off on book.offender_id = off.offender_id
...
VIEW_BUILDER = DirectIngestPreProcessedIngestViewBuilder(
    ...
    order_by_cols="offender_number, offender_charge_id",
)

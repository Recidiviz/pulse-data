...
SELECT
    ...
    CAST(CREATED_DATE AS DATETIME AS DATE) as created_date,
    CAST(START_DATE AS DATETIME AS DATE) AS contact_start_date,
    CAST(END_DATE AS DATETIME AS DATE) AS contact_end_date,

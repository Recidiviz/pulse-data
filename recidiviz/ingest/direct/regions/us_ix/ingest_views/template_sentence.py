...
SENTENCE_QUERY_TEMPLATE = """
    ...
    WHERE SentenceLinkClassId = '3'  -- keep only "Sentence" sentences (as opposed to "Offense" sentences)
        AND ord.SentenceOrderEventTypeId IN ('1', '2') -- keep only "Initial" or "Amendment" sentence records (exclude "Error Correction", "Sentence Calculation", and NULLs)

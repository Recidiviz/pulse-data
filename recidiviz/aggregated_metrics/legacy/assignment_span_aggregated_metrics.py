...
# TODO(#35898): This function should become unused once we've migrated over to optimized
#  aggregated metrics queries for AssignmentSpanAggregatedMetrics.
...
, month_metrics AS ({get_assignment_span_time_specific_cte(

    ...
    for population_type, all_metrics in metrics_by_population_dict.items():
        ...
        for unit_of_analysis_type in units_of_analysis_by_population_dict[
            ...
            if not is_metric_class_supported_by_optimized_format(
                ...
                raise ValueError(
                    "Expected PeriodSpanAggregatedMetric to be generated by new "
            ...
            if not is_metric_class_supported_by_optimized_format(
                ...
                raise ValueError(
                    "Expected AssignmentSpanAggregatedMetric to be generated by new "
                    "optimized aggregated metric view collection."
                )
            ...
            if not is_metric_class_supported_by_optimized_format(
                ...
                raise ValueError(
                    "Expected AssignmentEventAggregatedMetric to be generated by new "
                    "optimized aggregated metric view collection."
                )

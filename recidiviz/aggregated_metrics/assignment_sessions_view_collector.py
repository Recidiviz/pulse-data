...
def _get_jii_tablet_app_provisioned_user_population_selector(
    population_type: MetricPopulationType,
) -> SpanSelector | None:
    """Returns the population SpanSelector for the
    MetricUnitOfObservationType.JII_TABLET_APP_PROVISIONED_USER population of the given population
    type.
    """
    match population_type:
        case MetricPopulationType.CUSTOM:
...
def get_standard_population_selector_for_unit_of_observation(
    ...
    match unit_of_observation_type:
        ...
        case MetricUnitOfObservationType.JII_TABLET_APP_PROVISIONED_USER:
            return _get_jii_tablet_app_provisioned_user_population_selector(
                population_type
            )

...
# TODO(#6455) - This queue should be created via the county-direct-ingest-resources
#  Terraform module and would ideally be renamed to "direct-ingest-jpp-scheduler-v2"
DIRECT_INGEST_SCHEDULER_QUEUE_V2 = "direct-ingest-scheduler-v2"

# TODO(#6455) - This queue should be created via the county-direct-ingest-resources
#  Terraform module and would ideally be renamed to "direct-ingest-jpp-bq-import-export-v2"

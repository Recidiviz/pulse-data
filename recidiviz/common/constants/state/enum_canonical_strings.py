...
state_incarceration_period_release_reason_released_from_erroneous_admission = 'RELEASED_FROM_ERRONEOUS_ADMISSION'
...
state_supervision_violation_response_decision_shock_incarceration = 'SHOCK_INCARCERATION'
...
state_supervision_violation_response_decision_treatment_in_prison = 'TREATMENT_IN_PRISON'

...
# =============================================================================
"""Functions for archiving Practices ETL data"""
...
def archive_etl_file(filename: str) -> None:
    """Given a storage blob name (assumed to be from the Practices ETL bucket),
    copies that file to the Practices ETL Archive bucket, stamped with today's date.

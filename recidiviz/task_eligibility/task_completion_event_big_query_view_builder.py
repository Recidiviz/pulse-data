...
class TaskCompletionEventType(Enum):
    ...
    EARLY_RELEASE_TO_DRUG_PROGRAM = "EARLY_RELEASE_TO_DRUG_PROGRAM"
    ...
    TRANSITIONAL_EARLY_RELEASE_DATE_SET = "TRANSITIONAL_EARLY_RELEASE_DATE_SET"
    DRUG_PROGRAM_EARLY_RELEASE_DATE_SET = "DRUG_PROGRAM_EARLY_RELEASE_DATE_SET"
    ...
    def system_type(self) -> WorkflowsSystemType:
        ...
        if self in [
            ...
            TaskCompletionEventType.DRUG_PROGRAM_EARLY_RELEASE_DATE_SET,
            TaskCompletionEventType.EARLY_RELEASE,
            TaskCompletionEventType.TRANSITIONAL_EARLY_RELEASE_DATE_SET,
            TaskCompletionEventType.EARLY_RELEASE_TO_DRUG_PROGRAM,

...
# =============================================================================
"""Defines a view with the transfers from MINIMUM supervision level to LIMITED supervision level"""
...
WHERE supervision_downgrade = 1
    AND previous_supervision_level = 'MINIMUM'
"""

VIEW_BUILDER: StateAgnosticTaskCompletionEventBigQueryViewBuilder = StateAgnosticTaskCompletionEventBigQueryViewBuilder(
    completion_event_type=TaskCompletionEventType.TRANSFER_TO_LIMITED_SUPERVISION_FROM_MINIMUM,
    description=__doc__,

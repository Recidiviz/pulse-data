...
# =============================================================================
"""Defines a view that shows all supervision level downgrade events from medium
...
WHERE supervision_downgrade = 1
    AND previous_supervision_level IN ('MEDIUM', 'MINIMUM')
"""

VIEW_BUILDER: StateAgnosticTaskCompletionEventBigQueryViewBuilder = StateAgnosticTaskCompletionEventBigQueryViewBuilder(
    completion_event_type=TaskCompletionEventType.SUPERVISION_LEVEL_DOWNGRADE_FROM_MEDIUM_OR_MINIMUM,
    description=__doc__,

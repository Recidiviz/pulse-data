...
# =============================================================================
"""Identifies people who have been released from a prison facility to LIMITED supervision 
in AZ"""
...
WHERE state_code = 'US_AZ'
  ...
  -- if the person was transferred from a prison facility to LIMITED supervision
  AND REGEXP_EXTRACT(supervision_level_raw_text, r'@@([^@]+)@@') = '35 DAY'
"""
VIEW_BUILDER: StateSpecificTaskCompletionEventBigQueryViewBuilder = (
    StateSpecificTaskCompletionEventBigQueryViewBuilder(
        state_code=StateCode.US_AZ,
        completion_event_type=TaskCompletionEventType.RELEASE_TO_LIMITED_SUPERVISION,
        description=__doc__,

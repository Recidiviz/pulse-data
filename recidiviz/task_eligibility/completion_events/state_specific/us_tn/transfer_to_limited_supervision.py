...
_QUERY_TEMPLATE = f"""
    ...
    WHERE state_code='US_TN'
        ...
        /* Restrict to sessions with raw-text levels not in the set of raw-text levels
        being used for the 2025 CR policy. */
        AND COALESCE(supervision_level_raw_text, 'UNKNOWN') NOT IN ({list_to_query_string(COMPLIANT_REPORTING_2025_POLICY_SUPERVISION_LEVELS_RAW_TEXT, quoted=True)})

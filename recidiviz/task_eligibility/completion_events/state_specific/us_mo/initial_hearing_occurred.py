...
_DESCRIPTION = """Defines a view that shows when initial Restrictive Housing hearings
that were scheduled have occurred, regardless of whether they were on time.
"""

# TODO(#25382): Fill in stub
_QUERY_TEMPLATE = """
    SELECT
        'US_MO' AS state_code,
        0 AS person_id,
...
VIEW_BUILDER: StateSpecificTaskCompletionEventBigQueryViewBuilder = (
    StateSpecificTaskCompletionEventBigQueryViewBuilder(
        ...
        completion_event_type=TaskCompletionEventType.INITIAL_HEARING_OCCURRED,

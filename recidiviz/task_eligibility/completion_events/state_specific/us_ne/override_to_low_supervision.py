...
# =============================================================================
"""Identifies when clients in NE have been overridden to the Low supervision level."""
...
_QUERY_TEMPLATE = supervision_oras_overrides_completion_event_query_template(
    overridden_to_level="LOW"
)

VIEW_BUILDER: StateSpecificTaskCompletionEventBigQueryViewBuilder = (
    StateSpecificTaskCompletionEventBigQueryViewBuilder(
        state_code=StateCode.US_NE,
        completion_event_type=TaskCompletionEventType.OVERRIDE_TO_LOW_SUPERVISION,
        description=__doc__,

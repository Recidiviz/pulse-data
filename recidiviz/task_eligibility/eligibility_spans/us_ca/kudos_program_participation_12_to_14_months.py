...
_DESCRIPTION = """Shows the spans of time during which someone in CA is eligible for an
attained program participation kudos. This span only lasts for two months after the
event happened and is only available to clients on PAROLE and not IN_CUSTODY.
"""

VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    state_code=StateCode.US_CA,
    task_name="kudos_program_participation_12_to_14_months",
    description=_DESCRIPTION,
    candidate_population_view_builder=parole_active_supervision_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        participated_in_programming_for_12_to_14_months.VIEW_BUILDER,
    ],

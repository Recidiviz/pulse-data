...
for an attained sustainable housing kudos. This span only lasts for two 
...
from recidiviz.task_eligibility.criteria.state_specific.us_ca import (
    sustainable_housing_for_0_to_2_months,
)
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="kudos_sustainable_housing_0_to_2_months",
    description=__doc__,
    candidate_population_view_builder=parole_active_supervision_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        sustainable_housing_for_0_to_2_months.VIEW_BUILDER,
    ],

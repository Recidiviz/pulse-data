...
for a 6 month violation free kudos. This span only lasts for two 
...
from recidiviz.task_eligibility.criteria.general import (
    no_supervision_violation_within_6_to_8_months_of_start,
)

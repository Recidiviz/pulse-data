...
for an maintained 12 months of employment kudos. This span only lasts for two months 
after the event happened and is only available to clients on PAROLE and not IN_CUSTODY.
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_ca import (
    employment_for_12_to_14_months,
)

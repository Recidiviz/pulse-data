...
for a 6 month sustainable housing kudos. This span only lasts for two 
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="kudos_sustainable_housing_6_to_8_months",
    description=__doc__,
    candidate_population_view_builder=parole_active_supervision_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        sustainable_housing_for_6_to_8_months.VIEW_BUILDER,
    ],

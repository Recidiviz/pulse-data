...
someone in MI is eligible to have supervision level downgrade.
"""
...
_DESCRIPTION = """Shows the spans of time during which someone in MI may be eligible to have their supervision
level downgraded.
"""

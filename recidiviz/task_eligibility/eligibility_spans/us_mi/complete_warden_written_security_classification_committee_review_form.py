...
someone in MI is eligible for a written security committee classification review from the warden
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_mi import (
    not_past_warden_in_person_review_for_scc_date,
    past_warden_written_review_for_scc_date,
)
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="COMPLETE_WARDEN_WRITTEN_SECURITY_CLASSIFICATION_COMMITTEE_REVIEW_FORM",
    description=_DESCRIPTION,
    candidate_population_view_builder=incarceration_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        past_warden_written_review_for_scc_date.VIEW_BUILDER,
        not_past_warden_in_person_review_for_scc_date.VIEW_BUILDER,

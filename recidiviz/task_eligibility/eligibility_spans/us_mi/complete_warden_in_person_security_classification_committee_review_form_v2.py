...
"""Shows the spans of time during which someone in MI is eligible for an in person
 security classification committee review from the warden, per 2026 policy"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_mi import (
    six_months_since_last_warden_in_person_scc_review,
)
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="COMPLETE_WARDEN_IN_PERSON_SECURITY_CLASSIFICATION_COMMITTEE_REVIEW_FORM_V2",
    description=__doc__,
    candidate_population_view_builder=ad_seg_scc_solitary_incarceration_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        six_months_since_last_warden_in_person_scc_review.VIEW_BUILDER,
    ],

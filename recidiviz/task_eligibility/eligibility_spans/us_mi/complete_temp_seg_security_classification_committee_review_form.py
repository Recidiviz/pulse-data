...
# =============================================================================
"""Shows the spans of time during which someone in MI is in temp seg and eligible for
...
from recidiviz.task_eligibility.candidate_populations.state_specific.us_mi import (
    temp_seg_scc_solitary_incarceration_population,
)
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="COMPLETE_TEMP_SEG_SECURITY_CLASSIFICATION_COMMITTEE_REVIEW_FORM",
    description=__doc__,
    candidate_population_view_builder=temp_seg_scc_solitary_incarceration_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        StateSpecificTaskCriteriaGroupBigQueryViewBuilder(
            logic_type=TaskCriteriaGroupLogicType.OR,
            criteria_name="US_MI_PAST_TEMP_SEG_SECURITY_CLASSIFICATION_COMMITTEE_REVIEW_DATE",
            sub_criteria_list=[
                eligible_for_initial_temp_seg_security_classification_committee_review.VIEW_BUILDER,
                thirty_days_past_last_temp_seg_security_classification_committee_review_date.VIEW_BUILDER,
            ],

...
someone in MI is eligible for their subsequent classification review
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_mi import (
    ...
    six_months_past_last_classification_review_date,
...
_DESCRIPTION = """Shows the spans of time during which someone in MI is eligible for their subsequent
 classification review, which occurs every 6 months after their initial review. 
"""

VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    state_code=StateCode.US_MI,
    task_name="COMPLETE_SUBSEQUENT_CLASSIFICATION_REVIEW_FORM",
    description=_DESCRIPTION,
    candidate_population_view_builder=probation_parole_dual_active_supervision_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        six_months_past_last_classification_review_date.VIEW_BUILDER,
    ...
    almost_eligible_condition=TimeDependentCriteriaCondition(
        criteria=six_months_past_last_classification_review_date.VIEW_BUILDER,
        reasons_date_field="six_months_past_review_date",
        interval_length=30,
        interval_date_part=BigQueryDateInterval.DAY,
        description="Within 30 days of subsequent classification review date",
    ),
)

...
someone in TN is eligible for a custody level downgrade, under the 2026 classification policy (v3).
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_tn import (
    custody_level_higher_than_recommended_2026_policy_v3,
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="CUSTODY_LEVEL_DOWNGRADE_2026_POLICY_V3",
    description=__doc__,
    ...
    criteria_spans_view_builders=[
        ...
        custody_level_higher_than_recommended_2026_policy_v3.VIEW_BUILDER,

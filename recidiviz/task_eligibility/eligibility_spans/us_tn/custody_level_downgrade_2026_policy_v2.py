...
someone in TN is eligible for a custody level downgrade, under the 2026 classification policy (v2).
"""
...
from recidiviz.task_eligibility.completion_events.state_specific.us_tn import (
    custody_level_downgrade_2026_policy,
)
from recidiviz.task_eligibility.criteria.state_specific.us_tn import (
    custody_level_higher_than_recommended_2026_policy_v2,
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="CUSTODY_LEVEL_DOWNGRADE_2026_POLICY_V2",
    description=__doc__,
    ...
    criteria_spans_view_builders=[
        ...
        custody_level_higher_than_recommended_2026_policy_v2.VIEW_BUILDER,
        has_not_had_2026_policy_initial_classification_in_past_6_months.VIEW_BUILDER,
    ],
    completion_event_builder=custody_level_downgrade_2026_policy.VIEW_BUILDER,
)

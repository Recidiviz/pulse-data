...
someone in TN is eligible for an annual reclassification, under the 2026 classification
policy.
"""
...
# Criteria shared across annual reclassification review variants. The original
# annual_reclassification_review adds custody_level_is_not_max on top of these.
US_TN_ANNUAL_RECLASSIFICATION_REVIEW_CRITERIA_VIEW_BUILDERS: list[
    TaskCriteriaBigQueryViewBuilder
] = [
    ...
    # reasons blob for easier access to the fields on the front end. This could also be
    # done via the opportunity record query but doing it this way standardizes across all
    # TN facilities opportunities related to classification, including custody level
    # downgrade. For annual reclassification, everyone with a span meets the criteria.
    custody_level_compared_to_recommended.VIEW_BUILDER,
]

# Almost eligible population includes clients in the week before the month in which
# their assessment is due, as well as during the month in which the assessment is due.
...
VIEW_BUILDER = SingleTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="ANNUAL_RECLASSIFICATION_REVIEW_2026_POLICY",
    description=__doc__,

...
def get_compliance_eligibility_spans_unioned_view_builders() -> Sequence[
    ...
    for (
        ...
        def get_criteria_select_statement(
            ...
            return f"SELECT state_code, person_id, '{vb.task_name}' AS task_name, start_date, end_date, is_eligible, is_overdue, reasons, reasons_v2, ineligible_criteria, due_date, last_task_completed_date"

...
_DESCRIPTION = """Defines a criteria span view that shows spans of time during which someone is on
 lifetime electronic monitoring
"""

_REASON_QUERY = "TO_JSON(STRUCT('9999-99-99' as lifetime_em_date))"

...
every 6 months they are in administrative solitary confinement, regardless of if they transfer facilities.
...
_QUERY_TEMPLATE = f"""
   WITH review_dates AS (
       ...
       at 6 month intervals from the start date of the ad seg stay. */
        SELECT 
            h.state_code,
            h.person_id, 

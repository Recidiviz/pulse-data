...
_REASON_QUERY = """TO_JSON(STRUCT(False AS pending_felony_detainer,
                                  False AS pending_immigration_detainer,
                                  False AS pending_felony_charge,
                                  False AS felony_suspect_information))"""

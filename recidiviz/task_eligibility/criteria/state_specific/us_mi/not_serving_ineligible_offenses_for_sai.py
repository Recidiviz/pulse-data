...
_CRITERIA_NAME = "US_MI_NOT_SERVING_INELIGIBLE_OFFENSES_FOR_SAI"

_DESCRIPTION = """Describes the spans of time during which
    someone is not serving ineligible offenses for SAI"""

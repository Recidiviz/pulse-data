...
_CRITERIA_NAME = "US_PA_NOT_SERVING_INELIGIBLE_AS_OFFENSE"
...
_REASON_QUERY = f"""
    WITH ineligible_spans AS (
          ...
          span.person_id,
          span.start_date,
          {nonnull_end_date_exclusive_clause('span.end_date_exclusive')} AS end_date,
          ...
          QUALIFY ROW_NUMBER() OVER (PARTITION BY span.person_id, span.start_date, sc.offense_type) = 1
    )
    SELECT 
      state_code,
      person_id,

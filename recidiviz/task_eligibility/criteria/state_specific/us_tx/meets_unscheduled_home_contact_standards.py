...
are compliant with unscheduled office contacts
"""
...
_CRITERIA_NAME = "US_TX_MEETS_UNSCHEDULED_HOME_CONTACT_STANDARDS"

_DESCRIPTION = """Defines a criteria view that shows spans of time for which supervision clients
meet standards for unscheduled home contacts based on their supervision level and case type.
"""

...
_CRITERIA_NAME = "US_TX_NEEDS_SCHEDULED_COLLATERAL_CONTACT"

_DESCRIPTION = """Defines a criteria view that shows spans of time for which supervision clients
do not meet standards for scheduled collateral contacts based on their supervision level and case type.
"""

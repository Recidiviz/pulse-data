...
from recidiviz.task_eligibility.criteria.state_specific.us_tx import (
    ...
    not_monthly_home_contact_required_and_supervision_officer_in_critically_understaffed_location,
...
VIEW_BUILDER = AndTaskCriteriaGroup(
    ...
    sub_criteria_list=[
        ...
        not_monthly_home_contact_required_and_supervision_officer_in_critically_understaffed_location.VIEW_BUILDER,
    ],

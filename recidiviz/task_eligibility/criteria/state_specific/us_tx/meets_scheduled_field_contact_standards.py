...
are compliant with scheduled field contacts
"""
...
_CRITERIA_NAME = "US_TX_MEETS_SCHEDULED_FIELD_CONTACT_STANDARDS"

_DESCRIPTION = """Defines a criteria view that shows spans of time for which supervision clients
meet standards for scheduled field contacts based on their supervision level and case type.
"""

...
supervision in California had sustainable housing for between 12 and 14 months.
"""
...
_CRITERIA_NAME = "US_CA_SUSTAINABLE_HOUSING_FOR_12_TO_14_MONTHS"

_DESCRIPTION = """Defines a criteria span view that shows spans of time during which
someone on supervision in California had sustainable housing for between 12 and 14 months.
"""
...
WITH {spans_within_x_and_y_months_of_start_date(
    x_months=12,
    y_months=14,
    start_date_plus_x_months_name_in_reason_blob='twelve_months_sustainable_housing',

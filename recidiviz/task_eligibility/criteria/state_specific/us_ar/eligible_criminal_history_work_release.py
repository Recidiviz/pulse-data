...
# ============================================================================
"""Spans of time when someone has a criminal history eligible for Work Release in Arkansas.
"""
...
_CRITERIA_NAME = "US_AR_ELIGIBLE_CRIMINAL_HISTORY_WORK_RELEASE"

_DESCRIPTION = """Spans of time when someone has a criminal history eligible for Work Release in Arkansas."""
...
_QUERY_TEMPLATE = f"""
    ...
    sentences_with_offense_types AS (
        ...
        -- Do not count inchoate offenses
        WHERE (NOT is_conspiracy) AND (NOT is_solicitation) AND (NOT is_attempt)
    )
    ,
    ...
    ineligible_offense_spans AS (
        ...
        WHERE offense_type IN ("CAPITAL_OFFENSE", "MURDER_1", "ESCAPE", "RAPE", "KIDNAPPING")
...
VIEW_BUILDER: StateSpecificTaskCriteriaBigQueryViewBuilder = StateSpecificTaskCriteriaBigQueryViewBuilder(
    ...
    reasons_fields=[
        ReasonsField(
            ...
            description="Ineligible offense types someone has been charged with for Work Release in Arkansas.",
        )
    ],

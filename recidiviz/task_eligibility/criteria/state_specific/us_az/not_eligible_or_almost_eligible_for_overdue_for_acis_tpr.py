...
"""Defines a criteria span view that shows spans of time during which someone is
    eligible or almost eligible for overdue for ACIS TPR"""
...
_CRITERIA_NAME = "US_AZ_NOT_ELIGIBLE_OR_ALMOST_ELIGIBLE_FOR_OVERDUE_FOR_ACIS_TPR"
...
FROM `{project_id}.{spans_dataset}.overdue_for_acis_tpr_request_materialized`
"""
    ...
    StateSpecificTaskCriteriaBigQueryViewBuilder(
        ...
        reasons_fields=[
            ReasonsField(
                ...
                description="Is this person eligible for overdue_for_acis_tpr?",
            ),
            ReasonsField(
                name="is_almost_eligible",
                type=bigquery.enums.StandardSqlTypeNames.BOOL,
                description="Is this person almost_eligible for overdue_for_acis_tpr?",
            ),
        ],

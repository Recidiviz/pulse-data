...
6 months of their ACIS (Time Comp assigned) Drug Transition Program date.
"""
...
_CRITERIA_NAME = "US_AZ_INCARCERATION_WITHIN_6_MONTHS_OF_ACIS_DTP_DATE"

_DESCRIPTION = """Defines a criteria span view that shows spans of time during which someone is within
6 months of their ACIS (Time Comp assigned) Drug Transition Program date."""

...
# ============================================================================
"""Describes spans of time when someone has not been removed from self-improvement programs in their current incarceration - TPR"""
...
_CRITERIA_NAME = "US_AZ_NO_TPR_REMOVALS_FROM_SELF_IMPROVEMENT_PROGRAMS"

_DESCRIPTION = """Describes spans of time when someone has not been removed from self-improvement programs in their current incarceration - TPR"""
...
WITH removals AS (
    ...
    FROM `{{project_id}}.{{raw_data_up_to_date_views_dataset}}.AZ_DOC_TRANSITION_PRG_EVAL_latest` eva

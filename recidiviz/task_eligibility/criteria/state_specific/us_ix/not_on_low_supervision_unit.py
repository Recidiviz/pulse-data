...
_CRITERIA_NAME = "US_IX_NOT_ON_LOW_SUPERVISION_UNIT"

_DESCRIPTION = """Defines a criteria span view that shows spans of time
for which a client is not already on LSU """
...
AND supervision_site = "LOW SUPERVSN UNIT"
),
...
SELECT 
    ...
    TO_JSON(STRUCT("LOW SUPERVISION UNIT" AS supervision_site)) AS reason,

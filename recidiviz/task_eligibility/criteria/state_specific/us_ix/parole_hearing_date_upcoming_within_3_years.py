...
someone is within 3 years of their parole hearing date AND their next parole hearing date is not in the past.
"""
...
_CRITERIA_NAME = "US_IX_PAROLE_HEARING_DATE_UPCOMING_WITHIN_3_YEARS"

_DESCRIPTION = """
Defines a criteria span view that shows spans of time during which
someone is within 3 years of their parole hearing date AND their parole hearing date is not in the past.
"""
...
critical_date_spans AS (
    ...
    SELECT
        ...
        person_id,
        start_datetime,
        --ends spans of time at the earliest of either the end_datetime or the PHD
        LEAST(min_parole_hearing_date, {nonnull_end_date_clause('end_datetime')}) AS end_datetime,
    ...
    SELECT 
        ...
        --ends spans of time at the earliest of either the end_datetime or the PHD
        LEAST(max_parole_hearing_date, {nonnull_end_date_clause('end_datetime')}) AS end_datetime,
        max_parole_hearing_date AS critical_date,
    FROM min_max_parole_hearing_date_spans
    WHERE min_parole_hearing_date < max_parole_hearing_date
),

{critical_date_has_passed_spans_cte(meets_criteria_leading_window_time=3,
                                    date_part='YEAR')},

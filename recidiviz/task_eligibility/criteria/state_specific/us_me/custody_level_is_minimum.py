...
which residents have a custody level of "Minimum".
"""
...
_CRITERIA_NAME = "US_ME_CUSTODY_LEVEL_IS_MINIMUM"

_DESCRIPTION = """Defines a criteria view that shows spans of time where
clients have a custody level of "Minimum".
"""

VIEW_BUILDER: StateSpecificTaskCriteriaBigQueryViewBuilder = (
    cis_112_custody_level_criteria(
        _CRITERIA_NAME, _DESCRIPTION, custody_levels=""" "Minimum" """
    )
)

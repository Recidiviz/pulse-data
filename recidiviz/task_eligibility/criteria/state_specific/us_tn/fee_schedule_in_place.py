...
_CRITERIA_NAME = "US_TN_FEE_SCHEDULE_IN_PLACE"
...
VIEW_BUILDER: StateSpecificTaskCriteriaBigQueryViewBuilder = state_specific_placeholder_criteria_view_builder(
    ...
    reasons_fields=[
        ReasonsField(
            name="latest_feep_contact_date",
            type=bigquery.enums.StandardSqlTypeNames.DATE,
            description="Date on which latest FEEP (Fees/Exemptions Current) note was recorded",
        ),
    ],
)

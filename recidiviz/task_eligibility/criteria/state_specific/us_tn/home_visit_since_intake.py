...
_CRITERIA_NAME = "US_TN_HOME_VISIT_SINCE_INTAKE"
...
VIEW_BUILDER: StateSpecificTaskCriteriaBigQueryViewBuilder = state_specific_placeholder_criteria_view_builder(
    ...
    reasons_fields=[
        ReasonsField(
            name="home_visit_contacts_array",
            type=bigquery.enums.StandardSqlTypeNames.ARRAY,
            description="Array that contains dates and contact type of home visits since intake",
        ),
        ReasonsField(
            name="intake_date",

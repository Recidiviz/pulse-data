...
someone is incarcerated within 1 year of their full term completion date, 
...
_CRITERIA_NAME = "US_ND_INCARCERATION_WITHIN_1_YEAR_OF_FTCD_OR_PRD_OR_CPP_RELEASE"
...
_CRITERIA_QUERY_1 = f"""
    ...
    FROM `{{project_id}}.{{task_eligibility_criteria_general}}.incarceration_within_1_year_of_full_term_completion_date_materialized`
...
_CRITERIA_QUERY_2 = f"""
    ...
    FROM `{{project_id}}.{{task_eligibility_criteria_US_ND}}.incarceration_within_12_months_of_parole_review_date_materialized`"""
...
SELECT
    *,
    ...
    JSON_EXTRACT(reason, "$.parole_review_date") AS parole_review_date,
FROM
    combined_query
"""

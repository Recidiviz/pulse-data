...
is no violations within 12 to 14 months on supervision."""
...
_CRITERIA_NAME = "NO_SUPERVISION_VIOLATION_WITHIN_12_TO_14_MONTHS"
...
WITH {spans_within_x_and_y_months_of_end_date(
    x_months=0,
    y_months=2,
    end_date_plus_x_months_name_in_reason_blob='twelve_months_violation_free_date',
    dataset = 'tes_criteria_general_dataset',
    table_view= "no_supervision_violation_within_12_months_materialized")}
"""

...
someone is incarcerated within 10 years of their parole eligibility date.
"""
...
_CRITERIA_NAME = "INCARCERATION_WITHIN_10_YEARS_OF_PAROLE_ELIGIBILITY_DATE"


VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = (
    is_past_completion_date_criteria_builder(
        compartment_level_1_filter="INCARCERATION",
        meets_criteria_leading_window_time=10,
        date_part="YEAR",

...
completed at least 3 years of minimum OR limited supervision.
"""
...
_CRITERIA_NAME = "SUPERVISION_LEVEL_IS_MINIMUM_OR_LIMITED_FOR_3_YEARS"
...
VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = (
    get_minimum_time_served_criteria_query(
        ...
        supervision_levels=["MINIMUM", "LIMITED"],
    )
)

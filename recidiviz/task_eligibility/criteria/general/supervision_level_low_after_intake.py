...
have a 'LOW' supervision level after supervision intake
"""
...
# TODO(#37898): Replace "Low" with whatever we end up ingesting the new TN levels as
# TODO(#37440): Replace to be "low after intake" and not just low
_CRITERIA_NAME = "SUPERVISION_LEVEL_LOW_AFTER_INTAKE"

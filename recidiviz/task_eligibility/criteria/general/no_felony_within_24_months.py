...
WITH supervision_violations AS (
    ...
    SELECT
        ...
        DATE_ADD(COALESCE(v.violation_date, vr.response_date), INTERVAL 24 MONTH) AS end_date,
        TRUE as felony_violation,
   ...
   and sets felony_violation as FALSE*/
    SELECT
        state_code,
        person_id,
        start_date,
        DATE_ADD(end_date, INTERVAL 1 DAY) AS end_date,
        FALSE as felony_violation,
...
SELECT 
    ...
    NOT LOGICAL_OR(felony_violation) AS meets_criteria,

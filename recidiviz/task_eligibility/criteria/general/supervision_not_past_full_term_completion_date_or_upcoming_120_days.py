...
is not past their supervision full term completion date (sentence projected max
completion date) or within 120 days of it. However, this criteria will be
FALSE if no projected max completion date is set.

This criteria is therefore not fully the logical opposite of the
`SUPERVISION_PAST_FULL_TERM_COMPLETION_DATE_OR_UPCOMING_120_DAYS` view,
since both criteria will be FALSE if there is no projected max completion date"""
...
_CRITERIA_NAME = "SUPERVISION_NOT_PAST_FULL_TERM_COMPLETION_DATE_OR_UPCOMING_120_DAYS"

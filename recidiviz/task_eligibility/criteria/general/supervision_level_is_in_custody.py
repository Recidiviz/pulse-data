...
# =============================================================================
"""Criteria view builder for spans of time when a person is in IN_CUSTODY
supervision status.
...
_CRITERIA_NAME = "SUPERVISION_LEVEL_IS_IN_CUSTODY"
...
VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = custody_or_supervision_level_criteria_builder(
    ...
    description=__doc__,
    levels_lst=["IN_CUSTODY"],
    reasons_columns=_REASONS_COLUMNS,
    reasons_fields=[
        ReasonsField(
            name="supervision_level",
            type=bigquery.enums.StandardSqlTypeNames.STRING,
            description="Person's supervision level",
        ),
        ReasonsField(
            name="supervision_level_start_date",
            type=bigquery.enums.StandardSqlTypeNames.DATE,
            description="Specifies when a person began on the specified supervision level",
        ),
    ],
)

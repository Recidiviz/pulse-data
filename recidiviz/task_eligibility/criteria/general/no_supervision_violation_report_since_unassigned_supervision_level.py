...
no supervision violation reports since the latest time someone was on Unassigned supervision level
"""
...
_CRITERIA_NAME = "NO_SUPERVISION_VIOLATION_REPORT_SINCE_UNASSIGNED_SUPERVISION_LEVEL"
...
SELECT
    ...
    TO_JSON(STRUCT(critical_date AS earliest_violation_date,

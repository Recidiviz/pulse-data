...
no supervision sanctions since starting supervision.
"""
...
_CRITERIA_NAME = "NO_SUPERVISION_SANCTION_SINCE_STARTING_SUPERVISION"
...
VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = (
    state_agnostic_placeholder_criteria_view_builder(
        ...
        reasons_fields=[
            ReasonsField(
                name="sanction_dates_since_supervision_start",
                type=bigquery.enums.StandardSqlTypeNames.ARRAY,
                description="Date(s) of any sanction(s) since starting supervision",
            ),
            ReasonsField(

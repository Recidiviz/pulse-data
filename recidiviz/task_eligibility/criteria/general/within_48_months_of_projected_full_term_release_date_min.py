...
# ============================================================================
"""Spans of time when someone is within 48 months of their earliest projected full-term
release date.
...
_CRITERIA_NAME = "WITHIN_48_MONTHS_OF_PROJECTED_FULL_TERM_RELEASE_DATE_MIN"
...
VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = (
    is_past_completion_date_criteria_builder(
        meets_criteria_leading_window_time=48,
        date_part="MONTH",

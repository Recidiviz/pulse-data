...
where start_date is the first time a person began supervision (based on super_sessions) 
and end_date is the final projected_release_date all supervision sentences considered.

This view was created because SUPERVISION_PAST_HALF_FULL_TERM_RELEASE_DATE didn't use
the right start_date in ME. Once the ingest mappings are fixed in ME, we will hopefully 
deprecate this criteria view builder.
"""
...
_CRITERIA_NAME = "SUPERVISION_PAST_HALF_FULL_TERM_RELEASE_DATE_FROM_SUPERVISION_START"
...
_QUERY_TEMPLATE = f"""
#TODO(#19981) Deprecate this criteria builder once the supervision sentence effective date aligns with the probation session start date

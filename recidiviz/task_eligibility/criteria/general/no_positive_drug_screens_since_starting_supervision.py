...
no positive drug screens since starting supervision.
"""
...
_CRITERIA_NAME = "NO_POSITIVE_DRUG_SCREENS_SINCE_STARTING_SUPERVISION"
...
VIEW_BUILDER: StateAgnosticTaskCriteriaBigQueryViewBuilder = state_agnostic_placeholder_criteria_view_builder(
    ...
    reasons_fields=[
        ReasonsField(
            name="positive_screen_dates",
            type=bigquery.enums.StandardSqlTypeNames.ARRAY,
            description="Date(s) of any positive screens since starting supervision",
        ),
        ReasonsField(

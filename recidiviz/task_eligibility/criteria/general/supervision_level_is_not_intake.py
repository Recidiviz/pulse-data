...
# ============================================================================
"""Identifies when clients do not have a supervision level of 'INTAKE', as tracked by
...
_QUERY_TEMPLATE = f"""
    ...
    SELECT 
        ...
        start_date AS intake_start_date,
    FROM ({aggregate_adjacent_spans(table_name='intake_spans')})
"""
    ...
    StateAgnosticTaskCriteriaBigQueryViewBuilder(
        ...
        reasons_fields=[
            ReasonsField(
                ...
                description="Date that a client started on intake supervision",
            ),
        ],
    )
)

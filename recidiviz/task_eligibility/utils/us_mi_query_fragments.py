...
def generate_sccp_form_opportunity_record_view_builder_v2(
    ...
    Supports multiple TES view builders (UNION ALL'd together) and identifies the
    relevant criteria row by checking for a non-null value in the reasons field rather
    than matching by criteria name.
    ...
    return f"""
        ...
        secondary_officer_metadata AS (
            ...
            WHERE 
                ...
                AND Supervision_Status IN ({ACTIVE_SUPERVISION_STATUSES})

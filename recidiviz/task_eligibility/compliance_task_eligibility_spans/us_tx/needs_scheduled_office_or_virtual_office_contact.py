...
do not meet standards for scheduled virtual office contacts, in cases where extra
in-person office contacts may count towards virtual contacts.
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_tx import (
    needs_scheduled_office_or_virtual_office_contact,
)
...
VIEW_BUILDER = ComplianceTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="needs_scheduled_office_or_virtual_office_contact",
    candidate_population_view_builder=prioritized_supervision_population_with_officer.VIEW_BUILDER,
    criteria_spans_view_builders=[
        needs_scheduled_office_or_virtual_office_contact.VIEW_BUILDER,
    ],

...
# =============================================================================
"""
Defines a compliance task span view that shows spans of time during which a
client requires an unscheduled weekend home contact (an unscheduled home
contact occurring on a Saturday or Sunday).
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_tx import (
    needs_unscheduled_weekend_home_contact_standard_policy,
)
...
VIEW_BUILDER = ComplianceTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="needs_unscheduled_weekend_home_contact",
    ...
    criteria_spans_view_builders=[
        needs_unscheduled_weekend_home_contact_standard_policy.VIEW_BUILDER,
    ],

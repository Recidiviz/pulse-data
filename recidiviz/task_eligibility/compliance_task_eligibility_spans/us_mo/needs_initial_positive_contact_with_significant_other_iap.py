...
significant other(s) is required for a client in the Initial Assessment Phase (IAP) to
...
from recidiviz.task_eligibility.criteria.state_specific.us_mo import (
    meets_initial_positive_contact_with_significant_other_iap_triggers,
)
...
VIEW_BUILDER = ComplianceTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="needs_initial_positive_contact_with_significant_other_iap",
    candidate_population_view_builder=supervision_tasks_eligible_iap_population.VIEW_BUILDER,
    criteria_spans_view_builders=[
        meets_initial_positive_contact_with_significant_other_iap_triggers.VIEW_BUILDER,
    ],

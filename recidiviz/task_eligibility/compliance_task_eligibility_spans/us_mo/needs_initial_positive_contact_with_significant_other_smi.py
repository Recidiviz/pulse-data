...
# =============================================================================
"""Identifies spans of time during which an initial positive contact with a MO client's
significant other(s) is required for Serious Mental Illness (SMI) supervision clients to
meet contact standards.
"""
...
from recidiviz.task_eligibility.candidate_populations.state_specific.us_mo import (
    supervision_tasks_eligible_smi_population,
)
...
from recidiviz.task_eligibility.criteria.state_specific.us_mo import (
    meets_initial_positive_contact_with_significant_other_smi_triggers,
)
...
VIEW_BUILDER = ComplianceTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="needs_initial_positive_contact_with_significant_other_smi",
    ...
    criteria_spans_view_builders=[
        meets_initial_positive_contact_with_significant_other_smi_triggers.VIEW_BUILDER,
    ],

...
are not compliant with scheduled personal contacts, for the active parole population.
"""
...
from recidiviz.task_eligibility.criteria.state_specific.us_ne import (
    meets_personal_contact_triggers,
)
...
VIEW_BUILDER = ComplianceTaskEligibilitySpansBigQueryViewBuilder(
    ...
    task_name="needs_personal_contact",
    ...
    criteria_spans_view_builders=[
        meets_personal_contact_triggers.VIEW_BUILDER,
    ],

...
as tracked by data in our `sessions` dataset, as well as STATE_PRISON custodial authority, excluding
people in SAFEKEEPING"""
...
_POPULATION_NAME = "INCARCERATION_POPULATION_STATE_PRISON_EXCLUDE_SAFEKEEPING"
...
VIEW_BUILDER: StateAgnosticTaskCandidatePopulationBigQueryViewBuilder = (
    state_agnostic_candidate_population_view_builder(
        ...
        description=__doc__,
        additional_filters=[
            'compartment_level_2 != "SAFEKEEPING" ',

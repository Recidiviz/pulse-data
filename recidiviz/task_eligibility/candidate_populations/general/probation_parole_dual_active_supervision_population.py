...
# =============================================================================
"""Defines a candidate population view containing all people who are on probation, parole, or dual
...
_POPULATION_NAME = "PROBATION_PAROLE_DUAL_ACTIVE_SUPERVISION_POPULATION"

_DESCRIPTION = """Selects all spans of time in which a person is on probation, parole or dual

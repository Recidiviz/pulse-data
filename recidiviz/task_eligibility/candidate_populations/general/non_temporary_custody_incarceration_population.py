...
comparment_level_1 = 'INCARCERATION' and compartment_level_2 != 'TEMPORARY_CUSTODY'
...
_POPULATION_NAME = "NON_TEMPORARY_CUSTODY_INCARCERATION_POPULATION"

_DESCRIPTION = """Selects all spans of time in which a person is in INCARCERATION
as tracked by data in our `sessions` dataset. The only type of incarceration excluded is 
compartment_level_2 != 'TEMPORARY_CUSTODY'.
"""
...
VIEW_BUILDER: StateAgnosticTaskCandidatePopulationBigQueryViewBuilder = (
    state_agnostic_candidate_population_view_builder(
        ...
        additional_filters=['compartment_level_2 != "TEMPORARY_CUSTODY" '],

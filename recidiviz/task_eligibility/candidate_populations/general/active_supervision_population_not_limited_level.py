...
# =============================================================================
"""Selects all spans of time in which a person is on
supervision and actively supervised as defined by excluding certain compartments and supervision levels
such as in custody, bench warrant, absconsion, or unknown, and especially the limited correctional level.
"""
...
_POPULATION_NAME = "ACTIVE_SUPERVISION_POPULATION_NOT_LIMITED_LEVEL"
...
VIEW_BUILDER: StateAgnosticTaskCandidatePopulationBigQueryViewBuilder = state_agnostic_candidate_population_view_builder(
    ...
    additional_filters=active_supervision_population_additional_filters(
        excluded_correctional_levels="('IN_CUSTODY','WARRANT','ABSCONDED','ABSCONSION','EXTERNAL_UNKNOWN', "
        "'LIMITED')"
    ),

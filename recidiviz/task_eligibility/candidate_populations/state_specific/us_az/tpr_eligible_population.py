...
# =============================================================================
"""Selects all spans of time in which a person is a candidate for TPR in Arizona. This includes people who meet the
following criteria:
- No ineligible TPR offense convictions
- No TPR Denial or Release in Current Incarceration
- No TPR Removals from Self Improvement Programs
...
_CRITERIA_GROUP = StateSpecificTaskCriteriaGroupBigQueryViewBuilder(
    ...
    sub_criteria_list=[
        ...
        StateSpecificTaskCriteriaGroupBigQueryViewBuilder(
            logic_type=TaskCriteriaGroupLogicType.AND,
            criteria_name="US_AZ_HAS_TPR_DATE",
            sub_criteria_list=[
                StateSpecificInvertedTaskCriteriaBigQueryViewBuilder(
                    sub_criteria=acis_tpr_date_not_set.VIEW_BUILDER,
                ),
                incarceration_population.VIEW_BUILDER.as_criteria(
                    criteria_name="IN_INCARCERATION_CANDIDATE_POPULATION",
                    sessions_dataset=SESSIONS_DATASET,

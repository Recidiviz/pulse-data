...
contact standards applying only to clients who are NOT in the Initial Assessment Period
(IAP).
"""
...
_POPULATION_NAME = "US_MO_SUPERVISION_TASKS_ELIGIBLE_NON_IAP_POPULATION"
...
_CRITERIA_GROUP = StateSpecificTaskCriteriaGroupBigQueryViewBuilder(
    ...
    sub_criteria_list=[
        ...
        StateSpecificInvertedTaskCriteriaBigQueryViewBuilder(
            sub_criteria=in_supervision_initial_assessment_phase.VIEW_BUILDER,
        ),
    ],
)

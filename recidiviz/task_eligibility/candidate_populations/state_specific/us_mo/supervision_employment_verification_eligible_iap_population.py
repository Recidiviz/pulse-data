...
supervision Tasks in MO under routine contact standards applying only to clients in the
Initial Assessment Period (IAP).
"""
...
_POPULATION_NAME = "US_MO_SUPERVISION_EMPLOYMENT_VERIFICATION_ELIGIBLE_IAP_POPULATION"

_CRITERIA_GROUP = StateSpecificTaskCriteriaGroupBigQueryViewBuilder(
    logic_type=TaskCriteriaGroupLogicType.AND,
    criteria_name=_POPULATION_NAME,
    sub_criteria_list=[
        supervision_tasks_eligible_iap_population.VIEW_BUILDER.as_criteria(
            criteria_name="US_MO_IN_SUPERVISION_TASKS_ELIGIBLE_IAP_POPULATION",
        ),

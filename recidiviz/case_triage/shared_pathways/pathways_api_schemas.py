...
def build_fetch_metric_schemas_by_name(
    metrics: list[MetricQueryBuilder],
) -> dict[str, type[Schema]]:
    """Builds Marshmallow schemas for the Pathways API"""
    ...
    for metric_class in metrics:
        ...
        schemas[metric_class.name] = Schema.from_dict(schema_fields)

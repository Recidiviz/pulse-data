...
class WorkflowsConfigSchema(CamelCaseSchema):
    ...
    snooze_review_status_message = fields.Str(required=False)
    grant_review_status_message = fields.Str(required=False)
    grant_review_dropdown_label = fields.Str(required=False)
    reviewer_feature_variant = fields.Str(required=False)

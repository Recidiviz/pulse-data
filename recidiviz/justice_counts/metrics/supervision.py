    ...
    aggregated_dimensions=[
        ...
        AggregatedDimension(
            ...
            dimension_to_description={
                ...
                CensusRace.BLACK: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is listed as Black or African-American. This includes people with origins in Kenya, Nigeria, Ghana, Ethiopia, or other countries in Sub-Saharan Africa.",
                CensusRace.HISPANIC_OR_LATINO: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race and ethnicity are listed as Hispanic or Latino. This includes people with origins in Mexico, Cuba, Puerto Rico, the Dominican Republic, and other Spanish-speaking countries in Central or South America, as well as people with origins in Brazil or other non-Spanish-speaking countries in Central or South America.",
                CensusRace.MORE_THAN_ONE_RACE: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is listed as more than one race, such as White and Black.",
                CensusRace.NATIVE_HAWAIIAN_PACIFIC_ISLANDER: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is listed as Native Hawaiian, Pacific Islander, or similar. This includes people with origins in the original populations of Pacific islands such as Hawaii, Samoa, Fiji, Tahiti, or Papua New Guinea.",
                CensusRace.OTHER: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is listed as some other race, not included above.",
                CensusRace.UNKNOWN: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is not known.",
                CensusRace.WHITE: "A single-day count of the number of people who are supervised under the jurisdiction of the agency whose race is listed as White, Caucasian, or Anglo. This includes people with origins in France, Italy, or other countries in Europe, as well as Israel, Palestine, Egypt, or other countries in the Middle East and North Africa.",
            },
        ),
        AggregatedDimension(

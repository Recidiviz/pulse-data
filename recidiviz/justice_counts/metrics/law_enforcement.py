...
police_officers = MetricDefinition(
    ...
    description="Measures the number of full or part-time sworn officers employed by the agency.",
    measurement_type=MeasurementType.INSTANT,
    reporting_frequencies=[ReportingFrequency.ANNUAL],
    aggregated_dimensions=[
...
reported_crime = MetricDefinition(
    ...
    description="Measures the number of crimes reported to the agency.",
    definitions=[
        Definition(
            term="Crime incident",
...
total_arrests = MetricDefinition(
    ...
    description="Measures the number of arrests made by the agency.",
    specified_contexts=[
        Context(

...
DEPLOYED_DATASETS_THAT_HAVE_EVER_BEEN_MANAGED: Set[str] = {
    ...
    "classification_score_components_us_ix",
    "classification_score_components_us_mi",
    "classification_score_components_us_tn",
    "classification_views",
    "compliance_task_eligibility_spans",
    "compliance_task_eligibility_spans_us_co",
    "compliance_task_eligibility_spans_us_ix",
    "compliance_task_eligibility_spans_us_mo",
    ...
    "observations__sentencing_assessment_report_primary_user_event",
    "observations__sentencing_assessment_report_provisioned_user_event",
    "observations__sentencing_assessment_report_primary_user_span",
    "observations__sentencing_assessment_report_provisioned_user_span",
    "observations__supervisor_homepage_operations_module_primary_user_event",
    "observations__supervisor_homepage_operations_module_primary_user_span",
    "observations__supervisor_homepage_operations_module_provisioned_user_span",
    ...
    "task_eligibility_candidates_us_mo",
    "task_eligibility_candidates_us_tx",
    "task_eligibility_candidates_us_az",
    "task_eligibility_candidates_us_ar",
    "task_eligibility_candidates_us_ix",
    "task_eligibility_candidates_us_ne",
    ...
    "task_eligibility_completion_events_us_nc",
    ...
    "task_eligibility_criteria_us_nc",
    ...
    "us_nyc_raw_data_up_to_date_views",
    "us_nyc_raw_data_up_to_date_views_secondary",
    ...
    "us_nyc_raw_data_views",
    "us_nyc_raw_data_views_secondary",

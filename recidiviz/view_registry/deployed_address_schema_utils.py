...
from recidiviz.calculator.query.state.views.us_tn_tomis_1_0_analog_views.CodesDescription import (
    US_TN_TOMIS_CODESDESCRIPTION_ANALOG_VIEW_BUILDER,
)
...
from recidiviz.calculator.query.state.views.workflows.us_mi.resident_metadata import (
    US_MI_RESIDENT_METADATA_VIEW_BUILDER,
)
from recidiviz.calculator.query.state.views.workflows.us_mo.client_metadata import (
    US_MO_CLIENT_METADATA_VIEW_BUILDER,
)
...
from recidiviz.calculator.query.state.views.workflows.us_tn.client_metadata import (
    US_TN_CLIENT_METADATA_VIEW_BUILDER,
)
from recidiviz.calculator.query.state.views.workflows.us_tn.resident_metadata import (
    US_TN_RESIDENT_METADATA_VIEW_BUILDER,
)
from recidiviz.calculator.query.state.views.workflows.us_tx.client_metadata import (
    US_TX_CLIENT_METADATA_VIEW_BUILDER,
)
from recidiviz.calculator.query.state.views.workflows.us_ut.client_metadata import (
    US_UT_CLIENT_METADATA_VIEW_BUILDER,
)
from recidiviz.calculator.query.state.views.workflows.us_ut.resident_metadata import (
    US_UT_RESIDENT_METADATA_VIEW_BUILDER,
)
...
def state_specific_deployed_views_without_state_code_columns(
    ...
    missing_state_code_col_addresses = {
        ...
        *raw_data_views_no_state_code_column,
        ...
        US_UT_RESIDENT_METADATA_VIEW_BUILDER.address,
        US_MI_RESIDENT_METADATA_VIEW_BUILDER.address,
        US_MI_SUPERVISION_LEVEL_RAW_TEXT_MAPPINGS_VIEW_BUILDER.address,
        US_MO_CLIENT_METADATA_VIEW_BUILDER.address,
        ...
        US_TN_CLIENT_METADATA_VIEW_BUILDER.address,
        ...
        US_TN_TOMIS_CODESDESCRIPTION_ANALOG_VIEW_BUILDER.address,

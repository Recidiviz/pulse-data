...
class MetricUnitOfObservationType(Enum):
    ...
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER"
    )
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PROVISIONED_USER = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PROVISIONED_USER"
    )
    ...
    JII_TABLET_APP_PROVISIONED_USER = "JII_TABLET_APP_PROVISIONED_USER"

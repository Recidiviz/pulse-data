...
class SpanType(Enum):
    ...
    INCARCERATION_INCIDENT_SESSION = "INCARCERATION_INCIDENT_SESSION"
    ...
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER_REGISTRATION_SESSION = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER_REGISTRATION_SESSION"
    )
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PROVISIONED_USER_SESSION = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PROVISIONED_USER_SESSION"
    )
    ...
    COMPLIANCE_TASK_ELIGIBILITY_SESSION = "COMPLIANCE_TASK_ELIGIBILITY_SESSION"
    ...
    ROUTE_PLANNER_ELIGIBLE_CASELOAD_SESSION = "ROUTE_PLANNER_ELIGIBLE_CASELOAD_SESSION"
    US_AR_OVG_SESSIONS = "US_AR_OVG_SESSIONS"
    EARNED_CREDIT_BALANCE_SESSION = "EARNED_CREDIT_BALANCE_SESSION"
    EARNED_CREDIT_BALANCE_BY_TYPE_SESSION = "EARNED_CREDIT_BALANCE_BY_TYPE_SESSION"
    ...
    def unit_of_observation_type(self) -> MetricUnitOfObservationType:
        ...
        if self in [
            ...
            SpanType.INCARCERATION_INCIDENT_SESSION,
            ...
            SpanType.COMPLIANCE_TASK_ELIGIBILITY_SESSION,
        ...
        if self in [
            SpanType.SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER_REGISTRATION_SESSION,
        ]:
            return (
                MetricUnitOfObservationType.SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PRIMARY_USER
            )
        if self in [
            SpanType.SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_PROVISIONED_USER_SESSION
        ]:
            return (
        ...
        if self in [
            ...
            SpanType.ROUTE_PLANNER_ELIGIBLE_CASELOAD_SESSION,
        ]:

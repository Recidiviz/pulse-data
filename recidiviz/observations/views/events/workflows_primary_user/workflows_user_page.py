...
# =============================================================================
"""View with events where the officer viewed a particular Workflows page, e.g.,
PROFILE_VIEWED.
"""
...
_VIEW_DESCRIPTION = (
    "Events where the officer viewed a particular Workflows page, e.g., PROFILE_VIEWED"
)

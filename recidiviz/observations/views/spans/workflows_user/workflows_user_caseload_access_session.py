...
# =============================================================================
"""View with spans of time over which a workflows user is associated with a given
location
"""
...
_VIEW_DESCRIPTION = (
    "Spans of time over which a workflows user is associated with a given location"
)

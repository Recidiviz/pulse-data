...
class EventType(Enum):
    ...
    INCARCERATION_ENDS = "INCARCERATION_ENDS"
    ...
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_ACTIVE_USAGE_EVENT = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_ACTIVE_USAGE_EVENT"
    )
    SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_USER_LOGIN = (
        "SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_USER_LOGIN"
    )
    IMPACT_TRANSITION = "IMPACT_TRANSITION"
    INTERCOM_CSAT_RESPONSE = "INTERCOM_CSAT_RESPONSE"
    INTERCOM_EMAIL_SENT = "INTERCOM_EMAIL_SENT"
    JII_INCOMING_TEXT_MESSAGE = "JII_INCOMING_TEXT_MESSAGE"
    JII_TABLET_APP_PROGRAM_DETAIL_OPENED = "JII_TABLET_APP_PROGRAM_DETAIL_OPENED"
    ...
    SENTENCING_ASSESSMENT_REPORT_COMPLETED = "SENTENCING_ASSESSMENT_REPORT_COMPLETED"
    SENTENCING_ASSESSMENT_REPORT_USER_LOGIN = "SENTENCING_ASSESSMENT_REPORT_USER_LOGIN"
    ...
    def unit_of_observation_type(self) -> MetricUnitOfObservationType:
        ...
        if self in [
            ...
            EventType.JII_INCOMING_TEXT_MESSAGE,
            ...
            EventType.SENTENCING_ASSESSMENT_REPORT_COMPLETED,
        ...
        if self in [
            EventType.SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_USER_LOGIN,
            EventType.SUPERVISOR_HOMEPAGE_OPERATIONS_MODULE_ACTIVE_USAGE_EVENT,
        ]:
            return (
        ...
        if self in [
            ...
            EventType.ROUTE_PLANNER_ACTIVE_USAGE_EVENT,
        ]:
        ...
        if self in [
            ...
            EventType.INTERCOM_EMAIL_SENT,
        ]:
            return MetricUnitOfObservationType.GLOBAL_PROVISIONED_USER
        if self in [
            EventType.JII_TABLET_APP_PROGRAM_DETAIL_OPENED,
        ...
        if self in [
            EventType.SENTENCING_ASSESSMENT_REPORT_USER_LOGIN,

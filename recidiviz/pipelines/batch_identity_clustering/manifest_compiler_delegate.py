...
# =============================================================================
"""Manifest compiler delegate for the batch identity clustering pipeline.
...
import recidiviz.pipelines.batch_identity_clustering
...
from recidiviz.pipelines.batch_identity_clustering import entities as identity_entities
from recidiviz.pipelines.batch_identity_clustering import (
    entity_factories as identity_entity_factories,
)

# TODO(#75853): Revisit this location once we refactor dir structure (e.g.
# regions/identity/ingest_mappings).
...
class IdentityIngestViewManifestCompilerDelegate(
    ...
    def get_entity_factory_class(self, entity_cls_name: str) -> Type[EntityFactory]:
        ...
        if factory_cls is None:
            raise ValueError(
                ...
                f"batch_identity_clustering.entity_factories."
            )
        return factory_cls
    ...
    def get_custom_function_registry(self) -> CustomFunctionRegistry:
        return CustomFunctionRegistry(
            custom_functions_root_module=recidiviz.pipelines.batch_identity_clustering
        )

...
class UsOrAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_OR implementation of the StateSpecificAssessmentNormalizationDelegate."""

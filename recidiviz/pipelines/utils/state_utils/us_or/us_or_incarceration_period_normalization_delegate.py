...
class UsOrIncarcerationNormalizationDelegate(
    StateSpecificIncarcerationNormalizationDelegate
):
    """US_OR implementation of the StateSpecificIncarcerationNormalizationDelegate."""
    ...
    def standardize_purpose_for_incarceration_values(
        ...
        for US_OR since this was previously the default normalization behavior

...
class UsMiAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_MI implementation of the StateSpecificAssessmentNormalizationDelegate."""

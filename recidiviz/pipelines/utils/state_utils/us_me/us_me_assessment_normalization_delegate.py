...
class UsMeAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_ME implementation of the StateSpecificAssessmentNormalizationDelegate."""

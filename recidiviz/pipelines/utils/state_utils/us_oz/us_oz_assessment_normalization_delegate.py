...
class UsOzAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_OZ implementation of the StateSpecificAssessmentNormalizationDelegate."""

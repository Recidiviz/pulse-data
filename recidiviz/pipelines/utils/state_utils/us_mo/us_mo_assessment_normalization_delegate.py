...
class UsMoAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_MO implementation of the StateSpecificAssessmentNormalizationDelegate."""

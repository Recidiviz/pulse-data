...
class UsXxAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_XX implementation of the StateSpecificAssessmentNormalizationDelegate."""

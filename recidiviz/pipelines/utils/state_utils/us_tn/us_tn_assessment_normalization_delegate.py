...
class UsTnAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_TN implementation of the StateSpecificAssessmentNormalizationDelegate."""

...
class UsCaAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_CA implementation of the StateSpecificAssessmentNormalizationDelegate."""

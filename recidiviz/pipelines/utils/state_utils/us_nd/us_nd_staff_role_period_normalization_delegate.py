...
class UsNdStaffRolePeriodNormalizationDelegate(
    StateSpecificStaffRolePeriodNormalizationDelegate
):
    """US_ND implementation of the StateSpecificStaffRolePeriodNormalizationDelegate."""

    def __init__(
        self, staff_supervisor_periods: List[StateStaffSupervisorPeriod]
    ) -> None:
        self._staff_supervisor_periods = staff_supervisor_periods

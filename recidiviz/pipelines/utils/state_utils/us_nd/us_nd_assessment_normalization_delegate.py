...
class UsNdAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_ND implementation of the StateSpecificAssessmentNormalizationDelegate."""

...
class UsTxSentenceNormalizationDelegate(StateSpecificSentenceNormalizationDelegate):
    """US_TX implementation of the StateSpecificSentenceNormalizationDelegate."""

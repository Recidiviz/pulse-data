...
class UsCoAssessmentNormalizationDelegate(StateSpecificAssessmentNormalizationDelegate):
    """US_CO implementation of the StateSpecificAssessmentNormalizationDelegate."""

...
usage: python -m recidiviz.tools.calculator.run_sandbox_flex_calculation_pipeline \
...
Examples:
    python -m recidiviz.tools.calculator.run_sandbox_flex_calculation_pipeline \

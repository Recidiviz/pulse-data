...
class ComparisonResultType(Enum):
    IMPROVED_IN_SANDBOX: str = "IMPROVED_IN_SANDBOX"
    REGRESSED_IN_SANDBOX: str = "REGRESSED_IN_SANDBOX"
    IMPROVED_IN_SANDBOX_NO_STATUS_CHANGE: str = "IMPROVED_IN_SANDBOX_NO_STATUS_CHANGE"
    REGRESSED_IN_SANDBOX_NO_STATUS_CHANGE: str = "REGRESSED_IN_SANDBOX_NO_STATUS_CHANGE"
    NO_STATUS_CHANGE: str = "NO_CHANGE"

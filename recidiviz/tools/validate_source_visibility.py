...
def main() -> int:
    ...
    valid_raw_data_import_dag_prefixes = {
        ...
        "recidiviz.ingest.direct.raw_data.raw_data_import_chunked_file_handler_factory",
        ...
        "recidiviz.ingest.direct.types.raw_data_import_blocking_validation_collector",

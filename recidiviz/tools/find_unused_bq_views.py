...
UNREFERENCED_ADDRESSES_TO_KEEP_WITH_REASON: Dict[BigQueryAddress, str] = {
    ...
    **{
    ...
    BigQueryAddress(
        dataset_id=VITALS_REPORT_DATASET,
        table_id="supervision_state_30_day_aggregated_metrics",
    ): ("Will be used for vitals-in-insights (see #34611) (Dana Hoffman 11/1/24)"),
    BigQueryAddress(
        dataset_id=VITALS_REPORT_DATASET,
        table_id="supervision_district_30_day_aggregated_metrics",
    ): ("Will be used for vitals-in-insights (see #34611) (Dana Hoffman 11/1/24)"),
    BigQueryAddress(
        dataset_id=VITALS_REPORT_DATASET,
        table_id="supervision_office_30_day_aggregated_metrics",
    ): ("Will be used for vitals-in-insights (see #34611) (Dana Hoffman 11/1/24)"),
    BigQueryAddress(
        dataset_id=VITALS_REPORT_DATASET,
        table_id="supervision_officer_30_day_aggregated_metrics",
    ): ("Will be used for vitals-in-insights (see #34611) (Dana Hoffman 11/1/24)"),
    BigQueryAddress(

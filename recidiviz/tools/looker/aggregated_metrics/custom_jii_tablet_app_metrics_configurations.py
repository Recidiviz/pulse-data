...
JII_TABLET_APP_DENOMINATOR_METRICS: list[AggregatedMetric] = [
    metric_config.AVG_DAILY_POPULATION,
    metric_config.AVG_DAILY_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS,
]

JII_TABLET_APP_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    metric_config.AVG_DAILY_POPULATION,
    metric_config.PERSON_DAYS_INCARCERATED,
    ...
    metric_config.SUM_EARNED_CREDITS_FOR_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS,
    metric_config.DISTINCT_POPULATION_WITH_EARNED_CREDITS,
    metric_config.DISTINCT_POPULATION_WITH_POSITIVE_EARNED_CREDITS,
    metric_config.DISTINCT_POPULATION_MAXED_OUT_CREDITS,
    metric_config.DISTINCT_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS_WITH_EARNED_CREDITS,
    metric_config.DISTINCT_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS_WITH_POSITIVE_EARNED_CREDITS,
    metric_config.DISTINCT_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS_MAXED_OUT_CREDITS,
    ...
    metric_config.PERSON_DAYS_WEIGHTED_ACHIEVEMENT_EARNED_CREDIT_BALANCE,
    metric_config.DISTINCT_POPULATION_AT_ACHIEVEMENT_EARNED_CREDIT_CAP,
    metric_config.PERSON_DAYS_WEIGHTED_EARNED_CREDIT_BALANCE_FOR_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS,
    metric_config.PERSON_DAYS_WEIGHTED_ACHIEVEMENT_EARNED_CREDIT_BALANCE_FOR_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS,
    metric_config.DISTINCT_POPULATION_AT_ACHIEVEMENT_EARNED_CREDIT_CAP_FOR_REGISTERED_JII_TABLET_APP_PROVISIONED_USERS,
]

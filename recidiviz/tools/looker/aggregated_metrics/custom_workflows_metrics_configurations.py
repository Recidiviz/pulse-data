...
WORKFLOWS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    metric_configs.PERSON_DAYS_IN_SYSTEM,
    metric_configs.PERSON_DAYS_INCARCERATED,
    metric_configs.PERSON_DAYS_SUPERVISED,
    metric_configs.AVG_DAILY_POPULATION_TASK_CANDIDATE,
    ...
    *metric_configs.AVG_DAILY_POPULATION_TASK_ELIGIBLE_FUNNEL_METRICS,
    ...
    metric_configs.AVG_DAILY_POPULATION_TASK_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
    metric_configs.AVG_DAILY_POPULATION_TASK_ELIGIBLE_AND_UNVIEWED_LESS_THAN_30_DAYS,
    metric_configs.AVG_DAILY_POPULATION_TASK_ELIGIBLE_AND_UNVIEWED,
    metric_configs.AVG_DAILY_POPULATION_TASK_ELIGIBLE_ACTIONABLE_AND_VIEWED,
    metric_configs.AVG_DAILY_POPULATION_TASK_MARKED_SUBMITTED,
    metric_configs.AVG_DAILY_POPULATION_TASK_MARKED_INELIGIBLE,
    ...
    *metric_configs.AVG_DAILY_POPULATION_TASK_ALMOST_ELIGIBLE_FUNNEL_METRICS,
    metric_configs.AVG_DAILY_POPULATION_TASK_ALMOST_ELIGIBLE_ACTIONABLE_AND_VIEWED,
    metric_configs.AVG_DAILY_POPULATION_TASK_ALMOST_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
    *metric_configs.AVG_DAILY_POPULATION_WORKFLOWS_REVIEW_STATUS,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE,
    *metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_FUNNEL_METRICS,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_AND_VISIBLE_IN_TOOL,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_AND_ACTIONABLE,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_ACTIONABLE_AND_VIEWED,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE,
    *metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_FUNNEL_METRICS,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_AND_VISIBLE_IN_TOOL,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_AND_ACTIONABLE,
    metric_configs.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_ACTIONABLE_AND_VIEWED,
    *metric_configs.DISTINCT_POPULATION_WORKFLOWS_REVIEW_STATUS,
    ...
    metric_configs.DISTINCT_REGISTERED_PRIMARY_WORKFLOWS_USERS_WITH_ELIGIBLE_CASELOAD_IN_PAST_YEAR,
    metric_configs.DISTINCT_LOGGED_IN_PRIMARY_WORKFLOWS_USERS_WITH_ELIGIBLE_CASELOAD_IN_PAST_YEAR,
    metric_configs.DISTINCT_ACTIVE_PRIMARY_WORKFLOWS_USERS_WITH_ELIGIBLE_CASELOAD_IN_PAST_YEAR,
    ...
    metric_configs.TASK_COMPLETIONS_WHILE_ELIGIBLE_OVER_7_DAYS,
    ...
    metric_configs.WORKFLOWS_PRIMARY_USER_ACTIVE_USAGE_EVENTS,
]

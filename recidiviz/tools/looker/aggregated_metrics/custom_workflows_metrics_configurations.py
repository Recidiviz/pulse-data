...
WORKFLOWS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    *metric_configs.WORKFLOWS_DISTINCT_POPULATION_ELIGIBLE_FUNNEL_METRICS,
    metric_configs.WORKFLOWS_DISTINCT_PEOPLE_ELIGIBLE_AND_ACTIONABLE,
    metric_configs.WORKFLOWS_DISTINCT_PEOPLE_ELIGIBLE_ACTIONABLE_AND_VIEWED,
    *metric_configs.WORKFLOWS_DISTINCT_POPULATION_ALMOST_ELIGIBLE_FUNNEL_METRICS,
    metric_configs.WORKFLOWS_DISTINCT_PEOPLE_ALMOST_ELIGIBLE_AND_ACTIONABLE,
    metric_configs.WORKFLOWS_DISTINCT_PEOPLE_ALMOST_ELIGIBLE_ACTIONABLE_AND_VIEWED,

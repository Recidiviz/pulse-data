...
INSIGHTS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    *OutliersAggregatedMetricsCollector().get_metrics(),
    ...
    # Operations drilldown funnel (top: provisioned for the operations module; then
    # registered, then engagement)
    metric_config.DISTINCT_PROVISIONED_PRIMARY_SHP_OPERATIONS_USERS,
    metric_config.DISTINCT_REGISTERED_PRIMARY_SHP_OPERATIONS_USERS,
    metric_config.DISTINCT_LOGGED_IN_PRIMARY_SHP_OPERATIONS_USERS,
    metric_config.DISTINCT_PRIMARY_SHP_OPERATIONS_USERS_VIEWED_DRILLDOWN,
    ...
    # All opportunity module metrics
    *metric_config.DISTINCT_POPULATION_WORKFLOWS_REVIEW_STATUS,
    metric_config.DISTINCT_POPULATION_WORKFLOWS_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
    metric_config.DISTINCT_POPULATION_WORKFLOWS_ALMOST_ELIGIBLE_MARKED_PERMANENTLY_INELIGIBLE,
]

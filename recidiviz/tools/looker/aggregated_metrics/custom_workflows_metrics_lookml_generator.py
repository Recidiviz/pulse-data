...
WORKFLOWS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    *workflows_metrics.AVG_DAILY_POPULATION_TASK_ALMOST_ELIGIBLE_LOOKER_FUNNEL_METRICS,
    ...
    workflows_metrics.DISTINCT_OFFICERS_WITH_CANDIDATE_CASELOAD,
    workflows_metrics.DISTINCT_OFFICERS_WITH_ELIGIBLE_OR_ALMOST_ELIGIBLE_CASELOAD,
    workflows_metrics.DISTINCT_OFFICERS_WITH_ELIGIBLE_CASELOAD,
    workflows_metrics.DISTINCT_OFFICERS_WITH_ALMOST_ELIGIBLE_CASELOAD,
    workflows_metrics.DISTINCT_OFFICERS_WITH_TASKS_COMPLETED,
    workflows_metrics.DISTINCT_OFFICERS_WITH_TASKS_COMPLETED_WHILE_ELIGIBLE_OR_ALMOST_ELIGIBLE,
    workflows_metrics.DISTINCT_OFFICERS_WITH_TASKS_COMPLETED_WHILE_ELIGIBLE,
    workflows_metrics.DISTINCT_OFFICERS_WITH_TASKS_COMPLETED_WHILE_ALMOST_ELIGIBLE,
    workflows_metrics.DISTINCT_OFFICERS_WITH_TASKS_COMPLETED_AFTER_TOOL_ACTION,
]

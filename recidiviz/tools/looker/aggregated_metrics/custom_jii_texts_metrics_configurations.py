...
JII_TEXTS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    metric_config.JII_INCOMING_TEXT_MESSAGES,
    metric_config.JII_INCOMING_TEXT_MESSAGES_OPT_OUT,
    metric_config.JII_INCOMING_TEXT_MESSAGES_OPT_OUT_DISTINCT_CLIENTS,
    metric_config.JII_INCOMING_TEXT_MESSAGES_SWITCH_LANGUAGE_SPANISH,
    metric_config.JII_INCOMING_TEXT_MESSAGES_SWITCH_LANGUAGE_ENGLISH,
    metric_config.CONTACTS_ELIGIBLE_FOR_TEXT_REMINDERS,
    metric_config.CONTACTS_ELIGIBLE_FOR_TEXT_REMINDERS_RECORDED_ON_SCHEDULED_DATE,
    metric_config.JII_TEXT_MESSAGES_ATTEMPTED_WITH_CONTACT_COMPLETED_ON_SCHEDULED_DATE,
    metric_config.JII_TEXT_MESSAGES_SUCCESSFUL_WITH_CONTACT_COMPLETED_ON_SCHEDULED_DATE,
    metric_config.JII_TEXT_MESSAGES_ATTEMPTED_WITH_CONTACT_ATTEMPTED_ON_SCHEDULED_DATE,
    metric_config.JII_TEXT_MESSAGES_SUCCESSFUL_WITH_CONTACT_ATTEMPTED_ON_SCHEDULED_DATE,
]

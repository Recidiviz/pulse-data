...
# =============================================================================
"""Configured metrics for custom CPA (Case Planning Assistant) impact metrics displayable in Looker"""
...
CPA_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    metric_config.AVG_DAILY_POPULATION,
    metric_config.DISTINCT_PROVISIONED_CASE_PLANNING_ASSISTANT_USERS,
    metric_config.DISTINCT_REGISTERED_CASE_PLANNING_ASSISTANT_USERS,
    metric_config.DISTINCT_LOGGED_IN_CASE_PLANNING_ASSISTANT_USERS,
    metric_config.DISTINCT_ACTIVE_CASE_PLANNING_ASSISTANT_USERS,
]

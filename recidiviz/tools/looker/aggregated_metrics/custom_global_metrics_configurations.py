...
GLOBAL_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    metric_config.PERSON_DAYS_IN_SYSTEM,
    ...
    metric_config.LOGINS_GLOBAL_USER_UNKNOWN_ROLE_TYPE,
    ...
    metric_config.CSAT_RESPONSES,
    metric_config.CSAT_POSITIVE_RESPONSES,
    metric_config.CSAT_NEUTRAL_RESPONSES,
    metric_config.CSAT_NEGATIVE_RESPONSES,
    metric_config.AVG_CSAT_SCORE,
    metric_config.DISTINCT_USERS_WITH_CSAT_RESPONSES,
]

...
# =============================================================================
"""Configured metrics for custom Meetings impact metrics displayable in Looker"""
...
MEETINGS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    metric_config.AVG_DAILY_POPULATION,
    metric_config.DISTINCT_PROVISIONED_MEETINGS_USERS,
    metric_config.DISTINCT_REGISTERED_MEETINGS_USERS,
    metric_config.DISTINCT_LOGGED_IN_MEETINGS_USERS,
    metric_config.DISTINCT_ACTIVE_MEETINGS_USERS,
]

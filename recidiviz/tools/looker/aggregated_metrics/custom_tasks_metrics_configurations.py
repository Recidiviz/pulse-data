...
TASKS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    metric_config.DISTINCT_PRIMARY_TASKS_USERS_VIEWED_HCRP,
    metric_config.DISTINCT_PRIMARY_TASKS_USERS_VIEWED_HCRP_USING_MOBILE,
    metric_config.DISTINCT_PRIMARY_TASKS_USERS_USED_OPTIMIZE_ROUTE,
    metric_config.DISTINCT_PRIMARY_TASKS_USERS_USED_GOOGLE_MAPS_LINK,
    metric_config.DISTINCT_REGISTERED_PRIMARY_TASKS_ELIGIBLE_ROUTE_PLANNER_USERS,
    metric_config.DISTINCT_REGISTERED_PRIMARY_TASKS_ELIGIBLE_USERS_VIEWED_HCRP,
    metric_config.DISTINCT_REGISTERED_PRIMARY_TASKS_ELIGIBLE_USERS_USED_OPTIMIZE_ROUTE,
    metric_config.DISTINCT_REGISTERED_PRIMARY_TASKS_ELIGIBLE_USERS_USED_GOOGLE_MAPS_LINK,
    ...
    metric_config.AVG_DAILY_POPULATION_CONTACT_TASKS_ELIGIBLE,
    ...
    metric_config.CONTACT_DUE_DATES_MET_INCLUDED_IN_ROUTE_PLANNER,
    metric_config.CONTACT_DUE_DATES_MET_AFTER_ROUTE_PLANNER_LINK_INTERACTION,
    metric_config.CONTACT_DUE_DATES_MET_AFTER_ROUTE_PLANNER_ROUTE_OPTIMIZATION_ATTEMPT,
    metric_config.CONTACT_DUE_DATES_MET_AFTER_ROUTE_PLANNER_SURFACED,
    metric_config.CONTACTS_AFTER_ROUTE_PLANNER_SURFACED,
    metric_config.CONTACTS_AFTER_ROUTE_PLANNER_LINK_INTERACTION,
    metric_config.CONTACTS_AFTER_ROUTE_PLANNER_ROUTE_OPTIMIZATION_ATTEMPT,
]

...
TASKS_IMPACT_LOOKER_METRICS: list[AggregatedMetric] = [
    ...
    metric_config.HOME_CONTACTS_AFTER_SURFACED_IN_ROUTE_PLANNER,
    metric_config.HOME_CONTACTS_AFTER_LINK_INTERACTION_IN_ROUTE_PLANNER,
    metric_config.HOME_CONTACTS_AFTER_ROUTE_OPTIMIZATION_ATTEMPT_IN_ROUTE_PLANNER,
]

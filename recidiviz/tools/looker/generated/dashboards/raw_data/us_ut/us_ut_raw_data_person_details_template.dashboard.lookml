...
- dashboard: us_ut_raw_data_person_details_template
  title: Utah Latest Raw Data Person Details Template
  ...
  - name: ofndr_sec_assess
    ...
    fields: [us_ut_ofndr_sec_assess.primary_key,
      ...
      us_ut_ofndr_sec_assess.eff_strt_dt,

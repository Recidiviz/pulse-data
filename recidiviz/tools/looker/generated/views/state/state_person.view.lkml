...
view: state_person {
  sql_table_name: state.state_person ;;
  ...
  dimension: actions {
    ...
    <style>
      ...
      <a
        href="/dashboards/recidiviz-staging::normalized_state_person?Person+ID={{ _filters['state_person.person_id'] }}&State+Code={{ _filters['state_person.state_code'] }}&External+ID={{ _filters['state_person_external_id.external_id'] }}&ID+Type={{ _filters['state_person_external_id.id_type'] }}"
        style="
          position: relative;
        ...
        "
      >
        Switch to Normalized State Person
      </a>
 ;;
  }

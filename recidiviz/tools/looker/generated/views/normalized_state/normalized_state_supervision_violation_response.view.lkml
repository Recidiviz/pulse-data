...
view: normalized_state_supervision_violation_response {
  sql_table_name: normalized_state.state_supervision_violation_response ;;
  ...
  dimension: deciding_staff_id {
    type: number
    value_format: "0"
    sql: ${TABLE}.deciding_staff_id ;;
  }

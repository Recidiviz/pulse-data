...
- dashboard: us_mo_raw_data_person_details
  ...
  - name: LBAKRDTA_TAK071
    title: LBAKRDTA_TAK071
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK071.primary_key,
      us_mo_LBAKRDTA_TAK071.CV_DOC,
      us_mo_LBAKRDTA_TAK071.CV_CYC,
      us_mo_LBAKRDTA_TAK071.CV_MXY,
      us_mo_LBAKRDTA_TAK071.CV_MXM,
      us_mo_LBAKRDTA_TAK071.CV_MXD,
      us_mo_LBAKRDTA_TAK071.CV_AP,
      us_mo_LBAKRDTA_TAK071.CV_AM,
      us_mo_LBAKRDTA_TAK071.CV_MR,
      us_mo_LBAKRDTA_TAK071.CV_TC,
      us_mo_LBAKRDTA_TAK071.CV_TA,
      us_mo_LBAKRDTA_TAK071.CV_TCA,
      us_mo_LBAKRDTA_TAK071.CV_S1,
      us_mo_LBAKRDTA_TAK071.CV_S1A,
      us_mo_LBAKRDTA_TAK071.CV_S2,
      us_mo_LBAKRDTA_TAK071.CV_S2A,
      us_mo_LBAKRDTA_TAK071.CV_TC1,
      us_mo_LBAKRDTA_TAK071.CV_TC2,
      us_mo_LBAKRDTA_TAK071.CV_TC3,
      us_mo_LBAKRDTA_TAK071.CV_DCR,
      us_mo_LBAKRDTA_TAK071.CV_TCR,
      us_mo_LBAKRDTA_TAK071.CV_DLU,
      us_mo_LBAKRDTA_TAK071.CV_TLU,
      us_mo_LBAKRDTA_TAK071.file_id,
      us_mo_LBAKRDTA_TAK071.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK071.CV_DOC, us_mo_LBAKRDTA_TAK071.CV_CYC]
    note_display: hover
    note_text: "ITIM screen: where we see sentence length, max discharge date, conditional release date, etc. Column prefix: CV."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID
  ...
  - name: LBAKRDTA_TAK243
    title: LBAKRDTA_TAK243
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK243.primary_key,
      us_mo_LBAKRDTA_TAK243.T1_DOC,
      us_mo_LBAKRDTA_TAK243.T1_CYC,
      us_mo_LBAKRDTA_TAK243.T1TID,
      us_mo_LBAKRDTA_TAK243.T1_PON,
      us_mo_LBAKRDTA_TAK243.T1CID,
      us_mo_LBAKRDTA_TAK243.T1CSD__raw,
      us_mo_LBAKRDTA_TAK243.T1CST,
      us_mo_LBAKRDTA_TAK243.T1_DCR,
      us_mo_LBAKRDTA_TAK243.T1_TCR,
      us_mo_LBAKRDTA_TAK243.T1_DLU,
      us_mo_LBAKRDTA_TAK243.T1_TLU,
      us_mo_LBAKRDTA_TAK243.T1_UID,
      us_mo_LBAKRDTA_TAK243.T1_UIU,
      us_mo_LBAKRDTA_TAK243.file_id,
      us_mo_LBAKRDTA_TAK243.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK243.T1CSD__raw]
    note_display: hover
    note_text: "Supervision contacts. Has overall information about each contact; for a breakdown of each contact's components, see LBAKRDTA_TAK244."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID
  ...
  - name: LBAKRDTA_TAK244
    title: LBAKRDTA_TAK244
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK244.primary_key,
      us_mo_LBAKRDTA_TAK244.T2_DOC,
      us_mo_LBAKRDTA_TAK244.T2_CYC,
      us_mo_LBAKRDTA_TAK244.T2TID,
      us_mo_LBAKRDTA_TAK244.T2CID,
      us_mo_LBAKRDTA_TAK244.T2DID,
      us_mo_LBAKRDTA_TAK244.T2CTP,
      us_mo_LBAKRDTA_TAK244.T2NCT,
      us_mo_LBAKRDTA_TAK244.T2FUD__raw,
      us_mo_LBAKRDTA_TAK244.T2_DCR,
      us_mo_LBAKRDTA_TAK244.T2_TCR,
      us_mo_LBAKRDTA_TAK244.T2_DLU,
      us_mo_LBAKRDTA_TAK244.T2_TLU,
      us_mo_LBAKRDTA_TAK244.T2_UID,
      us_mo_LBAKRDTA_TAK244.T2_UIU,
      us_mo_LBAKRDTA_TAK244.file_id,
      us_mo_LBAKRDTA_TAK244.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK244.T2FUD__raw]
    note_display: hover
    note_text: "Supervision contact details. Has information about each contact type involved in a contact action."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID
  ...
  - name: LBAKRDTA_TAK019
    title: LBAKRDTA_TAK019
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK019.primary_key,
      us_mo_LBAKRDTA_TAK019.BP_DOC,
      us_mo_LBAKRDTA_TAK019.BP_CYC,
      us_mo_LBAKRDTA_TAK019.BP_ISN,
      us_mo_LBAKRDTA_TAK019.BP_IAS,
      us_mo_LBAKRDTA_TAK019.BP_INV,
      us_mo_LBAKRDTA_TAK019.BP_IIR,
      us_mo_LBAKRDTA_TAK019.BP_ICT,
      us_mo_LBAKRDTA_TAK019.BP_PON,
      us_mo_LBAKRDTA_TAK019.BP_PLN,
      us_mo_LBAKRDTA_TAK019.BP_PIN,
      us_mo_LBAKRDTA_TAK019.BP_ION,
      us_mo_LBAKRDTA_TAK019.BP_PL2,
      us_mo_LBAKRDTA_TAK019.BP_FLC,
      us_mo_LBAKRDTA_TAK019.BP_PLS,
      us_mo_LBAKRDTA_TAK019.BP_STA,
      us_mo_LBAKRDTA_TAK019.BP_DC,
      us_mo_LBAKRDTA_TAK019.BP_IV,
      us_mo_LBAKRDTA_TAK019.BP_DI,
      us_mo_LBAKRDTA_TAK019.BP_CT,
      us_mo_LBAKRDTA_TAK019.BP_AS,
      us_mo_LBAKRDTA_TAK019.BP_ID,
      us_mo_LBAKRDTA_TAK019.BP_IVR,
      us_mo_LBAKRDTA_TAK019.BP_IOR,
      us_mo_LBAKRDTA_TAK019.BP_IRR,
      us_mo_LBAKRDTA_TAK019.BP_AJN,
      us_mo_LBAKRDTA_TAK019.BP_DCR,
      us_mo_LBAKRDTA_TAK019.BP_TCR,
      us_mo_LBAKRDTA_TAK019.BP_DLU,
      us_mo_LBAKRDTA_TAK019.BP_TLU,
      us_mo_LBAKRDTA_TAK019.file_id,
      us_mo_LBAKRDTA_TAK019.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK019.BP_DOC, us_mo_LBAKRDTA_TAK019.BP_CYC, us_mo_LBAKRDTA_TAK019.BP_ISN, us_mo_LBAKRDTA_TAK019.BP_IAS]
    note_display: hover
    note_text: "Offender field investigation file. Column prefix: BP."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID
  ...
  - name: LBAKRDTA_TAK077
    title: LBAKRDTA_TAK077
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK077.primary_key,
      us_mo_LBAKRDTA_TAK077.DA_DOC,
      us_mo_LBAKRDTA_TAK077.DA_CYC,
      us_mo_LBAKRDTA_TAK077.DA_VAR,
      us_mo_LBAKRDTA_TAK077.DA_OFF,
      us_mo_LBAKRDTA_TAK077.DA_SEO,
      us_mo_LBAKRDTA_TAK077.DA_DCR,
      us_mo_LBAKRDTA_TAK077.DA_TCR,
      us_mo_LBAKRDTA_TAK077.DA_DLU,
      us_mo_LBAKRDTA_TAK077.DA_TLU,
      us_mo_LBAKRDTA_TAK077.file_id,
      us_mo_LBAKRDTA_TAK077.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK077.DA_DOC, us_mo_LBAKRDTA_TAK077.DA_CYC, us_mo_LBAKRDTA_TAK077.DA_VAR, us_mo_LBAKRDTA_TAK077.DA_OFF, us_mo_LBAKRDTA_TAK077.DA_SEO]
    note_display: hover
    note_text: "Officials Xref. Column prefix: DA."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID
  ...
  - name: LBAKRDTA_TAK245
    title: LBAKRDTA_TAK245
    explore: us_mo_raw_data
    model: "@{model_name}"
    type: looker_grid
    fields: [us_mo_LBAKRDTA_TAK245.primary_key,
      us_mo_LBAKRDTA_TAK245.T3_DOC,
      us_mo_LBAKRDTA_TAK245.T3_CYC,
      us_mo_LBAKRDTA_TAK245.I3TID,
      us_mo_LBAKRDTA_TAK245.I3CID,
      us_mo_LBAKRDTA_TAK245.I3DID,
      us_mo_LBAKRDTA_TAK245.I3LIN,
      us_mo_LBAKRDTA_TAK245.I3DES,
      us_mo_LBAKRDTA_TAK245.T3_DCR,
      us_mo_LBAKRDTA_TAK245.T3_TCR,
      us_mo_LBAKRDTA_TAK245.T3_DLU,
      us_mo_LBAKRDTA_TAK245.T3_TLU,
      us_mo_LBAKRDTA_TAK245.T3_UID,
      us_mo_LBAKRDTA_TAK245.T3_UIU,
      us_mo_LBAKRDTA_TAK245.file_id,
      us_mo_LBAKRDTA_TAK245.is_deleted]
    sorts: [us_mo_LBAKRDTA_TAK245.I3CID, us_mo_LBAKRDTA_TAK245.I3DID, us_mo_LBAKRDTA_TAK245.I3LIN]
    note_display: hover
    note_text: "Field case notes."
    listen: 
      View Type: us_mo_LBAKRDTA_TAK001.view_type
      US_MO_DOC: us_mo_LBAKRDTA_TAK001.EK_DOC
      US_MO_SID: us_mo_LBAKRDTA_TAK001.EK_SID

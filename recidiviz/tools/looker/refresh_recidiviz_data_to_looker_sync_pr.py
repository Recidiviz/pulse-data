...
class RecidivizDataLookerSyncOrchestrator:
    ...
    def from_config(
        ...
        return cls(
            ...
            LookerGitManager(
                ...
                looker_branch_name=config.looker_branch_name,
            ),
    ...
    def refresh_recidiviz_data_to_looker_sync_pr(self) -> None:
        ...
        should_delete_existing_branch = not self.github_manager.pr_exists_for_branch(
            self.sync_config.looker_branch_name
        )
        self.looker_git_manager.clone_and_checkout_branch(
            delete_existing_branch=should_delete_existing_branch
        )

...
def copy_bq_views(source_project_id: str,
    ...
    for table_ref in tables_in_source_dataset:
        ...
        # destination dataset
        if view_query and not destination_client.table_exists(destination_dataset, table_id=table.table_id):
            ...
            source_client.copy_view(view=BigQueryView(project_id=destination_project_id,
...
def parse_arguments(argv: List[str]) -> Tuple[argparse.Namespace, List[str]]:
    ...
    parser.add_argument('--source_dataset_id',
                        required=True,
                        help='The name of the dataset to copy.')

    parser.add_argument('--destination_project_id',
                        required=True,
                        help='The project_id where the new views should live. Can be the same as source_project_id.')

    parser.add_argument('--destination_dataset_id',
                        required=True,
...
if __name__ == '__main__':
    ...
    copy_bq_views(source_project_id=known_args.source_project_id,

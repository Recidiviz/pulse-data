...
resource "google_compute_url_map" "urlmap" {
  ...
  default_service = module.unified-product-load-balancer-v2.backend_services["case-triage"].self_link
  ...
  path_matcher {
    ...
    default_service = module.unified-product-load-balancer-v2.backend_services["ae"].self_link
  }
}

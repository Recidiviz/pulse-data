...
# =============================================================================
"""View containing transition events associated with workflows opportunities having
mandatory due dates, for org-wide impact tracking. We only count overdue transitions toward
depth and breadth metrics for mandatory workflows."""
...
from recidiviz.outcome_metrics.views.transitions_metric_utils import (
    get_workflows_transitions_query_template_for_observations,
)
from recidiviz.utils.environment import GCP_PROJECT_STAGING
from recidiviz.utils.metadata import local_project_id_override

_VIEW_DESCRIPTION = """View containing transition events associated with workflows opportunities having
mandatory due dates, for org-wide impact tracking. We only count overdue transitions toward
depth and breadth metrics for mandatory workflows."""

# Wrap transitions observations with additional attributes via helper
_SOURCE_DATA_QUERY_TEMPLATE = get_workflows_transitions_query_template_for_observations(
...
VIEW_BUILDER: ImpactTransitionsBigQueryViewBuilder = (
    ImpactTransitionsBigQueryViewBuilder(
        ...
        product_transition_type=ProductTransitionType.WORKFLOWS_MANDATORY,
    )
)

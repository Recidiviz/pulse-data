...
# =============================================================================
"""View containing discretionary transition events associated with the supervisor opportunities module
...
_VIEW_DESCRIPTION = """View containing discretionary transition events associated with the supervisor opportunities module
for org-wide impact tracking"""
...
VIEW_BUILDER: ImpactTransitionsBigQueryViewBuilder = ImpactTransitionsBigQueryViewBuilder(
    ...
    product_transition_type=ProductTransitionType.SUPERVISOR_OPPORTUNITIES_MODULE_DISCRETIONARY,
)

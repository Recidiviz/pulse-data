...
# =============================================================================
"""View containing transition events associated with the discretionary workflows 
opportunities, for org-wide impact tracking"""
...
_VIEW_DESCRIPTION = """View containing transition events associated with the discretionary workflows
opportunities, for org-wide impact tracking"""
...
VIEW_BUILDER: ImpactTransitionsBigQueryViewBuilder = (
    ImpactTransitionsBigQueryViewBuilder(
        ...
        product_transition_type=ProductTransitionType.WORKFLOWS_DISCRETIONARY,
    )
)

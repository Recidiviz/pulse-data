...
@attr.s(frozen=True)
class CalculationPipelineJobArgs(Generic[RecidivizMetricTypeT], PipelineJobArgs):
    """Stores information about the calculation pipeline job being run."""
...
class CalculationPipelineRunDelegate(PipelineRunDelegate[CalculationPipelineJobArgs]):
    """Delegate for running a calculation pipeline."""
    ...
    def _build_pipeline_job_args(
        ...
        """Builds the CalculationPipelineJobArgs object from the
        |apache_beam_pipeline_options| and other provided |pipeline_args|."""
        ...
        return CalculationPipelineJobArgs(
    ...
    def _validate_pipeline_config(self) -> None:
        ...
        # All of these entities are required for all calculation pipelines
    ...
    def run_data_transforms(
        ...
        """Runs the data transforms of a calculation pipeline. First, classifies the
        ...
        person_events = pipeline_data | "Get Events" >> beam.ParDo(
            ClassifyEvents(), identifier=self.identifier()
        )
...
@with_input_types(
    ...
    beam.typehints.Optional[CalculationPipelineJobArgs],
...
class ProduceMetrics(beam.DoFn):
    ...
    def process(
        ...
        pipeline_job_args: CalculationPipelineJobArgs,

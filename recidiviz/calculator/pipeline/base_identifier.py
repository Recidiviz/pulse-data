...
# =============================================================================
"""Base class for identifying various instances of events for a calculation pipeline."""
import abc
...
class BaseIdentifier(abc.ABC, Generic[IdentifierEventResultT]):
    """A base class for identifying various instances of events for a calculation pipeline."""

...
def find_incarceration_stays(
    ...
    original_admission_reason = state_specific_incarceration_admission_reason_override(incarceration_period.state_code,
...
def admission_event_for_period(
    ...
    if admission_date and admission_reason:
        admission_reason = state_specific_incarceration_admission_reason_override(
            incarceration_period.state_code, admission_reason, supervision_type_at_admission)

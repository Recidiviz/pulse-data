...
def has_revocation_admission_on_date(
    date_in_month: date, incarceration_period_index: IncarcerationPeriodIndex
) -> bool:
    ...
    for incarceration_period in incarceration_periods:
        ...
        if incarceration_period_is_from_revocation(
...
def _identify_revocation_type_and_subtype(
    incarceration_period: StateIncarcerationPeriod,
    ...
    if (
        ...
        raise ValueError(
            "Unhandled StateSpecializedPurposeForIncarceration: "

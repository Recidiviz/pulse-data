...
# =============================================================================
"""US_MO implementation of the supervision pre-processing delegate"""
import itertools
...
class UsMoSupervisionPreProcessingDelegate(
    StateSpecificSupervisionPreProcessingDelegate
):
    """US_MO implementation of the supervision pre-processing delegate"""
    ...
    def split_periods_based_on_sentences(
        ...
        if incarceration_sentences is None or supervision_sentences is None:
            raise ValueError(
                f"Sentences are required for US_MO SP pre-processing."

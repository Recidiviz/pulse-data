...
# =============================================================================
"""Utils for state-specific preprocessing logic related to violations in US_PA."""
...
class UsPaViolationResponsePreprocessingDelegate(
    StateSpecificViolationResponsePreProcessingDelegate
):
    """US_PA implementation of the
    StateSpecificViolationResponsePreProcessingDelegate."""

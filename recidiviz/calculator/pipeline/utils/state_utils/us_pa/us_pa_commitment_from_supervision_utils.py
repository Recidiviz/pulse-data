...
# TODO(#7441): Move this class to a us_pa_commitment_from_supervision_delegate file
#  once we've implemented US_PA pre-processing that moves most of the logic in this
#  file elsewhere

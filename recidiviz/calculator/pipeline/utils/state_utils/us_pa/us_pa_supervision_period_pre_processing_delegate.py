...
# =============================================================================
"""US_PA implementation of the supervision pre-processing delegate"""
...
class UsPaSupervisionPreProcessingDelegate(
    StateSpecificSupervisionPreProcessingDelegate
):
    """US_PA implementation of the supervision pre-processing delegate"""
    ...
    def infer_additional_periods(
        ...
        # TODO(#10084): Consider combining functions of IP / SP pre-processing to

...
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_assessment_normalization_delegate import (
    UsArAssessmentNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_commitment_from_supervision_utils import (
    UsArCommitmentFromSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_incarceration_delegate import (
    UsArIncarcerationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_incarceration_metrics_producer_delegate import (
    UsArIncarcerationMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_incarceration_period_normalization_delegate import (
    UsArIncarcerationNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_program_assignment_normalization_delegate import (
    UsArProgramAssignmentNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_recidivism_metrics_producer_delegate import (
    UsArRecidivismMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_sentence_normalization_delegate import (
    UsArSentenceNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_supervision_delegate import (
    UsArSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_supervision_metrics_producer_delegate import (
    UsArSupervisionMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_supervision_period_normalization_delegate import (
    UsArSupervisionNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_violation_response_normalization_delegate import (
    UsArViolationResponseNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ar.us_ar_violations_delegate import (
...
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_assessment_normalization_delegate import (
    UsIaAssessmentNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_commitment_from_supervision_utils import (
    UsIaCommitmentFromSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_incarceration_delegate import (
    UsIaIncarcerationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_incarceration_metrics_producer_delegate import (
    UsIaIncarcerationMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_incarceration_period_normalization_delegate import (
...
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_recidivism_metrics_producer_delegate import (
    UsIaRecidivismMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_sentence_normalization_delegate import (
    UsIaSentenceNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_supervision_delegate import (
    UsIaSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_supervision_metrics_producer_delegate import (
    UsIaSupervisionMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_supervision_period_normalization_delegate import (
    UsIaSupervisionNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_violation_response_normalization_delegate import (
    UsIaViolationResponseNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_ia.us_ia_violations_delegate import (
...
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_assessment_normalization_delegate import (
    UsNcAssessmentNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_commitment_from_supervision_utils import (
    UsNcCommitmentFromSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_incarceration_delegate import (
    UsNcIncarcerationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_incarceration_metrics_producer_delegate import (
    UsNcIncarcerationMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_incarceration_period_normalization_delegate import (
    UsNcIncarcerationNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_program_assignment_normalization_delegate import (
    UsNcProgramAssignmentNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_recidivism_metrics_producer_delegate import (
    UsNcRecidivismMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_sentence_normalization_delegate import (
    UsNcSentenceNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_supervision_delegate import (
    UsNcSupervisionDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_supervision_metrics_producer_delegate import (
    UsNcSupervisionMetricsProducerDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_supervision_period_normalization_delegate import (
    UsNcSupervisionNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_violation_response_normalization_delegate import (
    UsNcViolationResponseNormalizationDelegate,
)
from recidiviz.calculator.pipeline.utils.state_utils.us_nc.us_nc_violations_delegate import (
...
def _get_state_specific_program_assignment_normalization_delegate(
    ...
    if state_code == StateCode.US_AR.value:
        return UsArProgramAssignmentNormalizationDelegate()
    if state_code == StateCode.US_CA.value:
        return UsCaProgramAssignmentNormalizationDelegate()
    if state_code == StateCode.US_CO.value:
        return UsCoProgramAssignmentNormalizationDelegate()
    if state_code == StateCode.US_IA.value:
        return UsIaProgramAssignmentNormalizationDelegate()
    if state_code == StateCode.US_ID.value:
    ...
    if state_code == StateCode.US_NC.value:
        return UsNcProgramAssignmentNormalizationDelegate()
    if state_code == StateCode.US_ND.value:

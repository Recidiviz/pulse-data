...
# =============================================================================
"""Contains state-specific logic for certain aspects of normalization US_ND
...
PROBATION_REVOCATION_NORMALIZED_PREFIX = "US_ND_NORMALIZED_PROBATION_REVOCATION"
PAROLE_REVOCATION_NORMALIZED_PREFIX = "US_ND_NORMALIZED_PAROLE_REVOCATION"
...
PREVIOUS_SUPERVISION_TYPE_TO_INCARCERATION_ADMISSION_REASON_RAW_TEXT: Dict[
    ...
    # The following are prefixes set in normalization. The admission reason raw texts
    ...
    PROBATION_REVOCATION_NORMALIZED_PREFIX: StateSupervisionPeriodSupervisionType.PROBATION,
    PAROLE_REVOCATION_NORMALIZED_PREFIX: StateSupervisionPeriodSupervisionType.PAROLE,
}


class UsNdIncarcerationNormalizationDelegate(
    StateSpecificIncarcerationNormalizationDelegate
):
    """US_ND implementation of the StateSpecificIncarcerationNormalizationDelegate."""
...
def _updated_ip_after_revoked_sp(
    ...
    if (
        ...
        admission_reason_prefix = PROBATION_REVOCATION_NORMALIZED_PREFIX
    else:

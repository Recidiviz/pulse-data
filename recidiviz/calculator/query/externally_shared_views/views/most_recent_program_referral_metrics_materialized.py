...
# =============================================================================
"""Creates the view builder that copies most_recent_program_referral_metrics_materialized."""
...
PROGRAM_REFERRALS_VIEW_NAME = "ftr_referrals"

# description of the view
PROGRAM_REFERRALS_VIEW_DESCRIPTION = "Referral data for ND's FTR program"

# query template
PROGRAM_REFERRALS_QUERY_TEMPLATE = """
    /*{description}*/
    SELECT
        state_code,
        person_id,
    ...
    FTR_PROGRAM_REFERRALS_VIEW_BUILDERS.append(
        SimpleBigQueryViewBuilder(
            ...
            materialized_address_override=BigQueryAddress(
                ...
                table_id=PROGRAM_REFERRALS_VIEW_NAME,
            ),
        )
    )
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        for view_builder in FTR_PROGRAM_REFERRALS_VIEW_BUILDERS:

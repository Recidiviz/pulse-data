...
acis_dtp_date_approaching AS (
  SELECT
    acis_dtp_wo_reasons.external_id,
    acis_dtp_wo_reasons.person_id,
    acis_dtp_wo_reasons.state_code,
...
{almost_eligible_tab_logic(opp_name='dtp')}
),
...
array_side_panel_notes_cte AS (
    {array_agg_case_notes_by_external_id(
        ...
        from_cte="combine_acis_and_recidiviz_dtp_dates")}
)

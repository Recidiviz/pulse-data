...
from recidiviz.calculator.query.state.views.reentry.us_az.case_manager_template import (
    US_AZ_REENTRY_CASE_MANAGER_QUERY_TEMPLATE,
)
...
from recidiviz.calculator.query.state.views.reentry.us_ut.case_manager_template import (
...
WITH
  ...
  az_staff AS ({US_AZ_REENTRY_CASE_MANAGER_QUERY_TEMPLATE}),
  ut_staff AS ({US_UT_REENTRY_CASE_MANAGER_QUERY_TEMPLATE}),

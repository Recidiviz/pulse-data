...
#  =============================================================================
"""View to prepare Supervision officer records for export to the frontend."""
...
REENTRY_SUPERVISION_OFFICER_VIEW_NAME = "supervision_officer"

REENTRY_SUPERVISION_OFFICER_DESCRIPTION = """
    Supervision Officer records to be exported to frontend to power Reentry tools.
    """
...
REENTRY_SUPERVISION_OFFICER_VIEW_BUILDER = SelectedColumnsBigQueryViewBuilder(
    view_id=REENTRY_SUPERVISION_OFFICER_VIEW_NAME,
    dataset_id=dataset_config.REENTRY_OUTPUT_DATASET,
    view_query_template=REENTRY_SUPERVISION_OFFICER_QUERY_TEMPLATE,
    description=REENTRY_SUPERVISION_OFFICER_DESCRIPTION,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        REENTRY_SUPERVISION_OFFICER_VIEW_BUILDER.build_and_print()

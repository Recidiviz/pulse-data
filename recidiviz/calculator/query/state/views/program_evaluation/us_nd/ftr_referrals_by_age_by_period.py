...
FTR_REFERRALS_BY_AGE_BY_PERIOD_QUERY = \
    """
    /*{description}*/
    SELECT
      state_code,
    ...
    USING (state_code, year, month, supervision_type, supervising_district_external_id, metric_period_months, age_bucket)
...
FTR_REFERRALS_BY_AGE_BY_PERIOD_VIEW = bqview.BigQueryView(
    view_id=FTR_REFERRALS_BY_AGE_BY_PERIOD_VIEW_NAME,
    view_query=FTR_REFERRALS_BY_AGE_BY_PERIOD_QUERY
)

if __name__ == '__main__':
    print(FTR_REFERRALS_BY_AGE_BY_PERIOD_VIEW.view_id)
    print(FTR_REFERRALS_BY_AGE_BY_PERIOD_VIEW.view_query)

...
SELECT 
  'US_AZ' AS state_code, 
  OFFICE_LOCATION_ID AS location_external_id,
  ...
  TO_JSON(
    STRUCT(
      ...
      CASE 
        WHEN UPPER(LOCATION_NAME) IN ('CENTRAL OFFICE', '801 NO CC SUPERVISION','ADULT ADMINISTRATOR OFFICE') THEN 'CENTRAL OFFICE'
        ELSE LOCATION_NAME
...
SELECT 
  'US_AZ' AS state_code,
  UPPER(PRISON_CODE) AS location_external_id,

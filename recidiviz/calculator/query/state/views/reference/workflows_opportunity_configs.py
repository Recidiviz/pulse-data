...
WORKFLOWS_OPPORTUNITY_CONFIGS = [
    ...
    WorkflowsOpportunityConfig(
        ...
        task_completion_event=TaskCompletionEventType.TRANSFER_TO_REENTRY_CENTER,
    ...
    WorkflowsOpportunityConfig(
        ...
        task_completion_event=TaskCompletionEventType.SUPERVISION_CLASSIFICATION_REVIEW,
    ...
    WorkflowsOpportunityConfig(
        ...
        task_completion_event=TaskCompletionEventType.RELEASE_FROM_RESTRICTIVE_HOUSING,
        source_filename="us_mo_overdue_restrictive_housing_release_record.json",
        export_collection_name="US_MO-overdueRestrictiveHousingRelease",
    ...
    WorkflowsOpportunityConfig(
        ...
        task_completion_event=TaskCompletionEventType.INITIAL_HEARING_OCCURRED,
        source_filename="us_mo_overdue_restrictive_housing_initial_hearing_record.json",
        export_collection_name="US_MO-overdueRestrictiveHousingInitialHearing",
    ...
    WorkflowsOpportunityConfig(
        ...
        export_collection_name="US_MO-overdueRestrictiveHousingReviewHearing",

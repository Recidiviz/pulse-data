...
WORKFLOWS_OPPORTUNITY_CONFIGS = [
    ...
    WorkflowsOpportunityConfig(
        ...
        opportunity_record_view_name="us_ne_override_low_to_conditional_low_record_materialized",
        task_completion_event=TaskCompletionEventType.OVERRIDE_TO_CONDITIONAL_LOW_RISK_SUPERVISION,
        source_filename="us_ne_override_low_to_conditional_low_record.json",
    ...
    WorkflowsOpportunityConfig(
        ...
        opportunity_record_view_name="us_ne_override_moderate_to_low_record_materialized",
        task_completion_event=TaskCompletionEventType.OVERRIDE_TO_LOW_SUPERVISION,
        source_filename="us_ne_override_moderate_to_low_record.json",
    ...
    WorkflowsOpportunityConfig(
        ...
        task_completion_event=TaskCompletionEventType.TRANSFER_TO_LIMITED_SUPERVISION,
        source_filename="us_tx_transfer_from_parole_to_annual_reporting_status_record.json",

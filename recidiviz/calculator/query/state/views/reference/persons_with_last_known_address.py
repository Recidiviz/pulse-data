...
# =============================================================================
"""Persons with their last known address that is not a prison facility or a
P&P office.
"""
...
PERSONS_WITH_LAST_KNOWN_ADDRESS_DESCRIPTION = \
    """Persons with their last known address that is not a prison facility or a P&P office."""

# TODO(2577) Reference static state-specific tables of known facilities
PERSONS_WITH_LAST_KNOWN_ADDRESS_QUERY = \
    """
    /*{description}*/
    ...
    """.format(
        description=PERSONS_WITH_LAST_KNOWN_ADDRESS_DESCRIPTION,
...
PERSONS_WITH_LAST_KNOWN_ADDRESS_VIEW = bqview.BigQueryView(
    ...
    view_query=PERSONS_WITH_LAST_KNOWN_ADDRESS_QUERY
)

...
FROM `{project_id}.reference_views.state_resident_population` p
LEFT JOIN `{project_id}.reference_views.state_resident_population_combined_race_ethnicity_priority` race_priority
ON p.state_code = race_priority.state_code AND race = race_priority.race_or_ethnicity
LEFT JOIN `{project_id}.reference_views.state_resident_population_combined_race_ethnicity_priority` ethnicity_priority

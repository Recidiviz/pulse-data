...
EVENT_BASED_PROGRAM_REFERRALSS_QUERY = \
    """
    /*{description}*/
    SELECT
...
EVENT_BASED_PROGRAM_REFERRALS_VIEW = bqview.BigQueryView(
    view_id=EVENT_BASED_PROGRAM_REFERRALS_VIEW_NAME,
    view_query=EVENT_BASED_PROGRAM_REFERRALSS_QUERY
)

if __name__ == '__main__':
    print(EVENT_BASED_PROGRAM_REFERRALS_VIEW.view_id)
    print(EVENT_BASED_PROGRAM_REFERRALS_VIEW.view_query)

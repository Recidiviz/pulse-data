...
SUPERVISION_TO_PRISON_TRANSITIONS_RAW_VIEW_NAME = (
    "supervision_to_prison_transitions_raw"
)

SUPERVISION_TO_PRISON_TRANSITIONS_RAW_DESCRIPTION = (
    "Transitions from supervision to prison by month."
)

SUPERVISION_TO_PRISON_TRANSITIONS_RAW_QUERY_TEMPLATE = """
    WITH base_data AS (
        SELECT
            sessions.state_code,
            sessions.person_id,
    ...
    , transitions AS (
        SELECT 
            ...
            COALESCE(location.location_name, base_data.level_1_location_external_id, 'EXTERNAL_UNKNOWN')
...
SUPERVISION_TO_PRISON_TRANSITIONS_RAW_VIEW_BUILDER = SelectedColumnsBigQueryViewBuilder(
    ...
    view_id=SUPERVISION_TO_PRISON_TRANSITIONS_RAW_VIEW_NAME,
    view_query_template=SUPERVISION_TO_PRISON_TRANSITIONS_RAW_QUERY_TEMPLATE,
    description=SUPERVISION_TO_PRISON_TRANSITIONS_RAW_DESCRIPTION,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        SUPERVISION_TO_PRISON_TRANSITIONS_RAW_VIEW_BUILDER.build_and_print()

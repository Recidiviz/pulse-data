...
SUPERVISION_POPULATION_OVER_TIME_VIEW_NAME = "supervision_population_over_time"

SUPERVISION_POPULATION_OVER_TIME_VIEW_DESCRIPTION = """Supervision population count.
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        SUPERVISION_POPULATION_OVER_TIME_VIEW_BUILDER.build_and_print()

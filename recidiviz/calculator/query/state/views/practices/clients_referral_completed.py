...
python -m recidiviz.calculator.query.state.views.practices.clients_referral_completed
"""
...
CLIENTS_REFERRAL_COMPLETED_QUERY_TEMPLATE = """
    ...
    SELECT
        ...
        timestamp,
        opportunity_type,
    FROM `{project_id}.{practices_views_dataset}.clients_latest_referral_status`

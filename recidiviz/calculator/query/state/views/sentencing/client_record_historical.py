...
SENTENCING_CLIENT_RECORD_HISTORICAL_VIEW_NAME = "sentencing_client_record_historical"

SENTENCING_CLIENT_RECORD_HISTORICAL_DESCRIPTION = """
    Sentencing client records to be exported to frontend to power PSI tools. This is the same as
    sentencing_client_record, but doesn't filter to only recent cases which is done in that view to avoid metric export
    timeouts.
    """

SENTENCING_CLIENT_RECORD_HISTORICAL_QUERY_TEMPLATE = f"""
    WITH 
...
SENTENCING_CLIENT_RECORD_HISTORICAL_VIEW_BUILDER = SelectedColumnsBigQueryViewBuilder(
    view_id=SENTENCING_CLIENT_RECORD_HISTORICAL_VIEW_NAME,
    dataset_id=dataset_config.SENTENCING_OUTPUT_DATASET,
    view_query_template=SENTENCING_CLIENT_RECORD_HISTORICAL_QUERY_TEMPLATE,
    description=SENTENCING_CLIENT_RECORD_HISTORICAL_DESCRIPTION,
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        SENTENCING_CLIENT_RECORD_HISTORICAL_VIEW_BUILDER.build_and_print()

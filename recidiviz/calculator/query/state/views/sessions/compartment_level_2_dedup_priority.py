...
COMPARTMENT_LEVEL_2_DEDUP_PRIORITY_QUERY_TEMPLATE = """
    ...
    SELECT
        ...
        *
    FROM
        UNNEST([ 'GENERAL', 'TREATMENT_IN_PRISON', 'SHOCK_INCARCERATION', 'PAROLE_BOARD_HOLD', 'TEMPORARY_CUSTODY', 'COMMUNITY_CONFINEMENT', 'WEEKEND_CONFINEMENT', 'INTERNAL_UNKNOWN']) AS compartment_level_2
    WITH
    OFFSET
        AS priority
    UNION ALL

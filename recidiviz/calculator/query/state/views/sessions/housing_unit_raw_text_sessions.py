...
"""Sessionized view of each individual that is incarcerated. Session defined as continuous period of time at a given
 housing unit, housing unit type, and facility using Recidiviz schema mappings"""
...
HOUSING_UNIT_RAW_TEXT_SESSIONS_QUERY_TEMPLATE = f"""
    ...
    {aggregate_adjacent_spans(table_name='sub_sessions_cte',
                       attribute=['housing_unit', 'housing_unit_type', 'facility'],
                       session_id_output_name='housing_unit_raw_text_session_id',

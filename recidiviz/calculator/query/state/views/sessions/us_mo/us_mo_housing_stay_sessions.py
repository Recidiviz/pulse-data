...
US_MO_HOUSING_STAY_SESSIONS_QUERY_TEMPLATE = f"""
    ...
    */
    ...
    SELECT
      *
    FROM UNNEST(['SOLITARY_CONFINEMENT','PROTECTIVE_CUSTODY','HOSPITAL','GENERAL','INTERNAL_UNKNOWN','EXTERNAL_UNKNOWN']) AS confinement_type
    ...
    */
    ...
    SELECT
      *
    FROM UNNEST(['PERMANENT','TEMPORARY-TASC','TEMPORARY-OTHER','INTERNAL_UNKNOWN','EXTERNAL_UNKNOWN']) AS stay_type

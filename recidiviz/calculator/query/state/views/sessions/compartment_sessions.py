...
COMPARTMENT_SESSIONS_QUERY_TEMPLATE = """
    ...
    */
    ...
    SELECT 
        ...
        s.last_day_of_data,
        COALESCE(LAG(s.compartment_level_1) OVER(PARTITION BY s.person_id ORDER BY s.start_date ASC), 'LIBERTY') AS inflow_from_level_1,
        COALESCE(LAG(s.compartment_level_2) OVER(PARTITION BY s.person_id ORDER BY s.start_date ASC), 'LIBERTY_FIRST_TIME_IN_SYSTEM') AS inflow_from_level_2,

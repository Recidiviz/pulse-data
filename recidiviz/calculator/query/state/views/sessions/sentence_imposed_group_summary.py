    ...
    */
    ...
    SELECT
        ...
        */
        ...
        ANY_VALUE(IF(is_longest_in_imposed_group, nibrs_code_uniform, NULL)) AS most_severe_nibrs_code_uniform,
        ANY_VALUE(IF(is_longest_in_imposed_group, nibrs_description_uniform, NULL)) AS most_severe_nibrs_description_uniform,
        ANY_VALUE(IF(is_longest_in_imposed_group, nibrs_category_uniform, NULL)) AS most_severe_nibrs_category_uniform,

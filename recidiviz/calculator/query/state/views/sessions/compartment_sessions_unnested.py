...
COMPARTMENT_SESSIONS_UNNESTED_QUERY_TEMPLATE = """
    ...
    FROM (
        ...
        LEFT JOIN `{project_id}.{sessions_dataset}.supervision_super_sessions_materialized` supervision_super_session
        ...
        LEFT JOIN `{project_id}.{sessions_dataset}.incarceration_super_sessions_materialized` incarceration_super_session
        ...
        LEFT JOIN `{project_id}.{sessions_dataset}.system_sessions_materialized` system_sessions

...
SUPERVISION_LEVEL_SESSIONS_VIEW_DESCRIPTION = """Sessionized view of non-overlapping periods of continuous stay on supervision on a given supervision level, using
        ...
        FROM
            ...
            FROM
                ...
                SELECT
                    ...
                    MIN(IF(
                        COALESCE(session_lag.supervision_level, "UNKNOWN") = COALESCE(session.supervision_level, "UNKNOWN")
                        AND session_lag.start_date IS NOT NULL, 
                    0, 1)) AS level_changed,

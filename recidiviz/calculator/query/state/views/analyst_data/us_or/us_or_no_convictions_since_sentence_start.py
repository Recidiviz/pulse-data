...
# =============================================================================
"""Creates view to identify individuals' sentences with no convictions since the start of the sentence"""
...
US_OR_NO_CONVICTIONS_SINCE_SENTENCE_START_VIEW_DESCRIPTION = """Creates view to identify individuals' sentences with no convictions since the start of the sentence"""

US_OR_NO_CONVICTIONS_SINCE_SENTENCE_START_QUERY_TEMPLATE = """
    SELECT person_id,
        sentence_id,

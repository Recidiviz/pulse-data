...
# =============================================================================
"""Creates view to identify individuals' sentences for which they have served at least 6 months on supervision"""
...
US_OR_SERVED_6_MONTHS_SUPERVISION_VIEW_DESCRIPTION = """Creates view to identify individuals' sentences for which they have served at least 6 months on supervision"""

US_OR_SERVED_6_MONTHS_SUPERVISION_QUERY_TEMPLATE = """
    SELECT person_id,
        sentence_id,

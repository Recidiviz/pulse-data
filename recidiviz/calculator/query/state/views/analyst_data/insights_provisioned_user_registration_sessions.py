...
# =============================================================================
"""View that represents attributes about every provisioned user
of the Insights tool, with spans reflecting whether that user registered
in the tool and had the role type of a primary Insights user based on 
product roster"""
...
INSIGHTS_PROVISIONED_USER_REGISTRATION_SESSIONS_VIEW_BUILDER = get_provisioned_user_registration_sessions_view_builder(
...
if __name__ == "__main__":
    with local_project_id_override(GCP_PROJECT_STAGING):
        INSIGHTS_PROVISIONED_USER_REGISTRATION_SESSIONS_VIEW_BUILDER.build_and_print()

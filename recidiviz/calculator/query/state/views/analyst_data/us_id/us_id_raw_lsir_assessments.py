...
US_ID_RAW_LSIR_ASSESSMENTS_QUERY_TEMPLATE = """
    ...
    WITH raw_assessments_clean AS (
        ...
        INNER JOIN `{project_id}.{analyst_dataset}.assessment_score_sessions_materialized` sessions
            USING (person_id)
    ...
    raw_assessments_clean_subscales AS (
        ...
        INNER JOIN `{project_id}.{analyst_dataset}.assessment_lsir_scoring_key`

...
INNER JOIN roster
    ON roster.state_code = projected_discharges.state_code
    AND roster.external_id = projected_discharges.supervising_officer_external_id
WHERE projected_end_date <= DATE_ADD(CURRENT_DATE(), INTERVAL 1 WEEK)
GROUP BY roster.email_address
ORDER BY roster.email_address;
"""

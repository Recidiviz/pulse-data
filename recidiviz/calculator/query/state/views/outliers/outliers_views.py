...
OUTLIERS_VIEW_BUILDERS_TO_EXPORT: List[BigQueryViewBuilder] = _VIEW_BUILDERS_TO_EXPORT

INSIGHTS_VIEW_BUILDERS_TO_EXPORT: List[BigQueryViewBuilder] = (
    _VIEW_BUILDERS_TO_EXPORT
    # TODO(#29763): Clean up Insights vs. Outliers exports
    + [INSIGHTS_SUPERVISION_OFFICERS_VIEW_BUILDER, SUPERVISION_OFFICERS_VIEW_BUILDER]
)

...
from recidiviz.calculator.query.state.views.outliers.insights_supervision_officers import (
    INSIGHTS_SUPERVISION_OFFICERS_VIEW_BUILDER,
)
...
_VIEW_BUILDERS_TO_EXPORT: List[BigQueryViewBuilder] = [
    METRIC_BENCHMARKS_VIEW_BUILDER,
    SUPERVISION_DISTRICT_MANAGERS_VIEW_BUILDER,
    SUPERVISION_CLIENT_EVENTS_VIEW_BUILDER,
    SUPERVISION_CLIENTS_VIEW_BUILDER,
...
OUTLIERS_VIEW_BUILDERS_TO_EXPORT: List[
    BigQueryViewBuilder
] = _VIEW_BUILDERS_TO_EXPORT + [SUPERVISION_OFFICERS_VIEW_BUILDER]

INSIGHTS_VIEW_BUILDERS_TO_EXPORT: List[
    BigQueryViewBuilder
] = _VIEW_BUILDERS_TO_EXPORT + [INSIGHTS_SUPERVISION_OFFICERS_VIEW_BUILDER]

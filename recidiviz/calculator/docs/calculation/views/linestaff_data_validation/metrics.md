## linestaff_data_validation.metrics



#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=linestaff_data_validation&t=metrics)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=linestaff_data_validation&t=metrics)
<br/>

#### Dependency Trees

##### Parentage
[linestaff_data_validation.metrics](../linestaff_data_validation/metrics.md) <br/>

## population_projection_data.us_id_parole_board_hold_population_transitions
"Historical US_ID Board Hold total population
by outflow compartment, and compartment duration (months)

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=population_projection_data&t=us_id_parole_board_hold_population_transitions)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=population_projection_data&t=us_id_parole_board_hold_population_transitions)
<br/>

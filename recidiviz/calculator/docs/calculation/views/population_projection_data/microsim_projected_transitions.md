## population_projection_data.microsim_projected_transitions
"The projected transitions for the micro simulation

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=population_projection_data&t=microsim_projected_transitions)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=population_projection_data&t=microsim_projected_transitions)
<br/>

#### Dependency Trees

##### Parentage
[population_projection_data.microsim_projected_transitions](../population_projection_data/microsim_projected_transitions.md) <br/>
|--population_projection_output_data.microsim_projected_outflows_raw ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=population_projection_output_data&t=microsim_projected_outflows_raw)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=population_projection_output_data&t=microsim_projected_outflows_raw)) <br/>
|--[population_projection_data.population_projection_sessions](../population_projection_data/population_projection_sessions.md) <br/>

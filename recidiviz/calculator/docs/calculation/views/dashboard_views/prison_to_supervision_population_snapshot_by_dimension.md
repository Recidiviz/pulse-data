## dashboard_views.prison_to_supervision_population_snapshot_by_dimension
Admissions to supervision from prison aggregated over different time periods.

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=dashboard_views&t=prison_to_supervision_population_snapshot_by_dimension)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=dashboard_views&t=prison_to_supervision_population_snapshot_by_dimension)
<br/>
...
|--[shared_metric_views.prison_to_supervision_transitions](../shared_metric_views/prison_to_supervision_transitions.md) <br/>

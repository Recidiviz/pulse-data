## sessions.supervision_level_sessions
Sessionized view of non-overlapping periods of continuous stay on supervision on a given supervision level, along with level transitions (upgrades/downgrades)

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=sessions&t=supervision_level_sessions)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=sessions&t=supervision_level_sessions)
<br/>

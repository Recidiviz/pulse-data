## reference_views.supervision_period_judicial_district_association
Maps supervision_period_ids to the area of jurisdictional coverage of the court
...
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=reference_views&t=supervision_period_judicial_district_association)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=reference_views&t=supervision_period_judicial_district_association)
<br/>

#### Dependency Trees

##### Parentage
[reference_views.supervision_period_judicial_district_association](../reference_views/supervision_period_judicial_district_association.md) <br/>

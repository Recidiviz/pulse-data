## experiments.person_assignments
Tracks assignments of experiment/policy/program variants to persons (clients) in each experiment.

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=experiments&t=person_assignments)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=experiments&t=person_assignments)
<br/>

#### Dependency Trees

##### Parentage
[experiments.person_assignments](../experiments/person_assignments.md) <br/>
|--us_pa_raw_data_up_to_date_views.dbo_vwCCISAllProgDtls_latest ([Raw Data Doc](../../../ingest/us_pa/raw_data/dbo_vwCCISAllProgDtls.md)) ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=us_pa_raw_data_up_to_date_views&t=dbo_vwCCISAllProgDtls_latest)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=us_pa_raw_data_up_to_date_views&t=dbo_vwCCISAllProgDtls_latest)) <br/>
|--us_pa_raw_data_up_to_date_views.dbo_vwCCISAllMvmt_latest ([Raw Data Doc](../../../ingest/us_pa/raw_data/dbo_vwCCISAllMvmt.md)) ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=us_pa_raw_data_up_to_date_views&t=dbo_vwCCISAllMvmt_latest)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=us_pa_raw_data_up_to_date_views&t=dbo_vwCCISAllMvmt_latest)) <br/>
|--us_id_raw_data_up_to_date_views.geo_cis_participants_latest ([Raw Data Doc](../../../ingest/us_id/raw_data/geo_cis_participants.md)) ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=us_id_raw_data_up_to_date_views&t=geo_cis_participants_latest)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=us_id_raw_data_up_to_date_views&t=geo_cis_participants_latest)) <br/>
|--us_id_raw_data_up_to_date_views.DoPro_Participant_latest ([Raw Data Doc](../../../ingest/us_id/raw_data/DoPro_Participant.md)) ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=us_id_raw_data_up_to_date_views&t=DoPro_Participant_latest)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=us_id_raw_data_up_to_date_views&t=DoPro_Participant_latest)) <br/>
|--static_reference_tables.us_pa_temporary_reprieves ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=static_reference_tables&t=us_pa_temporary_reprieves)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=static_reference_tables&t=us_pa_temporary_reprieves)) <br/>
|--static_reference_tables.geo_cis_referrals_matched ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=static_reference_tables&t=geo_cis_referrals_matched)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=static_reference_tables&t=geo_cis_referrals_matched)) <br/>
...
##### Descendants
[experiments.person_assignments](../experiments/person_assignments.md) <br/>
|--[experiments.person_attributes](../experiments/person_attributes.md) <br/>

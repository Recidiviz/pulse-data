## analyst_data.us_id_early_discharge_sessions_preprocessing
Idaho state-specific preprocessing for early discharge sessions

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=analyst_data&t=us_id_early_discharge_sessions_preprocessing)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=analyst_data&t=us_id_early_discharge_sessions_preprocessing)
<br/>

#### Dependency Trees

##### Parentage
[analyst_data.us_id_early_discharge_sessions_preprocessing](../analyst_data/us_id_early_discharge_sessions_preprocessing.md) <br/>

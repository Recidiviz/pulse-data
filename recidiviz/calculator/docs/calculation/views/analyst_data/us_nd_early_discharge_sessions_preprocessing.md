...
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=analyst_data&t=us_nd_early_discharge_sessions_preprocessing)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=analyst_data&t=us_nd_early_discharge_sessions_preprocessing)
<br/>

#### Dependency Trees

##### Parentage
[analyst_data.us_nd_early_discharge_sessions_preprocessing](../analyst_data/us_nd_early_discharge_sessions_preprocessing.md) <br/>
|--us_nd_raw_data_up_to_date_views.docstars_offendercasestable_latest ([Raw Data Doc](../../../ingest/us_nd/raw_data/docstars_offendercasestable.md)) ([BQ Staging](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=us_nd_raw_data_up_to_date_views&t=docstars_offendercasestable_latest)) ([BQ Prod](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=us_nd_raw_data_up_to_date_views&t=docstars_offendercasestable_latest)) <br/>
...
##### Descendants
[analyst_data.us_nd_early_discharge_sessions_preprocessing](../analyst_data/us_nd_early_discharge_sessions_preprocessing.md) <br/>
|--[analyst_data.early_discharge_sessions](../analyst_data/early_discharge_sessions.md) <br/>

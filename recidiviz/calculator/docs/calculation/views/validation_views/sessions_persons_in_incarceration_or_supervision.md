...
Identifies person ids in sessions that do not appear in either incarceration or supervision state tables.

#### View schema in Big Query
This view may not be deployed to all environments yet.<br/>
[**Staging**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-staging&page=table&project=recidiviz-staging&d=validation_views&t=sessions_persons_in_incarceration_or_supervision)
<br/>
[**Production**](https://console.cloud.google.com/bigquery?pli=1&p=recidiviz-123&page=table&project=recidiviz-123&d=validation_views&t=sessions_persons_in_incarceration_or_supervision)
<br/>

#### Dependency Trees

##### Parentage
[validation_views.sessions_persons_in_incarceration_or_supervision](../validation_views/sessions_persons_in_incarceration_or_supervision.md) <br/>

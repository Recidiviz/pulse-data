...
# Admissions data from Sourcebooks here: https://www.ussc.gov/research/sourcebook-2021
...
crack_outflows_data = pd.DataFrame(
    {
        ...
        "outflow_to": ["prison"] * 5,
        "crime_type": ["crack"] * 5,
        "total_population": [1613, 1417, 1564, 1217, 1088],
    }
)
...
powder_outflows_data = pd.DataFrame(
    {
        ...
        "outflow_to": ["prison"] * 5,
        "crime_type": ["powder"] * 5,
        "total_population": [3988, 3635, 3580, 2702, 2934],
    }
)
# Scale to account for recidivism (see sources below)
...
release_data = pd.DataFrame(
    {
        ...
        "compartment_duration": [69, 69, 68, 68],

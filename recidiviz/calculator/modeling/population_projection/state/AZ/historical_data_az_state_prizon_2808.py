...
historical_data_2018 = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/AZ/AZ_data/HB_2808/2018.csv",
    sep=";",
    thousands=",",
)
historical_data_2017 = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/AZ/AZ_data/HB_2808/2017.csv",
    sep=";",
    thousands=",",
)

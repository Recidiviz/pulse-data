...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state/OK/OK_habitual_sentencing/OK_data/Habitual Transitions Data-Table 1.csv"
        ),
    ]
)
...
yearly_outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/OK/OK_habitual_sentencing/OK_data/Habitual Outflows Data (Yearly)-Table 1.csv"
)

...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state/MS/habitual_sentencing/MS_data/Transitions Data (Policy B Baseline)-Table 1.csv"
        ),
    ]
)
...
outflows_data = pd.concat(
    [
        outflows_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state/MS/habitual_sentencing/MS_data/Outflows Data (Policy B)-Table 1.csv"
        ),
    ]
)
...
total_population_data = pd.concat(
    [
        ...
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state/MS/habitual_sentencing/MS_data/Total Population Data (Policy B)-Table 1.csv"
        ),
    ]
)

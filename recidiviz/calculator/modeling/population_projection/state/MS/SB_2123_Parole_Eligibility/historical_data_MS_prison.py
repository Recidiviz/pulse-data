...
transitions_data = pd.read_csv('recidiviz/calculator/modeling/population_projection/state/MS/SB_2123_Parole_Eligibility/ms_transitions.csv')
outflows_data = pd.read_csv('recidiviz/calculator/modeling/population_projection/state/MS/SB_2123_Parole_Eligibility/ms_outflows.csv')
total_population_data = pd.read_csv('recidiviz/calculator/modeling/population_projection/state/MS/SB_2123_Parole_Eligibility/ms_population.csv')
...
upload_spark_model_inputs('recidiviz-staging', 'MS_SB_2123', outflows_data, transitions_data, total_population_data)

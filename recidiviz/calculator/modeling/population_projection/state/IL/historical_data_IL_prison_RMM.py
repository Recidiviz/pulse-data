...
prison_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/IL/IL_data/RMM Prison Transitions Data (LOS)-Table 1.csv"
)

probation_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/IL/IL_data/RMM Probation Transitions Data-Table 1.csv"
)

release_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/IL/IL_data/RMM Release Transitions Data-Table 1.csv"
)
...
outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/IL/IL_data/RMM Prison Admissions Data (LOS)-Table 1.csv"
)
...
total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state/IL/IL_data/RMM Total Prison Population Data-Table 1.csv"
)
